...
Une priorité peut être affectée aux ressources opérationnelles dotées des mêmes capacités. Ensuite, si plusieurs ressources ont des capacités satisfont les exigences de planification au niveau requis, et sont la capacité libre, le moteur de planification peut sélectionner parmi ces ressources. Si ** priorité ** est sélectionné dans ** sélection de ressource principale ** le champ sous ** des paramètres de planification ** la page, la ressource possédant la priorité la plus élevée (la valeur numérique la plus faible dans ** priorité ** le champ) est sélectionnée en premier lors de la planification.
