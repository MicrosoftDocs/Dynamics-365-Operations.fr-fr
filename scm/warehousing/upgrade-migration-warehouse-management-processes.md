---
title: "Migration à partir de AX 2012 vers Finance and Operations"
description: "Cet article donne une vue d'ensemble des options de migration de la gestion des produits et des entrepôts dans Dynamics 365 for Finance and Operations."
author: BibiSp
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
# <a name="migrate-from-ax-2012-to-finance-and-operations"></a>Migration à partir de AX 2012 vers Finance and Operations

Cette rubrique donne une vue d'ensemble des options de migration de la gestion des produits et des entrepôts dans Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition.
