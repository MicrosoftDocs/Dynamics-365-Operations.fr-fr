...
## <a name="using-tca-for-coproducts"></a>Utilisation le RCT pour les coproducts
...
## <a name="calculating-the-burden-for-byproducts"></a>Calculer la charge pour des sous-produits
