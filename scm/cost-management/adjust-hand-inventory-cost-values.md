...
Vous pouvez utiliser la page **Ajustement du stock disponible** pour ajuster le coût des quantités de stock disponible une fois qu'un processus de clôture de stock a été exécuté. ** Remarque : ** Ouvrir ** ajustement de stock disponible ** la page, sous ** clôture et ajustement ** la page, sélectionnez l'enregistrement d'un processus de clôture de stock terminé, puis sur ** ajustement ** &gt; ** disponible **. **Exemple :** les transactions suivantes ont lieu en février :
