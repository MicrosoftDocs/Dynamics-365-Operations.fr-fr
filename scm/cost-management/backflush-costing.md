...
Le modèle de travaux en cours de la production au plus juste dans Microsoft Dynamics 365 for Operations vous permet d'utiliser le statut d'unité de manutention de kanban pour gérer les matières, les produits semi-finis, et les produits finis qui font partie des travaux en cours.
