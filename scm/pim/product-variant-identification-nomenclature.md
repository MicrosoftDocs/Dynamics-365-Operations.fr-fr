...
[Créer une nomenclature de numéros de produit pour des variantes de produit prédéfinies](http://ax.help.dynamics.com/en/wiki/create-a-product-number-nomenclature-for-predefined-product-variants/)

[Créer une nomenclature de numéros de produit pour des variantes de produit configurées](http://ax.help.dynamics.com/en/wiki/create-a-product-number-nomenclature-for-configured-product-variants/)
