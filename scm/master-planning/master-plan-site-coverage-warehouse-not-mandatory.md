---
title: "Planification de la demande pour la couverture de site, entrepôt non obligatoire"
...
# <a name="master-planning-for-site-coverage-warehouse-not-mandatory"></a>Planification de la demande pour la couverture de site, entrepôt non obligatoire
...
-   Par défaut, le type de commande est défini sur Production, Commande fournisseur ou Kanban. Cliquez sur ** produits lancés de produits &gt; de gestion&gt; des informations sur le produit **. Sélectionnez l'article, puis cliquez sur ** planifier &gt; des paramètres de commande par défaut **. Dans l'écran **Paramètres de commande par défaut**, consultez le champ **Type de commande par défaut**.
