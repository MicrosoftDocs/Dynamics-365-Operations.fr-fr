...
[processus de gestion de la qualité d'![] (. /media/quality-management-process-diagram.png)](. /media/quality-management-process-diagram.png)  
...
Les non-conformités sont associées à un type de problème. Les types de problèmes sont définis dans la page **Types de problèmes**, où vous spécifiez les types de problèmes qui peuvent être associé à chaque type de non-conformité. Par exemple, le Types de problèmes pour les non-conformités ** demande de service ** du type peut refléter une classification des réclamations client, tandis que le Types de problèmes pour les non-conformités ** interne ** du type peut représenter une classification des codes défaut. 
...
[Ordres de qualité de paramétrage (Guide de tâche)](http://ax.help.dynamics.com/en/wiki/set-up-quality-orders/)
