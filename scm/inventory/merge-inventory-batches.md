...
-   Sammy reçoit le stock et il souhaite combiner le nouveau traitement par lots avec un traitement par lots qu'il a déjà reçu pour améliorer la valeur d'attribut de lot du traitement par lots existant.
