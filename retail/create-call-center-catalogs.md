...
-   **Codes source** : ils peuvent être utilisés par les sociétés qui fournissent des catalogues imprimés pour suivre la réponse des clients à des catalogues particuliers. Codes sources sont souvent imprimés à l'arrière à partir d'un catalogue et sont déplacés vers la commande client si un client effectue un achat. Pour ajouter un code source au catalogue, vous devez d'abord créer une. La cible est généralement mappée à une liste de publipostage détenue par ou en crédit-bail.
