...
description: "Cet article fournit une vue d'ensemble Commerce Data Exchange et de ses composants. Il explique le rôle que joue chaque composant dans le transfert des données entre Microsoft Dynamics 365 for Retail et les canaux de vente au détail."
author: josaw1
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
