---
title: "Initialiser les données d&quot;origine à un nouvel environnement au détail"
description: "Cet article décrit les données créées dans le cadre de le processus d&quot;installation de Microsoft Dynamics 365 pour les opérations - au détail."
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="initialize-seed-data-in-a-new-retail-environment"></a>Initialiser les données d'origine à un nouvel environnement au détail

Cet article décrit les données créées dans le cadre de le processus d'installation de Microsoft Dynamics 365 pour les opérations - au détail.
...
1.  Démarrez Dynamics 365 pour le client des opérations.
2.  Cliquez sur ** au détail et commerce ** &gt; ** depuis Retail Headquarters paramètre ** &gt; ** des paramètres ** &gt; ** les paramètres des ventes au détail **.
