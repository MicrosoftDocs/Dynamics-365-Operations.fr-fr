...
description: "Les ressources humaines simplifient de nombreuses tâches d&quot;archivage de routine et automatisent un certain nombre de processus liés à la dotation en personnel de votre organisation. Elles fournissent également un cadre pour le personnel des ressources humaines pour gérer les zones de surveillance. Ces zones incluent le recrutement et la rétention des employés, l&quot;administration des avantages, la formation, les évaluations des performances et la gestion des modifications."
author: rschloma
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
# <a name="welcome-to-human-resources"></a>Bienvenue dans ressources humaines

[!include[banner](includes/banner.md)]

Les ressources humaines simplifient de nombreuses tâches d'archivage de routine et automatisent un certain nombre de processus liés à la dotation en personnel de votre organisation. Elles fournissent également un cadre pour le personnel des ressources humaines pour gérer les zones de surveillance. Ces zones incluent le recrutement et la rétention des employés, l'administration des avantages, la formation, les évaluations des performances et la gestion des modifications.
...
<a name="develop-a-human-resources-strategy"></a>Développer une stratégie de ressources humaines
---------------------------------------------------------

Lorsque vous travaillez avec les ressources humaines, vous allez décider de la structure de votre organisation, à l’aide des éléments, tels que les départements, les tâches et les postes. Ces données comptent parmi les éléments de base que vous allez configurer dans les ressources humaines. Les employés sont affectés aux postes qui sont associés aux tâches.
...
Les projets de recrutement permettent de gérer le contenu utilisé dans les publicités pour les postes à pourvoir et peuvent vous aider à gérer les candidatures aux emplois vacants. Vous pouvez les utiliser pour faire le suivi des réponses aux offres d'emploi pour un projet de recrutement spécifique ou des candidats spécifiques, et mettez à jour le statut des postes vacants. Vous pouvez également embaucher des candidats uniques ou gérer des « projets d’embauche collective », qui facilitent l’embauche de plusieurs travailleurs, par exemple, pour répondre aux besoins saisonniers de l’entreprise.

-   [Manage a recruiting process](manage-recruiting-process.md)
-   [Mass hire projects](mass-hire-projects.md) 

Une fois que vous avez engagé du personnel, vous pouvez définir des plans pour gérer efficacement et équitablement la rémunération, ainsi que gérer des éléments, tels que des ordinateurs ou à des téléphones, que votre organisation prête à ses employés. Vous pouvez créer des régimes de rémunération fixe et variable, et définir des règles qui appliquent le régime de rémunération en fonction des critères de ce programme.
...
Pour aider vos employés à atteindre leurs objectifs de carrière tout en vous offrant des critiques de l’entreprise des besoins peut définir des objectifs, créer des évaluations des performances et suivre vos commentaires pour aider les employés à développer les compétences nécessaires, vous pouvez également définir des instructeurs, les types de cours, cours, descriptions de cours, ordres du jour, suivis et sessions avant d’affecter un instructeur à un cours ou inscrire une personne à un cours. Les instructeurs doivent déjà exister en tant que collaborateurs, candidats ou contacts.

-   [Gestion des performances](performance-management-overview.md)
-   [Aligner les compétences du personnel et des besoins de l’entreprise](skills.md)
...
En plus de rémunérer votre équipe avec les traitements, salaires et primes de compensation, vous pouvez développer des programmes de prestations d’assurance-maladie et des plans d’épargne retraite. Vous pouvez également gérer des avantages, tels que les programmes de prêt, dans lequel votre société prête des éléments, tels que des ordinateurs ou à des téléphones, à ses employés.

-   [Gérer un programme d’avantages sociaux](manage-benefit-program.md)
