...
<a name=""></a>=======
---
# <a name="required-metadata"></a>métadonnées nécessaires

titre : Description de Distribuer et remplir un questionnaire : Cette rubrique décrit comment distribuer les questionnaires que vous créez pour qu'ils soient à la disposition de la personne ou du groupe de personnes qui les complèteront. auteur : responsable de twheeloc : AnnBe ms.date : 20/06/2017 ms.topic : article ms.prod : ms.service : Dynamics365Operations ms.technology : 

# <a name="optional-metadata"></a>métadonnées facultatives

ms.search.form : KMConnectionType, KMKnowledgeCollectorPlanningTabel, SysEmailParameters
# <a name="robots"></a>ROBOTS : 
public : Utilisateur de l'application
# <a name="msdevlang"></a>ms.devlang : 
ms.reviewer : twheeloc ms.search.scope : Noyau, ax 7.0.0, Operations, UnifiedOperations
# <a name="mstgtpltfrm"></a>ms.tgt_pltfrm : 
ms.custom : 17424 ms.assetid : fd8d867a-2446-400a-b91f-ad4085427470 ms.search.region : Mondial
# <a name="mssearchindustry"></a>ms.search.industry : 
ms.author : twheeloc ms.search.validFrom : 28-02-2016 ms.dyn365.ops.version : AX, Talent 7.0.0 mise à jour juillet 2017
...
Utilisez la page **Types de référence** pour paramétrer les types de référence pour un questionnaire. Chaque type de référence correspond à une table dans Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition. Lorsque vous créez des programmes de questionnaires, vous pouvez spécifier des enregistrements individuels dans la table ou une plage d'enregistrements qui seront associés au questionnaire. 
...
**Remarque :** les personnes interrogées doivent être des utilisateurs de Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition pour remplir un questionnaire.
