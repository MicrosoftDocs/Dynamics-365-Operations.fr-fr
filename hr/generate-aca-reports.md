...
description: "La fonctionnalité est disponible pour aider les employeurs devant suivre les informations déclarées dans les formulaires 1095-B and 1095-C à l'appui de la partie Mandat employeur de la Loi sur les soins abordables. Notez que cette fonctionnalité n'est activée que pour les entités juridiques aux États-Unis."
author: kherr
manager: AnnBe
ms.date: 07/01/2017
ms.topic: article
...
La fonctionnalité est disponible pour aider les employeurs devant suivre les informations déclarées dans les formulaires 1095-B and 1095-C à l'appui de la partie **Mandat employeur** de la Loi sur les soins abordables. Notez que cette fonctionnalité n'est activée que pour les entités juridiques aux États-Unis.
