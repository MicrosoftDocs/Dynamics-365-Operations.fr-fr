...
-   Lorsque vous sélectionnez le séparateur pour les plans de comptes, sélectionnez l'une des deux options de séparateur : doublez le trait de l'Union ()), double (barre~~) ou doublez la période (.)., ou doublez le soulignement (\_\_).
