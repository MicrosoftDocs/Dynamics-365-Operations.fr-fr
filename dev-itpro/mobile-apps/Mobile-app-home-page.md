...
<ul>
<li><a href="https://docs.microsoft.com/en-us/dynamics365/operations/financials/cost-accounting/cost-controlling-mobile-workspace">Espaces de travail mobiles Contrôle des coûts</a></li>
<li><a href="https://docs.microsoft.com/en-us/dynamics365/operations/supply-chain/production-control/inventory-on-hand-mobile-workspace">Stock disponible dans l'espace de travail mobile</a></li>
<li><a href="https://docs.microsoft.com/en-us/dynamics365/operations/supply-chain/production-control/sales-orders-mobile-workspace">Espaces de travail mobiles Commandes client</a></li>
<li><a href="https://docs.microsoft.com/en-us/dynamics365/operations/supply-chain/procurement/vendor-collaboration-mobile-workspace">Espace de travail de collaboration fournisseur sur téléphone mobile</a></li>
<li><a href="https://docs.microsoft.com/en-us/dynamics365/operations/financials/project-management/project-time-entry-mobile-workspace">Espace de travail mobile de saisie de l'heure du projet</a></li>
</ul></td>
</tr>
<tr class="odd">
<td>3</td>
...
<td><ul>
<li><a href="https://docs.microsoft.com/en-us/dynamics365/operations/dev-itpro/mobile-apps/mobile-platform">Technologie mobile Dynamics 365 for Operations</a></li>
...
<td><a href="https://docs.microsoft.com/en-us/dynamics365/operations/dev-itpro/deployment/create-apply-deployable-package">Générer un module déployable</a></td>
</tr>
<tr class="even">
<td>6</td>
<td>Administrateur système</td>
<td>Appliquez le module déployable contenant les espaces de travail personnalisés fournis par l'ISV.</td>
<td><a href="https://docs.microsoft.com/en-us/dynamics365/operations/dev-itpro/deployment/apply-deployable-package-system">Appliquer un module déployable à votre système Microsoft Dynamics 365 for Operations</a></td>
</tr>
<tr class="odd">
<td>7</td>
<td>Administrateur système</td>
<td>Publiez les espaces de travail mobiles personnalisés qui sont fournis par l'ISV.</td>
<td><a href="https://docs.microsoft.com/en-us/dynamics365/operations/dev-itpro/mobile-apps/publish-mobile-workspace">Publier un espace de travail mobile</a></td>
</tr>
<tr class="even">
<td>8</td>
<td>Utilisateur</td>
...
<td>Microsoft a fourni les espaces de travail mobiles suivants :
<ul>
<li><a href="https://docs.microsoft.com/en-us/dynamics365/operations/financials/cost-accounting/cost-controlling-mobile-workspace">Espaces de travail mobiles Contrôle des coûts</a></li>
<li><a href="https://docs.microsoft.com/en-us/dynamics365/operations/supply-chain/production-control/inventory-on-hand-mobile-workspace">Stock disponible dans l'espace de travail mobile</a></li>
<li><a href="https://docs.microsoft.com/en-us/dynamics365/operations/supply-chain/production-control/sales-orders-mobile-workspace">Espaces de travail mobiles Commandes client</a></li>
...
[Espaces de travail mobiles récemment activés pour l'application mobile Dynamics 365 for Operations](mobile-workspaces-released.md)
