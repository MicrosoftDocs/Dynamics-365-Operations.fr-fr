...
| Définitions de ligne       | Le nom de la définition de ligne pour l'unité de déclaration. La même définition de ligne est utilisée pour chaque unité de l'arborescence de génération d'états. Lorsque vous générez un rapport, cette définition de ligne est utilisée pour chaque unité de génération d'états. La définition de ligne peut inclure plusieurs liens de dimensions financières. Si une définition de ligne est spécifiée dans l’arborescence de génération d'états, activez la case à cocher **Utiliser la définition de ligne de l'arborescence de génération d'états** sur l'onglet **État** de la définition d'état.|
| Lien de ligne              | Le lien de ligne à utiliser pour l'unité de déclaration. Les liens de ligne sont définis pour la définition de ligne pour identifier les dimensions financières à relier.|
