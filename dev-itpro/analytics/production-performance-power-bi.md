...
- [Entités de données](https://ax.help.dynamics.com/en/wiki/data-entities/)
...
- [Ajout de vignettes Power BI aux espaces de travail](http://ax.help.dynamics.com/en/wiki/configuring-powerbi-integration/)
