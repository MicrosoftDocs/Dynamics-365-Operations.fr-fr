...
| Afficher le rapport                       | Ouvrez la version la plus récente du rapport généré dans Dynamics 365 pour les opérations. Cette commande est disponible à partir d'une définition de rapport si vous avez généré au moins un rapport.                                 |
...
Le menu **Accéder à** est à la disposition de tous les utilisateurs et comprend les commandes suivantes. **Remarque :** Ces commandes n'ont aucun effet visible sauf si le volet de navigation est visible.
...
| Commande | description ;                                                  |
|---------|--------------------------------------------------------------|
| Affiche l'aide    | Ouvrez Dynamics 365 de la page de le wiki d'aide opérations pour les états financiers. |
|         |                                                              |
...
| Bouton                                                                                                                                                                                   | Description                                                                                                                                                                            |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [![New button](./media/rowc130389.png)](./media/rowc130389.png)                              | Permet de créer une définition de rapport, de ligne, de colonne ou d'organigramme d'entreprise vide.                                                                               |
| [bouton en cours de![(]. /media/openfolderc130389.png)](. /media/openfolderc130389.png)               | Permet d'ouvrir une définition de ligne, de colonne, d'organigramme d'entreprise ou de rapport existante.                                                                                   |
| [bouton de sauvegarde d'![] (. /media/savec130389.png)](. /media/savec130389.png)                           | Permet d'enregistrer une définition de ligne, de colonne, d'organigramme d'entreprise ou de rapport en cours.                                                                                   |
| [bouton Copier![] (. /media/copyc130389.png)](. /media/copyc130389.png)                           | Permet de copier le texte sélectionné dans le presse-papiers.                                                                                                                                               |
| [bouton de fractionne![] (. /media/cutc130389.png)](. /media/cutc130389.png)                              | Permet de supprimer le texte sélectionné, puis de le copier dans le presse-papiers.                                                                                                                                |
| [bouton de collage d'![] (. /media/pastec130389.png)](. /media/pastec130389.png)                        | Permet d'insérer le texte à partir du presse-papiers.                                                                                                                                                    |
| [![Annuler le bouton (]. /media/undoc130389.png)](. /media/undoc130389.png)                           | Permet d'annuler la dernière action.                                                                                                                                                                  |
| [![refont le bouton (]. /media/redoc130389.png)](. /media/redoc130389.png)                           | Permet d'annuler la dernière action d'annulation.                                                                                                                                                          |
| [bouton de trouver![] (. /media/findc130389.png)](. /media/findc130389.png)                           | Permet d'ouvrir la boîte de dialogue **Rechercher/Remplacer** dans laquelle vous pouvez rechercher le texte et le remplacer dans la fenêtre active.                                                                                  |
| [bouton de ligne d'insertion d'![] (. /media/insertrowc130389.png)](. /media/insertrowc130389.png)           | Permet d'insérer une ligne vide dans la définition de ligne ou une ligne vide d'en-tête dans la définition de colonne. Cet bouton est disponible à partir d'une définition de ligne ou d'une définition de colonne.                    |
| [bouton de colonne d'insertion d'![] (. /media/insertcolumnc130389.png)](. /media/insertcolumnc130389.png)  | Permet d'insérer une colonne vide dans la définition de colonne. Ce bouton est disponible à partir d'une définition de colonne.                                                                                  |
| [bouton de verrouillage d'![] (. /media/lockc130389.png)](. /media/lockc130389.png)                           | Permet d'appliquer un mot de passe au bloc élémentaire en cours. Ce bouton est à la disposition des utilisateurs ayant le rôle de **Concepteur** ou d'**Administrateur**.                                                 |
| [bouton de liens de ligne![] (. /media/rowlinkc130389.png)](. /media/rowlinkc130389.png)                 | Permet d'ouvrir la boîte de dialogue **Liens de ligne** dans laquelle vous pouvez spécifier les sources des liens de données dans les définitions de ligne et les définitions d'organigramme d'entreprise. Ce bouton est disponible à partir d'une définition de ligne. |
| [![encouragent le bouton (]. /media/promotec130389.png)](. /media/promotec130389.png)                  | Permet de promouvoir une unité de la définition d'organigramme d'entreprise. Lorsque vous sélectionnez une unité enfant, puis cliquez sur **Hausser**, l'unité enfant est déplacée au même niveau que son unité parent.                |
| [![abaissent le bouton (]. /media/demotec130389.png)](. /media/demotec130389.png)                     | Permet d'abaisser une unité de la définition d'organigramme d'entreprise. Lorsque vous sélectionnez une unité, puis cliquez sur **Abaisser**, l'unité devient un enfant de l'unité qui la précède.                               |
| [![développez le bouton (]. /media/expandtreebuttonc130389.png)](. /media/expandtreebuttonc130389.png) | Permet de développer toutes les unités de la définition d'organigramme d'entreprise au niveau de l'unité sélectionnée.                                                                                                   |
| [sur le récapitulatif![] (. /media/collapsec130389.png)](. /media/collapsec130389.png)               | Permet de réduire l'arborescence d'organigramme d'entreprise.                                                                                                                                                           |
...
| Bouton                                                                                                                                                                                                   | Description                                             |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------|
| [bouton de style de police![] (. /media/formattingc130389.png)](. /media/formattingc130389.png)                         | Permet d'appliquer le style de police sélectionné au texte actif.      |
| [bouton de police![] (. /media/fonttype.png)](. /media/fonttype.png)                                                 | Permet d'appliquer la police sélectionnée au texte actif.              |
| [bouton de taille de police![] (. /media/fontsize.png)](. /media/fontsize.png)                                            | Permet d'appliquer la taille de police sélectionnée au texte actif (en points). |
| [bouton gras d'![] (. /media/boldc130389.png)](. /media/boldc130389.png)                                           | Permet d'appliquer le caractère gras au texte actif.                             |
| [bouton italique d'![] (. /media/italicsc130389.png)](. /media/italicsc130389.png)                                   | Permet d'appliquer le caractère italique au texte actif.                           |
| [![ligne] le bouton (. /media/underlinec130389.png)](. /media/underlinec130389.png)                            | Permet d'appliquer le soulignement au texte actif.                             |
| [bouton de retrait![une baisse de![(]. /media/outdentlsc130389.png)](. /media/outdentlsc130389.png)                      | Permet de diminuer le niveau de retrait du texte actif.                |
| [bouton de retrait![augmentation d'![] (. /media/indentlsc130389.png)](. /media/indentlsc130389.png)                        | Permet d'augmenter le niveau de retrait du texte actif.                |
| [bouton de couleur d'arrière-plan![] (. /media/fillbackgroundcolorc130389.png)](. /media/fillbackgroundcolorc130389.png) | Permet de modifier la couleur d'arrière-plan de la cellule active.        |
| [bouton de couleurs de police![] (. /media/fontcolorc130389.png)](. /media/fontcolorc130389.png)                           | Permet de modifier la couleur du texte actif.                   |
...
| Bouton                                                                                                                                                                                          | Description                                                                                                                                                                  |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [bouton de définition de rapport d'![] (. /media/reportc130389.png)](. /media/reportc130389.png)                 | Permet d'afficher la définition de rapport répertoriée sur le menu **Fenêtre**.                                                                                                            |
| [bouton de définition de ligne d'![] (. /media/rowc130389.png)](. /media/rowc130389.png)                          | Permet d'afficher la définition de ligne affectée à la définition de rapport active.                                                                                                    |
| [bouton de définition de colonne d'![] (. /media/columnc130389.png)](. /media/columnc130389.png)                 | Permet d'afficher la définition de colonne affectée à la définition de rapport active.                                                                                                 |
| [bouton de la définition d'organigramme d'entreprise![] (. /media/treec130389.png)](. /media/treec130389.png)             | Permet d'afficher la définition d'organigramme d'entreprise affectée à la définition de rapport active.                                                                                         |
| [bouton de la Visionneuse de rapports![] (. /media/reportviewerc130389.png)](. /media/reportviewerc130389.png)         | Permet de lancer la visionneuse de rapports et d'afficher la dernière version du rapport généré. Ce bouton est disponible à partir d'une définition de rapport si vous avez généré au moins un rapport. |
| [![Générer le bouton du rapport (]. /media/generate-to-ddvc130389.png)](. /media/generate-to-ddvc130389.png) | Permet de générer un rapport à partir de la définition de rapport active. Ce bouton est disponible à partir d'une définition de rapport.                                                                      |
