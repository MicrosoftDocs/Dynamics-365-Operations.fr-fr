...
Pour plus d'informations sur l'enregistrement de tâche, consultez [Enregistreur de tâches dans Finance and Operations](../user-interface/task-recorder.md).
...
--------
[Système d'aide de Finance and Operations (fiche téléchargeable)](https://mbs.microsoft.com/files/public/CS/AX2012R3/DynamicsAXHelpSystemFactSheet.pdf)
