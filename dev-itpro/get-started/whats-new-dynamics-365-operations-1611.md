...
| Le nouveau contenu BI de courant de l'accès cinq se comprime pour Ressources humaines                                     | Les nouveaux packs de contenu permettent aux organisations Ressources humaines et aux responsables des ressources humaines permet d'analyser les opérations suivantes : Les mesures de personnel • Répartitions démographiques par âge, sexe, et état civil • Permet de comparer l'année du taux d'usure et l'exercice et voir la liste des employés de motifs avoir indiqué pour quitter l'organisation • Permet d'afficher la liste des positions de début, ainsi qu'une comparaison d'en cours à la rémunération clôturée et aux avantages de postes • Comparer les employés horaires et salariés • Permet d'afficher le nombre d'employés inscrits à des avantages disponibles • Affichez les employés par le recrutement de type d'emploi • Analyse des candidats en fonction de le nombre de candidats, dans lequel ils passent, et les postes ils appliquent pour la formation organisationnelle • Confirmation de l'enregistrement par emplacement • Présence de Couse par statut • La liste des employés enregistrés pour les compétences et le développement d'employé de cours • Liste des qualifications détenues par les employés • Répartition des types de qualifications par le membre de l'équipe |
...
<td>Lettre de crédit bancaire divers. Format de répartition des frais pour l'Arabie Saoudite</td>
</tr>
<tr class="odd">
...
<td>Cette fonctionnalité apporte une amélioration de la productivité. <strong>Example</strong> You sell a product that is named Polo T-shirt. Ce produit est disponible dans deux couleurs : vert et bleu. Il est également disponible dans deux tailles : S et M. La couleur ou la taille sont des dimensions de produit actives pour le T-shirt de polo. Lorsque vous entrez une ligne de vente pour le T-shirt de polo de couleur verte et de taille S, vous ne devez pas entrer des données dans les champs <strong>Numéro d'article</strong>, <strong>Couleur</strong> et <strong>Taille</strong>. Vous pouvez créer la ligne en suivant la procédure suivante :
<ul>
...
### <a name="personalized-product-recommendations"></a>Recommandations personnalisées de produit

| Ce que vous pouvez faire                                                                                                                                                                                                                                                                        | Pourquoi c'est important                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Permet d'afficher les recommandations personnalisées de produit entre plusieurs touchpoints au point de vente (POS) de déterminer laquelle un client peut être intéressé $ selon leur historique d'achat, articles dans sa liste de souhait, et articles que d'autres clients ont acheté en ligne et dans les magasins de brique-et- physiques | Pour les détaillants avec des catalogues, les recommandations personnalisées permettent le client à la découverte de produit et autorisent les associers de magasin avec clienteling intelligent. Sur présentation de les produits visés aux intérêts d'un client et aux habitudes d'achats, les recommandations de produit peuvent aider les détaillants à l'upsell et peuvent améliorer la rétention client. Dans Dynamics 365 pour les opérations - au détail, recommandations de produit sont actionnés par l'apprentissage azuré cognitif de services et de machine Microsoft. |
...
Le système de magasin est un choix de déploiement pour les détaillants qui permet de mener un ensemble d'opérations de magasin, que ce soit dans un magasin local, un cloud public Microsoft, ou un cloud privé propre au client. Pour la version 7.1 de l'application Microsoft Dynamics AX, la portée est en magasin uniquement. Pour améliorer la prise en charge des environnements avec une connectivité réseau lente et peu fiable, nous devons fournir une option pour autoriser les détaillants à déployer la base de données des canaux et le serveur de vente au détail dans le magasin. Ils peuvent ensuite continuer à exécuter leurs scénarios d'entreprise de base, même s'il n'existe aucune connectivité avec les sièges sociaux. Selon les différents points de données, qui incluaient les discussions de l'équipe d'ingénierie, les résultats d'enquête client, et l'analyse de la concurrence, nous avons identifié la portée de solution suivant comme idéale pour nos clients cibles :
...
| En savoir plus sur la prise en charge de la consignation dans Dynamics 365 for Operations                                                                                                         | Pour plus d'informations sur la prise en charge des processus de consignation, voir consignation [] (/dynamics365/operations/scm/inventory/consignment), [consignation de paramétrage] (/dynamics365/operations/scm/inventory/setup-consignment), [créez une commande de réapprovisionnement de consignation (Guide de tâche)](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/), et [modifiez la propriété de la demande de production de stock de consignation selon (Guide de tâche)](http://ax.help.dynamics.com/en/wiki/change-the-ownership-of-consignment-inventory-based-on-production-demand/).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
| En savoir plus sur la prise en charge de la collaboration fournisseur dans Dynamics 365 for Operations. | Pour plus d'informations sur la collaboration fournisseur, consultez [Collaboration fournisseur avec des fournisseurs externes](/dynamics365/operations/scm/procurement/vendor-collaboration-work-external-vendors), [Collaboration fournisseur avec des clients](/dynamics365/operations/scm/procurement/vendor-collaboration-work-customers-dynamics-365-operations), [Gestion des utilisateurs de la collaboration fournisseur](/dynamics365/operations/scm/procurement/manage-vendor-collaboration-users), [Paramétrage et mise à jour de la collaboration fournisseur](/dynamics365/operations/scm/procurement/set-up-maintain-vendor-collaboration), et [Espace de travail de facturation de collaboration fournisseur](/dynamics365/operations/financials/accounts-payable/vendor-portal-invoicing-workspace).                                                         |
...
<tr class="even">
<td>Créez une promesse de commande directement dans les lignes de commande client. <strong>Exemple</strong> Créez une ligne de commande client qui est originaire d'un fournisseur intersociétés. Quittez la ligne. Les dates de livraison sont calculées en fonction de la disponibilité de la société d'approvisionnement.</td>
