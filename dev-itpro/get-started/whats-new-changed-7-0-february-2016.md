---
title: "Contenu nouveau ou modifiée dans Dynamics AX 7,0 (février 2016)"
...
# <a name="whats-new-or-changed-in-dynamics-ax-70-february-2016"></a>Contenu nouveau ou modifiée dans Dynamics AX 7,0 (février 2016)
...
| Intégration à Microsoft Office Outlook.                                                                             | Non disponible                                                                                                                                                                                      | Les nouvelles fonctionnalités incluent l'application de connecteur de données Excel, la page **Concepteur des classeurs**, l'API d'exportation, et la gestion des documents.                                                                                                        | Vous pouvez créer des solutions de productivité pour les utilisateurs finaux.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
<td>Les options des rapports ont été ajoutées, de sorte que des filtres puissent être appliqués lorsqu'un utilisateur affiche un rapport. Un nouvel état est ensuite généré selon les filtres.</td>
...
<td>Analyse des données financières à l'aide de le contenu BI de courant « de performances financières de surveiller ».</td>
<td>Non disponible</td>
...
<td>Non disponible</td>
<td> L'espace de travail peut être consulté via le tableau de bord de Dynamics AX. Il inclut des liens vers plusieurs nouvelles pages de recherche : **Synthèse Réels/Budget**, **Synthèse Statistique du contrôle budgétaire**, **Écritures de registre budgétaires**, et **Plans budgétaires**.</td>
...
<td>Le système d'aide de la version actuelle de Dynamics AX affiche les guides de tâches qui sont enregistrés dans le BPM Microsoft Dynamics Lifecycle Services (LCS). Le système d'aide affiche également des rubriques à partir du wiki Microsoft. Pour plus d'informations, voir [aide Dynamics AX - obtenant commencés] (help-overview.md) et [les nouveaux guides des tâches disponibles (février 2016)](new-task-guides-available-february-2016.md).</td>
...
<td>Vous devez générer des états **TVA sur ventes et achats** à l'aide de la fonctionnalité TVA non réalisée, afin que les utilisateurs puissent identifier les transactions appartenant aux sections réalisées et non réalisées en fonction du statut.</td>
...
<td>La fonction a été implémentée comme configuration électronique de génération d'états. Cette fonctionnalité est disponible pour l'Allemagne et l'Autriche.</td>
...
<td>La liste des soldes à l'état de comptes totaux par groupe est implémentée comme état SSRS (LedgerAccountSum\_franc).</td>
...
<td>La liste séparée de codes marchandise de déclaration d'échanges de biens sont fusionnées à la hiérarchie de produit de code marchandise de type.</td>
...
<td>Code marchandise de déclaration d'échanges de biens ont un champ de texte pour identifier les unités supplémentaires, et ** produit ** La carte a un champ permet d'identifier la quantité d'unités supplémentaires en kilogrammes.</td>
...
<tr class="odd">
<td>Analyse des données de ventes de canal de vente au détail à l'aide de le contenu BI de courant « performances de canal de vente au détail de l'Analyseur ».</td>
<td>Non disponible</td>
...
<li>Il fournit les modules « prêts à l'emploi » de livraison alternative, tels qu'un site de combinaison/un stockage/mode de variante/transport, selon le critère de livraison le plus rapide (la date disponible la plus proche) dont l'utilisateur peut choisir.</li>
