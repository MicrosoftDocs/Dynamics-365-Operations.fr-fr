...
Certaines des ressources suivantes se réfèrent à une version antérieure de Finance and Operations. Toutefois, une grande partie des informations sur l'application des dimensions par défaut et sur bon nombre des concepts sont identiques dans la version précédente, et les références sont toujours valides.
