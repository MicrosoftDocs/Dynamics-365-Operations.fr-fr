...
## <a name="how-do-i-use-advanced-ledger-entries-to-record-yearend-accrual-entries"></a>Comment utilise les écritures comptables avancées pour enregistrer les écritures de régularisation de fin d'exercice ?
