...
4. Cliquez sur Immobilisation dans le volet Actions.
5. Cliquez sur Ajouts d'immobilisations.
6. Cliquez sur Nouveau.
7. Tapez une valeur dans le champ Nom.
8. Définissez la date de l'achat ou du service en supplément.
9. Entrez le coût de l'article, de la maintenance ou de toute autre amélioration.
10. Dans le champ Quantité, entrer un numéro.
    * Le coût total n'aura pas d'impact sur la valeur de l'immobilisation. Il sert uniquement pour le suivi et à titre indicatif. Si le coût est ensuite capitalisé, une transaction d'augmentation doit être validée séparément.  
