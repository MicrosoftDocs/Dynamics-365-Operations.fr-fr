...
Pour tous les documents qui utilisent des informations supplémentaires affiche les Explorateur de document source, de source de comptabilité, selon les répartitions comptables et, le cas échéant, les répartitions comptables de projet. Ces informations incluent le montant en devises de type, projet, activité, catégorie, et propriété de ligne. Voici quelques exemples de l'analyse que vous pouvez effectuer :
