...
-   [Paramétrage des règles de correspondance du rapprochement bancaire](set-up-bank-reconciliation-matching-rules.md)
-   [Paramétrage des paiements centralisés](set-up-centralized-payments.md)
...
## <a name="accounts-receivable-payments-and-settlements"></a>Paiements et règlements des Ventes
