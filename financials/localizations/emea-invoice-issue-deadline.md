...
| Tâches associées de paramétrage | Dans la page**Intervalles de dates**, paramétrez un intervalle de dates utilisé pour calculer la date d'échéance d'émission de facture. (Cliquez sur ** comptabilité ** &gt; ** paramètre comptable ** &gt; ** intervalles de dates **.) Sous ** paramètres de commerce extérieur ** la page, propriétés de commerce extérieur de paramétrage pour différents pays/régions. (Cliquez sur ** taxe ** &gt; ** paramétrage ** &gt; ** commerce extérieur ** &gt; ** paramètres de commerce extérieur **.) |
...
Pour paramétrer Microsoft Dynamics 365 pour les opérations calcul des dates d'échéance de problème de facture pour les expéditions intra-UE jour le calcul du mois après l'approvisionnement soit fourni, créez un code intervalle de dates et une règle de calcul qui ont les paramètres suivants.
...
-   **Commandes client** – Lorsque vous créez une commande client et validez un bon de livraison, la date d'échéance d'émission des factures est calculée et mise à jour sur le bon de livraison. La date d'échéance est calculée selon l'intervalle de dates qui est associé le pays/la région spécifiée dans l'adresse de livraison de la commande client. Après avoir validé le bon de livraison, vous pouvez vérifier la date d'échéance de problème de facture dans ** facturez la date d'échéance de problème ** le champ sous ** journal des bons de livraison ** la page. (Cliquez sur ** Ventes et marketing ** &gt; ** commande client ** &gt; ** expédition ** &gt; ** bon de livraison **.) Vous pouvez afficher tous les bons de livraison qui ne sont pas facturés, et leur date d'échéance de problème de facture, sous ** des bons de livraison non facturés ** la page. (Cliquez sur ** Ventes et marketing ** &gt; ** commande client ** &gt; ** expédition ** &gt; ** bon de livraison non facturés **.)
-   **Commandes client** – Lorsque vous créez une commande client et validez un accusé de réception de marchandises, la date d'échéance d'émission des factures est calculée et mise à jour sur l'accusé de réception de marchandises. La date d'échéance est calculée en fonction de l'intervalle de dates associé au pays/région spécifié dans l'adresse de livraison principale du fournisseur. Après avoir validé l'accusé de réception de marchandises, vous pouvez vérifier la date d'échéance d'émission de facture dans le champ **Date d'échéance d'émission des factures** de la page **Journal d'accusé de réception de marchandises**. (Cliquez sur ** Approvisionnements ** &gt; ** commandes fournisseur ** &gt; ** réception des produits ** &gt; ** accusé de réception de marchandises **.) Vous pouvez afficher tous les accusés de réception de marchandises qui ne sont pas facturés, et leur date d'échéance de problème de facture, sous ** des accusés de réception de marchandises non facturés ** la page. (Cliquez sur ** Approvisionnements ** &gt; ** commandes fournisseur ** &gt; ** réception des produits ** &gt; ** accusés de réception de marchandises non facturés **.)
...
<td>Cliquez <strong>Administration du système</strong> &gt; <strong>Paramétrage</strong> &gt; <strong>Autorisation</strong> &gt; <strong>Configuration des licences</strong>sur. Cliquez sur la clé de configuration <strong>Comptabilité</strong>.</td>
</tr>
<tr class="even">
