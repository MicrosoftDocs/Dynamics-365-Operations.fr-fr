...
description: "Cette rubrique explique les niveaux de couverture pour la facturation électronique dans Microsoft Dynamics 365 for Finance and Operations, Enterprise edition en Europe."
...
Cette rubrique explique les niveaux de couverture pour la facturation électronique dans Microsoft Dynamics 365 for Finance and Operations, Enterprise edition en Europe. 
...
<a name="what-electronic-invoice-formats-are-currently-supported-in-finance-and-operations"></a>Quels formats de facture électronique sont actuellement pris en charge dans Finance and Operations ?
---------------------------------------------------------------------------------------


Dynamics 365 for Operations (1611) offre l'implémentation de la facturation électronique basée sur les [états électroniques](/dynamics365/unified-operations/dev-itpro/analytics/general-electronic-reporting) Il existe un **Modèle de facture client** et plusieurs configurations de format de génération d'états électroniques spécifiques au pays créées pour l'Autriche, le Danemark, l'Italie, la Norvège et l'Espagne :
