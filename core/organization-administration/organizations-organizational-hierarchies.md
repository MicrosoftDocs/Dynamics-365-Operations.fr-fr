...
Une section est une organisation utilisée pour partager le contrôle des ressources économiques et des processus opérationnels dans une société. Dans une section, les personnes ont la responsabilité d'optimiser l'utilisation des ressources rares, d'améliorer les processus et de justifier leurs performances. Dans Microsoft Dynamics 365 for Finance and Operations, les types de sections incluent les centres de coût, les unités commerciales, les chaînes de valeur, les départements et les canaux de vente au détail. Le tableau suivant fournit d'autres informations sur chaque type de section.
