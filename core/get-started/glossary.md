...
###### <a name="ach-automated-clearing-house"></a>**CCA (Chambre de compensation automatisée)**
...
###### <a name="bundle"></a>**offre groupée**

Combinaison d'un certain nombre de produits à vendre en une seule unité.

###### <a name="business-unit"></a>**unité commerciale**

Unité opérationnelle semi-autonome créée pour répondre aux objectifs commerciaux stratégiques.
...
Le plus petit groupe d'immobilisations classables qui génère des disponibilités indépendamment d'autres immobilisations au sein d'une organisation. Ces groupes d'immobilisations sont utilisés pour mesurer les pertes pour dégradation qui seront encourues.
...
###### <a name="financial-dimensionsdimension-based-configuration"></a>**..\dimensions financières\configuration basée sur les dimensions**
...
###### <a name="eft-electronic-funds-transfer"></a>**TEF (Transfert électronique de fonds)**
...
Relation numérique entre les entrées et les sorties du processus de production.
...
###### <a name="gst-goods-and-services-tax"></a>**GST (Taxe sur les Produits et Services)**
...
Définit la séquence des activités exécutées pour les kanbans créés pour une règle de kanban.

###### <a name="kanban-job"></a>**tâche de kanban**

Activité de traitement ou de transfert dans un flux de production déclenché par un kanban.
...
Attributs de produit (taille, couleur ou configuration) utilisés dans le cadre de ..\dimensions financières\configuration basée sur les dimensions.
...
Quantité de produits documentée sur une ligne de document source qui crée un besoin d'origine des besoins.
...
Quantité d'un ou plusieurs articles transférée ou pouvant faire l'objet d'un transfert.
...
Unité opérationnelle qui contrôle un ou plusieurs flux de production.
