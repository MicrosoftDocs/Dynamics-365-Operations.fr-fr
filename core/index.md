---
title: "Présentation de Dynamics 365 pour les opérations"
description: "Microsoft Dynamics 365 pour les opérations est l’application d’entreprise de Microsoft pour les entreprises. Cette page vous aide à en savoir plus et commencez à utiliser le produit."
author: margoc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
---
# <a name="introduction-to-dynamics-365-for-operations"></a>Présentation de Dynamics 365 pour les opérations

[!include[banner](includes/banner.md)]

Microsoft Dynamics 365 pour les opérations est l’application d’entreprise de Microsoft pour les entreprises. Il permet aux utilisateurs de rapidement prendre de meilleures décisions grâce à une interface d’utilisateur intelligent qui fournit l’accès à des analyses en temps réel et des données. Il permet aux entreprises de transformation et de l’innnovate en fournissant la logique métier éprouvée qui leur permet de remanier leurs processus métiers plus rapidement. Il permet aux entreprises de croissance à leur propre rythme et de faire des affaires de presque n’importe où, à tout moment, ce qui permet de les mettre à l’échelle de leurs opérations de manière globale afin de répondre aux besoins de l’entreprise. 

Ce guide peut vous aider à apprendre comment utiliser 365 Dynamics pour les opérations de votre entreprise.    
...
<p><a href="dev-itpro/lcs-solutions/country-region.md">Caractéristiques régionales</a></p>
<p>Ressources humaines</p>
   <ul>
  <li><a href="human-resources/departments-jobs-positions.md">Stratégie de ressources humaines</a></li>
  <li><a href="human-resources/manage-recruiting-process.md">Recrutement, d’embauche et motivation</a></li>
  ...
  <li><a href="human-resources/localizations/noam-usa-payroll.md">Fonctionnalités des États-Unis</a></li>
</ul></td>
  <td>
  <p>Vente au détail</p>
  <ul>
<li><a href="retail/call-center-functionality.md">Call center</a></li>
  ...
  <li><a href="retail/define-maintain-channel-clients-registers-hw-stations.md">POS MPOS et nuage</a></li>
  <li><a href="retail/dev-itpro/dev-retail-home-page.md">Administration et développement de la vente au détail</a></li></ul>
...
<li><a href="supply-chain/cost-management/costing-sheets.md">Cost management</a></li>
  ...
  <p>Fonctionnalités de développeur et d’administrateur</p>
