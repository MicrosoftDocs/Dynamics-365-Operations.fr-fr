...
# <a name="customer-transaction-list-page"></a>Page Liste des transactions client
...
1. Sélectionnez **Comptabilité client \> Clients**.
2. Sélectionnez un client avec des transactions, puis sélectionnez **Client \> Transactions**.
3. Sélectionnez une transaction à rechercher.
4. Sélectionnez l'onglet **Afficher les règlements** dans le volet Actions.

    La boîte de dialogue **Afficher les règlements** affiche la transaction sélectionnée et tous les documents réglés qui lui sont associés. Cette boîte de dialogue ressemble à la vue de l'historique des règlements, mais elle comprend tous les documents associés. 
