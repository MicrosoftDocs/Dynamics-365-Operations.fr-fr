...
Cet article présente une vue d'ensemble de l'autorisation de la carte de crédit dans Microsoft Dynamics 365 for Finance and Operations. Il inclut des informations sur le paramétrage d'un service de paiement, l'ajout d'une carte de crédit à une commande client et l'annulation d'une autorisation.
