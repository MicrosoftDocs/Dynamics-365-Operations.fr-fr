...
---
# <a name="revenue-recognition-overview"></a>Présentation de la constatation du produit
...
* Affecter le produit, pour garantir que le prix approprié est bien identifié en fonction de la valeur des composants sur les commandes à plusieurs éléments.
* Différer le produit, selon un échéancier de produit qui représente le calendrier et les pourcentages contractuels pour reconnaître le produit dans le temps.
...
Lorsque la commande client est confirmée, un échéancier de produit attendu est également créé s'il se trouve dans une ligne de commande. Lorsque la commande client est facturée, l'échéancier de produit attendu est supprimé et remplacé par l'échéancier de constatation du produit réel.
