...
# <a name="add-new-location-roles-and-party-relationship-types"></a>Ajouter de nouveaux rôles d'emplacement et de nouveaux types de relation de partie 

## <a name="add-new-location-roles"></a>Ajouter de nouveaux rôles d'emplacement
...
## <a name="add-new-party-relationship-types"></a>Ajouter de nouveaux types de relation de partie 
