...
5. Cliquez sur Propositions.
6. Cliquez sur Proposition d'acquisition.
7. Cliquez sur Filtre.
8. Cliquez sur Réinitialiser pour effacer les valeurs précédentes.
9. Sélectionnez la ligne Numéro d'immobilisation.
10. Dans le champ Critères, saisissez ou sélectionnez une valeur.
    * Définissez les critères restants pour les immobilisations à acquérir avec cette proposition.  
11. Cliquez sur OK.
12. Cliquez sur OK.
...
13. Cliquez sur l'onglet Registres.
