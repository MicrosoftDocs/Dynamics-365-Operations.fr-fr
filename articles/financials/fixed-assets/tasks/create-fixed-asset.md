...
1. Allez dans le **Volet de navigation > Modules > Immobilisations > Immobilisations > Immobilisations**.
...
4. Tapez une valeur dans le champ **Nom**. Entrez les informations supplémentaires dont votre entreprise a besoin pour cette immobilisation.  
5. Dans le volet **Actions**, cliquez sur **Registres**.
