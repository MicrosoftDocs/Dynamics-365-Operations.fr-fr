...
description: "Cette rubrique explique comment configurer la manière dont les données par défaut sont entrées lorsque vous intégrez Microsoft Dynamics 365 for Project Service Automation à Microsoft Dynamics 365 for Finance and Operations."
author: KimANelson
manager: AnnBe
ms.date: 07/20/2018
ms.topic: article
...
Sur la page **Paramètres d'intégration de Project Service Automation**, vous pouvez configurer la manière dont les données par défaut sont entrées lorsque vous intégrez Microsoft Dynamics 365 for Project Service Automation à Microsoft Dynamics 365 for Finance and Operations. Pour que les projets soient correctement synchronisés entre Project Service Automation et Finance and Operations, vous devez paramétrer les champs suivants.
