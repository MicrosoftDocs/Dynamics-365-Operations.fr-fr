...
1. <span data-ttu-id="86cba-110">Accédez à Gestion de projets et comptabilité > Paramétrage > Paramètres de gestion de projets et de comptabilité.</span><span class="sxs-lookup"><span data-stu-id="86cba-110">Go to Project management and accounting > Setup > Project management and accounting parameters.</span></span>
2. <span data-ttu-id="86cba-111">Cliquez sur l'onglet Stade de projet.</span><span class="sxs-lookup"><span data-stu-id="86cba-111">Click the Project stage tab.</span></span>
3. <span data-ttu-id="86cba-112">Dans le champ Langue, sélectionnez la langue que vous souhaitez utiliser pour le nom du nouveau stade de projet.</span><span class="sxs-lookup"><span data-stu-id="86cba-112">In the Language field, select the language that you want to use for the new project stage name.</span></span>
4. <span data-ttu-id="86cba-113">Dans la liste, sélectionnez le stade prédéfini ou défini par l'utilisateur à modifier.</span><span class="sxs-lookup"><span data-stu-id="86cba-113">In the list, select the predefined or user-defined stage that you want to modify.</span></span> 
5. <span data-ttu-id="86cba-114">Entrez le nom du nouveau nom dans le champ Stade de projet.</span><span class="sxs-lookup"><span data-stu-id="86cba-114">In the Project stage field, enter the new name.</span></span>
6. <span data-ttu-id="86cba-115">Cliquez sur Enregistrer.</span><span class="sxs-lookup"><span data-stu-id="86cba-115">Click Save.</span></span>
