...
- <span data-ttu-id="bd505-109">Pour imprimer une description de codes taxe sur une facture client, la facture financière ou l'état des factures du projet, paramétrez le texte de référence aux instructions relatives à la taxe sur les codes de taxe.</span><span class="sxs-lookup"><span data-stu-id="bd505-109">To print a description of sales tax codes on a sales invoice, free text invoice, or project invoice report, set up the Tax Directive reference text on the sales tax codes.</span></span>
- <span data-ttu-id="bd505-110">Pour les avoirs, le numéro et la date de la facture d'origine sont imprimés avec le motif de la correction.</span><span class="sxs-lookup"><span data-stu-id="bd505-110">For credit notes, the number and date of the original invoice are printed along with the reason for correction.</span></span>
