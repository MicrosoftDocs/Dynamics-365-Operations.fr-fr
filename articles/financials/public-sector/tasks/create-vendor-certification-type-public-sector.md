...
ms.openlocfilehash: b93c416fe8e9372f9176dd3beed89a104b102eb1
...
1. <span data-ttu-id="1dd79-106">Accédez à Approvisionnements > Paramétrage > Fournisseurs > Type de certification.</span><span class="sxs-lookup"><span data-stu-id="1dd79-106">Go to Procurement and sourcing > Setup > Vendors > Certification type.</span></span>
2. <span data-ttu-id="1dd79-107">Cliquez sur Nouveau.</span><span class="sxs-lookup"><span data-stu-id="1dd79-107">Click New.</span></span>
3. <span data-ttu-id="1dd79-108">Dans le champ Type de certification, tapez une valeur.</span><span class="sxs-lookup"><span data-stu-id="1dd79-108">In the Certification type field, type a value.</span></span>
4. <span data-ttu-id="1dd79-109">Dans le champ Description, entrez une valeur.</span><span class="sxs-lookup"><span data-stu-id="1dd79-109">In the Description field, type a value.</span></span>
5. <span data-ttu-id="1dd79-110">Cliquez sur Enregistrer.</span><span class="sxs-lookup"><span data-stu-id="1dd79-110">Click Save.</span></span>
