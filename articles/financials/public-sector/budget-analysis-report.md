...
| Période de cycle budgétaire | Spécifiez le cycle budgétaire pour lequel créer l'état. Pour plus d'informations, voir [Définir des cycles budgétaires](https://docs.microsoft.com/en-us/dynamicsax-2012/appuser-itpro/define-budget-cycles). |
