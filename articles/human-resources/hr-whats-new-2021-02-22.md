...
description: Cet article décrit les fonctionnalités qui sont nouvelles ou ont été modifiées dans Microsoft Dynamics 365 Human Resources pour le 22 février 2021.
author: marcelbf
ms.date: 02/22/2021
ms.topic: article
ms.prod: ''
...
Pour plus d’informations sur le processus de mise à jour du service, voir [Processus de mise à jour](./hr-admin-setup-update-process.md).
