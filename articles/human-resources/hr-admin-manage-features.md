...
description: Cet article décrit la fonctionnalité de gestion des fonctionnalités et son utilisation.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
...
Vous pouvez afficher les informations de ces pages en mode lecture seule. Si vous souhaitez modifier les informations, vous devez d’abord désactiver la fonction d’aperçu de la gestion des avantages (applicable uniquement aux environnements de type **Bac à sable**).
