...
description: Cet article fournit des détails un exemple de requête pour l’entité Régime de rémunération fixe dans Dynamics 365 Human Resources.
author: jcart
ms.date: 08/25/2021
ms.topic: article
ms.prod: ''
...
Cet article décrit l’entité du plan de rémunération fixe de la paie pour Dynamics 365 Human Resources.
