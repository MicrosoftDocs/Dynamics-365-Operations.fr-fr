...
description: Cet article fournit un exemple de requête pour l’entité Demande de recrutement dans Dynamics 365 Human Resources.
author: jaredha
ms.date: 02/05/2021
ms.topic: article
ms.prod: ''
...
Cet article fournit un exemple de requête pour l’entité Demande de recrutement dans Dynamics 365 Human Resources.
