...
description: Cet article explique comment optimiser les performances lorsque vous utilisez la fonctionnalité Apporter votre propre base de données (BYOD) avec Microsoft Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/17/2020
ms.topic: article
ms.prod: ''
