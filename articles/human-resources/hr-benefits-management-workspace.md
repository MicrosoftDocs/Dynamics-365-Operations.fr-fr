...
Sélection des vignettes **Événements de la vie active** ou **Événements futurs de la vie** vous amène à une liste d’événements de la vie actifs ou futurs.
...
Pour afficher une période de prestations différente, sélectionnez-la dans menu déroulant **Période**.
...
Pour afficher plus d’informations et d’actions que vous pouvez effectuer, sélectionnez **Liens**.
