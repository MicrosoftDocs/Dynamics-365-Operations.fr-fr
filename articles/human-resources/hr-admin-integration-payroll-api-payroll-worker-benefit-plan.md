...
description: Cet article fournit des détails et un exemple de requête pour l’entité Régime des avantages sociaux pour les collaborateurs de la paie dans Dynamics 365 Human Resources.
author: twheeloc
ms.date: 07/28/2021
ms.topic: article
ms.prod: ''
...
Cet article décrit l’entité Régime des avantages sociaux pour les collaborateurs de la paie pour Dynamics 365 Human Resources.
