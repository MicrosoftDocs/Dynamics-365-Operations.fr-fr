...
description: Cet article montre comment configurer, générer, mettre à jour les tables virtuelles existantes et analyser les tables générées et disponibles pour Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
