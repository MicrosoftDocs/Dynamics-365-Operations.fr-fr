...
L'onglet **Rémunération** affiche le salaire annuel de l'employé. Un identifiant d'entreprise s'affiche sous le montant du salaire. Si un employé a plusieurs emplois et est payé par plusieurs entités juridiques, l'employé aura plusieurs cartes de rémunération. Le dernier montant et pourcentage d'augmentation s'affiche, en fonction de la société d'emploi.
