...
> [!IMPORTANT]
> L'intégration entre Dynamics 365 Human Resources et LinkedIn Talent Hub décrite dans cette rubrique sera obsolète le 31 décembre 2021. Le service d'intégration ne sera plus disponible après cette date. Les organisations qui n'utilisent pas déjà le service d'intégration ne pourront pas mettre en œuvre le service avant cette mise hors service.
