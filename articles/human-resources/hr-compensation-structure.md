...
description: Cet article explique comment créer un régime de rémunération fixe et inscrire les employés au régime par le biais de règles d’admissibilité.
author: twheeloc
ms.date: 08/25/2021
...
Cet article décrit comment créer un régime de rémunération fixe et inscrire les employés au régime par le biais de règles d’admissibilité. Cet article utilise les données de démonstration USMF et s’adresse aux gestionnaires des rémunérations et avantages.
