...
description: Cet article décrit les options de couverture dans Microsoft Dynamics 365 Human Resources pour le choix d’un participant dans un régime de prestations sociales.
author: twheeloc
ms.date: 08/24/2021
ms.topic: article
ms.prod: ''
