...
9. Dans le champ Quantité, entrez le nombre de postes de prévision à créer.
    * La date de début deviendra la date d'embauche pour les nouveaux travailleurs.  
    * La date de fin deviendra la date de fin de contrat pour les nouveaux travailleurs.  
    * Spécifiez si les nouveaux travailleurs sont des employés ou des fournisseurs.  
