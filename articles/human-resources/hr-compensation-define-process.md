...
1. Accédez à **Gestion de la rémunération** > **Processus** > **Processus de rémunération**.
2. Sélectionnez **Nouveau processus de rémunération**.
...
17. Dans le champ **Plan**, saisissez ou sélectionnez une valeur.
...
2. Sélectionnez **Oui** dans le champ **Afficher les résultats du traitement**.
3. Cliquez sur **OK**.
