...
description: Human Resources propose un ensemble d’outils pouvant servir à paramétrer et à mettre à jour les avantages, les déductions et les plans de compensation des collaborateurs qu’une organisation offre ou gère pour ses collaborateurs. Cette rubrique fournit des informations sur la manière de paramétrer et de gérer les avantages.
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
