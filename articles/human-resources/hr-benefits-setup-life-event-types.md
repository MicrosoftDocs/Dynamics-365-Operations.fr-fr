...
---
# <a name="configure-life-event-types"></a>Configuration des types d'événements de vie
...
| Modification de la couverture (salaire) | Collaborateur > Rémunération > Plan fixe | Le salaire annuel des avantages est recalculé automatiquement lorsque vous modifiez la rémunération |
