...
Cet article décrit la configuration requise pour Microsoft Dynamics 365 Human Resources. Elle décrit également les pays et régions où Human Resources est disponible, et fournit des informations sur les langues et la localisation des données pour Human Resources.

## <a name="supported-web-browsers"></a>Navigateurs Web pris en charge

Human Resources peut s'exécuter dans n'importe lequel des navigateurs Web suivants qui s'exécutent sur les systèmes d'exploitation spécifiés : 
...
> * La bande passante requise pour Human Resources dépend de votre scénario. La plupart des scénarios habituels nécessitent une bande passante de plus de 50 kilo-octets par seconde (KBps).
> 
> [!WARNING]
