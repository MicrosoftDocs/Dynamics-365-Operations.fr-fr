...
description: Cet article décrit les projets d’embauche collective qui autorisent les spécialistes des ressources humaines à créer plusieurs postes et à embaucher de manière efficace des collaborateurs pour ces postes.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
