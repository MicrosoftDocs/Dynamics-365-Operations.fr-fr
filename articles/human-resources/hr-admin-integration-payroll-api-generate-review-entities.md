...
description: Cet article décrit comment générer et examiner les entités de paie.
author: twheeloc
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
...
## <a name="review-payroll-entities"></a>Réviser les entités de paie

Utilisez cette API pour récupérer une liste des entités qui ont été générées avec succès et sont prêtes à être utilisées.
