...
description: Cet article explique comment résoudre les enregistrements qui ne se synchronisent pas correctement entre Microsoft Dynamics 365 Human Resources et la solution Human capital management (HCM) Common dans Microsoft Dataverse.
author: jaredha
ms.date: 09/27/2021
ms.topic: article
ms.prod: ''
