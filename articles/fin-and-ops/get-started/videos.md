---
title: "Vidéos de Dynamics 365 for Finance and Operations"
...
# <a name="videos-for-dynamics-365-for-finance-and-operations"></a>Vidéos de Dynamics 365 for Finance and Operations
...
- [Synchroniser un ordre d'exécution entre Dynamics 365 for Field Service et Finance and Operations](https://www.youtube.com/watch?v=hAB4TDVMjxU&t=2s)
...
- [Intégration de Visual Studio Team Services avec Lifecycle Services](https://www.youtube.com/watch?v=0QyyyUp1zHQ&t=1s)
...
- [Incorporer PowerApps](https://www.youtube.com/watch?v=x3qyA1bH-NY)
...
Les [forums techniques FastTrack for Dynamics 365](https://infopedia.eventbuilder.com/index?landingpageid=92tzhl) visent à fournir des informations techniques et des recommandations afin que les clients et les partenaires puissent avoir des connaissances détaillées spécifiques aux domaines d'intérêt. Les sections suivantes répertorient les enregistrements techniques FastTrack qui sont disponibles à la diffusion en continu ou au téléchargement. Vous pouvez également télécharger une copie PDF du document de présentation à partir du site Tech Talk. 

#### <a name="data-management"></a>Gestion des données
- [Copier dans une entité juridique (DYN383PAL)](https://infopedia.eventbuilder.com/event?eventid=q3h0m7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Gestion des données (DYN445PAL2)](https://infopedia.eventbuilder.com/event?eventid=a7n1v0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Réduire le délai d'importation et d'exportation des données à l'aide de configurations (DYN315PAL)](https://infopedia.eventbuilder.com/event?eventid=s6v1q3&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="demo-data"></a>Données de démonstration
- [Packages de données de démonstration (DYN443PAL)](https://infopedia.eventbuilder.com/event?eventid=m2r4o6&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="deployment"></a>Déploiement 
- [Déploiement sur site (DYN382PAL2)](https://infopedia.eventbuilder.com/event?eventid=m9i7a2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
- [Approche de test des performances (DYN449PAL)](https://infopedia.eventbuilder.com/event?eventid=i1u5m9&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
#### <a name="intelligence"></a>Intelligence
- [Options d'analyse et de génération d'états, impression et agent d'acheminement de documents (DYN442PAL)](https://infopedia.eventbuilder.com/event?eventid=r6d9a6&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Présentation des espaces de travail analytiques (DYN317PAL)](https://infopedia.eventbuilder.com/event?eventid=h6e1a7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="mobile"></a>Téléphone portable
- [Espace de travail mobile Dépenses et projet (DYN379PAL2)](https://infopedia.eventbuilder.com/event?eventid=u0g9h5&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Structure mobile (VIR824PAL)](https://infopedia.eventbuilder.com/event?eventid=p2o7n7&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="procurement-and-sourcing"></a>Approvisionnements
- [Pointage à la sortie (DYN332PAL2)](https://infopedia.eventbuilder.com/event?eventid=w5u5q8&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Collaboration du fournisseur (DYN327PAL)](https://infopedia.eventbuilder.com/event?eventid=c3e4c0&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
...
- [Paramétrage de Visual Studio Team Services (VSTS) (VIR782PAL)](https://infopedia.eventbuilder.com/event?eventid=g9f8g1&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)

#### <a name="warehouse-management"></a>Gestion des entrepôts
- [Ajouts à la réception de contenant mixte (DYN331PAL)](https://infopedia.eventbuilder.com/event?eventid=e0u6t2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Réapprovisionnement de la demande pour le prélèvement de matières premières (DYN333PAL2)](https://infopedia.eventbuilder.com/event?eventid=i5p9d2&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
- [Processus de migration des articles et entrepôts pour la gestion avancée des entrepôts (DYN316PAL)](https://infopedia.eventbuilder.com/event?eventid=w0k4b4&source=Dynamics_365_for_Operations_-_FastTrack_Tech_Talks)
