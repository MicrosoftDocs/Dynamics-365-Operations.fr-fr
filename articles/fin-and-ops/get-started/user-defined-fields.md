...
3.   Le menu déroulant **Langue** affiche l'ensemble des langues pour lesquelles des traductions ont déjà été fournies. 
     1.   Si vous souhaitez modifier une traduction existante, sélectionnez la langue souhaitée dans le menu et modifiez les valeurs du libellé et du texte d'aide.  
     2.   Sinon, cliquez sur le bouton **Ajouter une langue**, sélectionnez la langue souhaitée dans le menu, puis entrez les valeurs traduites pour le libellé et le texte d'aide.  
