...
3. Choisissez de supprimer ou non des pièces qui n'ont pas été affectées à un rôle.
4. Choisissez de vérifier ou non les enregistrements en double.
5. Choisissez d'afficher ou non le numéro DUNS sur les adresses.
6. Choisissez de vérifier ou non la présence de numéros DUNS uniques.
7. Dans le champ Partie, sélectionnez une option.
8. Dans le champ Client, sélectionnez une option.
...
13. Dans la liste, recherchez et sélectionnez l'enregistrement souhaité.
    * Appuyez sur la touche Shift pour sélectionner plusieurs rôles à ajouter au volet Rôles sélectionnés, puis cliquez sur la flèche pour ajouter les rôles sélectionnés.  
