...
---
# <a name="configure-the-system-to-send-workflow-related-email-to-users"></a>Configuration du système pour envoyer un e-mail associé au workflow aux utilisateurs
