...
description: Cet article explique comment configurer les différentes propriétés d’une décision manuelle.
author: ChrisGarty
ms.date: 06/15/2020
ms.topic: article
ms.prod: ''
...
Cet article explique comment configurer les différentes propriétés d’une décision manuelle.
