...
> [!NOTE]
> Une fois qu’une unité opérationnelle a été ajoutée à une hiérarchie, l’unité opérationnelle ne peut pas être supprimée. 
...
- [Créer une hiérarchie d’organisation](tasks/create-organization-hierarchy.md)
- [Créer une entité juridique](tasks/create-legal-entity.md)
- [Créer une unité opérationnelle](tasks/create-operating-unit.md)
