...
description: Cet article explique comment configurer les différentes propriétés d’un workflow.
author: ChrisGarty
ms.date: 07/07/2020
ms.topic: article
ms.prod: ''
...
Cet article explique comment configurer les différentes propriétés d’un workflow.
