...
> [!NOTE]
> Les informations suivantes sont fournies afin que vous puissiez planifier en conséquence. Pour plus d'informations sur la planification du lancement de la version 10.0.13 ciblée, voir [Disponibilité des mises à jour de service](../../fin-ops/get-started/public-preview-releases.md).

- [KB 4563317] Les info-bulles ne sont pas affichées pour les images.
