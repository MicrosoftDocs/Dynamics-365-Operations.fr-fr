...
description: L’article indique les fonctionnalités prises en charge dans le cloud et sur site.
author: sericks007
ms.date: 01/14/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9644139"
---
# <a name="comparison-of-cloud-and-on-premises-features"></a>Comparaison des fonctionnalités dans le cloud et sur site

[!include [banner](../includes/banner.md)]

Cet article affiche une comparaison des fonctionnalités disponibles dans le cloud ou sur site pour les applications suivantes :
