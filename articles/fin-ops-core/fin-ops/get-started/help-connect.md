...
Le système d’aide intégré au produit extrait des articles Microsoft Learn et d’autres sites Web connectés. Il extrait également des guides de tâche stockés dans le Concepteur de processus d’entreprise (BPM) dans Microsoft Dynamics Lifecycle Services (LCS).
