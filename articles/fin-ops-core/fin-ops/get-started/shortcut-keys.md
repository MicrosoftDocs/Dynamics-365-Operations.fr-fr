...
Les raccourcis clavier suivants peuvent vous aider rapidement et efficacement à la saisie des données.
...
| Accéder à l'option suivante/précédente dans un menu          | Flèche Haut/Flèche Bas            |
...
| Sélectionner la date du jour                     | T                                         |
| Désactiver la date sélectionnée               | C                                         |
...
| Effectuer un déplacement vers la barre de navigation                                                    | Alt+M, N ou Alt+Maj+F1    |
| Effectuer un déplacement vers le sélecteur de société                                                    | Ctrl+Maj+O               |
| Rechercher une page                                                             | Ctrl+/ ou Alt+G            |
...
| Ouvrir la boîte de dialogue de personnalisation rapide du contrôle sélectionné (à l'aide de l'outil Sélectionner)                              | Espace ou Entrée                      |
...
| Effectuer un basculement si le contrôle actuel est en séquence de tabulation (à l'aide de l'outil Ignorer)                                   | Espace ou Entrée                      |
...
| Exporter une personnalisation (lorsque vous êtes en mode personnalisation)                                                                | O                                   |
| Désactiver les personnalisations de cette page (lorsque vous êtes en mode personnalisation)                                                      | Ctrl+C                              |
| Déplacer la vue entre la barre d'outils de personnalisation et la page (lorsque vous êtes en mode personnalisation)                             | T                                   |
...
| Effectuer un basculement entre les modes « Afficher valide » et « Afficher tout »                                                                        | Alt+W                            |
...
- [Raccourcis clavier dans le Concepteur de rapports](../../../finance/general-ledger/financial-reporting-keyboard-shortcuts.md)
