...
3. Configurez l'application incorporée :
    ...
    - Le champ **ID d'application** indique l'identificateur global unique (GUID) de l'application canevas que vous souhaitez incorporer. Pour récupérer cette valeur, recherchez l'application sur [web.powerapps.com](https://web.powerapps.com), puis consultez le champ **ID d'application** sous **Détails**.
