...
- Personnalisations associées à l'utilisation d'une page, appelées personnalisations *implicites*. Par exemple, le système garde un suivi de la largeur des colonnes de la grille si vous les ajustez, et de l'état développé ou réduit des organisateurs.
