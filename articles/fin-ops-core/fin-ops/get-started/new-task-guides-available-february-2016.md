...
description: Cet article répertorie les tâches qui ont été publiées dans les bibliothèques Microsoft BPM à compter de février 2016.
author: josaw1
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8861732"
---
# <a name="new-task-guides-february-2016"></a>Nouveaux guides des tâches (février 2016)

[!include [banner](../includes/banner.md)]

Cet article répertorie les tâches qui ont été publiées dans les bibliothèques Microsoft BPM à compter de février 2016. Les bibliothèques qui ont été publiées incluent la bibliothèque unifiée APQC (février 2016) pour Microsoft Dynamics AX et Mise en route (février 2016).
...
|-----------------------------------------------------------|----------------|
| Données de facture clés dans le système de comptabilité fournisseur à l’aide de la facture fournisseur        | Général         |
...
| Données de facture clés dans le système de comptabilité fournisseur à l’aide du registre des factures    | Général         |
| Enregistrer la facture fournisseur et la mettre en correspondance avec la quantité reçue | Général         |
...
| Créer et traiter des factures financières                       | Général         |
...
| Traitement des intérêts                                            | Général         |
...
| Régler un chèque postdaté provenant d’un client                             | Général         |
| Vue d’ensemble des paiements fournisseurs                                              | Général         |
...
| Ligne BPM                                                            | Pays/région |
|---------------------------------------------------------------------|----------------|
| Comparer les coûts actifs, estimés et exécutés sur un ordre de fabrication | Général         |
| Afficher les entrées de coût pour un objet de coût                                 | Général         |
| Afficher le solde des objets de coût                                            | Général         |
...
| Ligne BPM                                                                                               | Pays/région                  |
|--------------------------------------------------------------------------------------------------------|---------------------------------|
| Ajouter des zones de déclaration BAS et générer la déclaration d’activité commerciale BAS pour l’Australie                        | Australie et Nouvelle-Zélande       |
| Configurer les codes motif pour le BAS australien                                                                  | Australie et Nouvelle-Zélande       |
| Affectation d’un format de bordereau de paiement à un compte client                                                     | Danemark                         |
...
| Valider une facture financière avec un bordereau de paiement                                                           | Danemark                         |
| Valider une facture de projet avec un bordereau de paiement                                                             | Danemark                         |
| Valider une facture de vente avec un bordereau de paiement                                                               | Danemark                         |
...
| Configurer le format du bordereau de paiement pour les factures de projet                                                         | Danemark                         |
| Créer et exporter des paiements fournisseur à l’aide d’un format de paiement SEPA                                          | Europe                          |
...
| Importer la configuration du virement SEPA                                                              | Europe                          |
| Importer la configuration du débit direct SEPA                                                                 | Europe                          |
| Configurer les comptes bancaires de société pour les virements SEPA                                                 | Europe                          |
| Configurer les comptes bancaires de société pour les débits directs SEPA                                                    | Europe                          |
| Configurer les clients et les comptes bancaires du client pour les débits directs SEPA                                     | Europe                          |
| Configurer le mode de paiement pour les virements SEPA                                                      | Europe                          |
| Configurer le mode de paiement pour les débits directs SEPA                                                         | Europe                          |
| Configurer les fournisseurs et les comptes bancaires fournisseur pour les virements SEPA                                      | Europe                          |
| FR-00002 Relevés de compte client et fournisseur                                                        | France                          |
...
| Créer un compte fournisseur et joindre la déclaration de facture                                             | Islande                         |
| IS-00005 État de rapprochement de TVA                                                                     | Islande                         |
| Configurer une déclaration de facture pour les fournisseurs                                                              | Islande                         |
| Configurer les références de paiement obligatoires                                                                    | Islande                         |
| Mettre à jour les déclarations de facture fournisseur et générer l’état associé                                             | Islande                         |
| Acquisition d’une immobilisation avec des obligations de suppression d’immobilisation                                                | Japon                           |
| Acquisition d’immobilisations, réclamation de subvention gouvernementale et application de l’entrée de réduction                         | Japon                           |
...
| Modifier la méthode d’amortissement lors de la vie de l’actif pour un modèle de valeur                                   | Japon                           |
| CN-00004 Allocation spéciale pour amortissement d’immobilisation (JP-)                                                     | Japon                           |
| Configurer le profil d’amortissement et le profil de validation pour l’amortissement supplémentaire                         | Japon                           |
| Configurer le profil d’amortissement et le profil de validation pour l’amortissement spécial                            | Japon                           |
...
| Créer un profil d’amortissement accéléré et l’affecter au modèle de valeur                                   | Japon                           |
...
| Créer et confirmer une facture consolidée client                                                     | Japon                           |
...
| Générer le fichier de paiement de TEF au format JBA                                                              | Japon                           |
| Générer la déclaration de taxes sur la consommation japonaise                                                                  | Japon                           |
| Importer le paiement client au format de fichier JBA                                                           | Japon                           |
...
| Proposer et valider un amortissement accéléré                                                              | Japon                           |
...
| Régler les factures client consolidées à l’aide des transactions de règlement                                     | Japon                           |
...
| GB-00002 Création d’une commande client qui inclut des articles soumis à la TVA au preneur                        | Royaume-Uni                  |
| GB-00002 Paramétrer des groupes de taxes d’article pour la taxe au preneur                                           | Royaume-Uni                  |
| GB-00002 Paramétrer les groupes règles et paramètres d’articles de taxe au preneur                                  | Royaume-Uni                  |
| GB-00002 Paramétrer les groupe de taxes pour la taxe au preneur                                                | Royaume-Uni                  |
...
| Ligne BPM                                                                                 | Pays/région |
|------------------------------------------------------------------------------------------|----------------|
| Analyser les résultats de questionnaire                                                            | Général         |
| Créer une question fermée                                                           | Général         |
| Créer une question ouverte                                                            | Général         |
...
| Ligne BPM                                        | Pays/région |
|-------------------------------------------------|----------------|
| ER Définir le mappage de modèles et sélectionner des sources de données | Général         |
| ER Concevoir un modèle de données spécifiques au domaine            | Général         |
| ER Concevoir un format spécifique au domaine                | Général         |
...
| Paramétrage de modèles de valeur                                       | Général         |
...
| Création de groupes de consolidation et comptes de consolidation supplémentaires | Général         |
...
| Tenir à jour les modèles par défaut de dimension financière                    | Général         |
| Clôture de période comptable en masse                                       | Général         |
| Effetuer une consolidation en ligne                                   | Général         |
| Valider les journaux périodiques                                            | Général         |
| Préparation d’une entité juridique en vue de son utilisation dans le processus de consolidation       | Général         |
| Traiter les transactions d’élimination                                  | Général         |
| Traiter le journal de répartition comptable                                 | Général         |
| Paramétrage d’un alias de compte général                                     | Général         |
| Configurer les règles d’élimination                                          | Général         |
...
|------------------------------------------------------------------|----------------|
| Analyser les résultats de questionnaire                                    | Général         |
| Approuver les enregistrements de la boîte de réception des candidatures                                | Général         |
| Processus de droit aux avantages                                      | Général         |
| Créer un projet d’embauche collective                                       | Général         |
| Créer des articles empruntés                                                | Général         |
| Définir les règles d’admissibilité et les stratégies relatives aux avantages                    | Général         |
| Définir le processus de rémunération et calculer les résultats                | Général         |
| Définir les nouveaux départements                                           | Général         |
| Définir les nouvelles tâches                                                  | Général         |
| Délivrer le programme d’avantages des employés                                | Général         |
| Développer et ouvrir une demande de poste                                 | Général         |
| Développer un plan de succession                                          | Général         |
| Vérification d’emploi i9 vérification                          | Général         |
| Inscription et annulation de l’inscription d’un travailleur à des avantages                          | Général         |
| Inscription d’employés à un régime de rémunération fixe                    | Général         |
| Inscription d’employés à un régime de rémunération variable                 | Général         |
| Entrez le candidat et les données de la candidature manuellement                    | Général         |
| Entrer des informations sur le collaborateur                                         | Général         |
| Embaucher un candidat existant via le recrutement                    | Général         |
| Embaucher le candidat via le recrutement                                | Général         |
| Embaucher plusieurs employés                                          | Général         |
| Identifier et déployer les outils de sélection de candidats                    | Général         |
| Prêter l’article à un collaborateur                                            | Général         |
| Mise à jour des informations relatives aux blessures et aux maladies des employés                 | Général         |
| Rendre une question dépendante de la réponse à la question précédente | Général         |
| Gérer les dates d’expiration des avantages                                  | Général         |
| Gérer les modèles d’e-mails                                           | Général         |
| Gérer les transitions et les transferts des employés                        | Général         |
| Gérer les congés                                          | Général         |
| Gérer logements des collaborateurs                                     | Général         |
| Modifier les relations hiérarchiques d’un poste                    | Général         |
| Configurer les grilles de rémunération                                        | Général         |
| Paramétrer les informations sur les blessures et les maladies                            | Général         |
| Paramétrer les informations sur les blessures et les maladies                            | Général         |
...
| Ligne BPM                                                                          | Pays/région |
|-----------------------------------------------------------------------------------|----------------|
| Ajuster les niveaux des stocks dans l’entrepôt                                              | Général         |
| Vérifier la disponibilité du stock                                                   | Général         |
| Corriger les informations de suivi de stock                                            | Général         |
| Énumérer le stock dans un entrepôt                                                    | Général         |
| Créer une structure d’entrepôt                                                     | Général         |
| Créer et tenir à jour un blocage du stock                                         | Général         |
| Créer et traiter une non-conformité                                              | Général         |
| Définir les processus de comptage d’inventaire                                               | Général         |
| Initialiser les niveaux des stocks dans l’entrepôt                                          | Général         |
| Inspecter la qualité des marchandises                                                      | Général         |
| Tenir à jour les types de code-barres                                                            | Général         |
| Enregistrer des articles pour un article activé pour l’entreposage de base à l’aide d’un journal des arrivées d’articles | Général         |
| Configurer les profils de vue d’ensemble des arrivées                                                  | Général         |
...
| Ligne BPM                                                      | Pays/région |
|---------------------------------------------------------------|----------------|
| Ajouter une stratégie de calcul de quantité kanban à une règle de kanban     | Général         |
| Cycle de vie d’un lot de commandes de la création au démarrage                    | Général         |
| Calculer des suggestions de quantité de kanban                         | Général         |
| Modifier les règles de kanban pour une tâche de traitement                         | Général         |
| Configurer un collaborateur à l’aide du périphérique de travail mobile                | Général         |
| Copier une formule                                                | Général         |
| Créer une formule par la copie d’une formule existante          | Général         |
| Création d’une version de flux de production                              | Général         |
| Créer un ordre de fabrication                                     | Général         |
| Créer une règle de kanban d’événement de vente                              | Général         |
| Créer une chaîne de valeur                                         | Général         |
| Créer une relation d’activité : Successeur                           | Général         |
| Création d’une ressource opérationnelle                                 | Général         |
| Créer des règles de kanban de quantité fixe                            | Général         |
| Créer des règles de kanban en dupliquant des règles de kanban existantes  | Général         |
| Créer des activités de processus pour la lean manufacturing              | Général         |
| Créer des capacités de ressource                                  | Général         |
| Créer des activités de transfert pour la lean manufacturing             | Général         |
| Créer les propriétés de la planification du temps de travail                     | Général         |
| Création de modèles de temps de travail                                 | Général         |
| Définir les calendriers et les articles de travail                            | Général         |
| Définir un groupe de ressources pour la fabrication discrète                  | Général         |
| Définir les cellules de travail Lean Manufacturing                          | Général         |
| Définir les groupes de calendriers de production au plus juste                                   | Général         |
| Définir les modèles de flux de production                                 | Général         |
| Définir les capacités de ressource                                  | Général         |
| Activer le processus de paie par pointage                | Général         |
| Terminer un ordre de fabrication                                        | Général         |
| Estimer un ordre de fabrication                                   | Général         |
| Origine des besoins au plus juste pour les commandes client                                | Général         |
| Gérer l’unité de mesure                                        | Général         |
| Déplacer les tâches de kanban planifiées                                    | Général         |
| Préparer une tâche de kanban de processus lorsque les matières sont disponibles     | Général         |
| Préparer une tâche de kanban de traitement lorsque les matières ne sont pas disponibles | Général         |
| Lancer un ordre de fabrication                                    | Général         |
| Supprimer une tâche de kanban du programme                         | Général         |
| Déclarer un ordre de fabrication comme terminé                         | Général         |
| Générer un état de la progression sur un périphérique mobile                        | Général         |
| Rétablir le statut de l’opération kanban                                      | Général         |
| Planifier un ordre de fabrication                                   | Général         |
| Programmer les tâches de kanban                                          | Général         |
| Démarrer un ordre de fabrication                                      | Général         |
...
| Ligne BPM                                          | Pays/région |
|---------------------------------------------------|----------------|
| Définir des règles de couverture pour les articles                   | Général         |
| Développer la prévision de base                         | Général         |
| Créer un plan avec contrainte                       | Général         |
...
| Ligne BPM                                                         | Pays/région |
|------------------------------------------------------------------|----------------|
| Créer un contrat d’achat                                      | Général         |
| Créer un ordre de lancement d’achat à partir d’un contrat d’achat        | Général         |
| Créez un ordre de lancement d’achat à la création de la commande fournisseur | Général         |
| Créer un bon de commande pour la consommation                             | Général         |
| Création d’un compte fournisseur                                          | Général         |
| Rechercher des fournisseurs                                               | Général         |
| Paramétrer une hiérarchie de catégories d’approvisionnement                          | Général         |
...
| Création d’un contrainte d’expression                                    | Général         |
| Créer les attributs de lot pour un produit                              | Général         |
| Créer des règles de configuration                                         | Général         |
| Créer des composants de modèle de produit                                    | Général         |
| Définir les groupes de configuration                                        | Général         |
| Définir une gamme de configuration                                         | Général         |
...
| Contrôler l’accès aux contrats d’achat pour le secteur public                                 | Général         |
| Créer une classification de facturation pour le secteur public                                       | Général         |
| Créer un code de facturation pour le secteur public                                                 | Général         |
| Créer un engagement de réserver des fonds budgétaires pour le secteur public                           | Général         |
| Créer un champ personnalisé pour le code de facturation pour le secteur public                              | Général         |
| Créer un type de fonds pour le secteur public                                                    | Général         |
| Créer un fournisseur occasionnel et une facture pour le secteur public                                  | Général         |
...
| Créer une écriture comptable avancée pour le secteur public                                       | Général         |
| Créer un budget d’origine puis contrepasser les écritures budgétaires préliminaires pour le secteur public | Général         |
| Créer et affecter un code de partenaire commercial pour le secteur public                              | Général         |
| Créer une couverture et des pages de signature pour les états de paiement pour le secteur public                 | Général         |
| Importer et créer plusieurs fournisseurs et factures occasionnels pour le secteur public              | Général         |
| Configurer une hiérarchie financière dérivée pour le secteur public                                  | Général         |
...
| Ligne BPM                                                                                  | Pays/région |
|-------------------------------------------------------------------------------------------|----------------|
| Ajout de variantes de produits à une commande fournisseur à l’aide des poids des variantes                              | Général         |
| Prix de base et accords commerciaux                                                           | Général         |
| Règles de tarification de catégorie en vue de créer des accords commerciaux                                         | Général         |
| Configurer et exécuter la tâche de calcul des déclarations                                             | Général         |
| Configurer et exécuter la tâche de validation des déclarations                                                  | Général         |
| Configurer le traitement de carte de crédit                                                          | Général         |
| Configurer les produits liés                                                                 | Général         |
| Créer un profil visuel de PDV                                                               | Général         |
| Créer un produit                                                                          | Général         |
| Création d’un produit générique                                                                   | Général         |
| Créer et associer un périphérique                                                             | Général         |
| Créer et associer une station matérielle                                                   | Général         |
| Créer des dimensions financières pour les caisses de PDV et configurer les valeurs de dimension dans les registres | Général         |
| Créer des dimensions financières pour les canaux de vente au détail et configurer les valeurs de dimension pour les magasins  | Général         |
| Créer un canal en ligne et définir les attributs du canal                                       | Général         |
| Créer des groupes d’autorisations de PDV                                                              | Général         |
| Créer des packages de produit et les utiliser dans une commande fournisseur                                         | Général         |
| Définir un canal de centre d’appels et les attributs du canal                                         | Général         |
| Définir les attributs de canal                                                                 | Général         |
| Définir les programmes de fidélité                                                                   | Général         |
| Définir les points de récompense de fidélité                                                              | Général         |
| Définir les schémas de fidélité                                                                    | Général         |
| Créer les relations entre les unités de l’organisation                                     | Général         |
| Générer et exécuter les états prêts à l’emploi                                                       | Général         |
| Gérer les remises commerciales pour les clients                                                      | Général         |
| Configurations de paramètres pour des relevés de vente au détail                                            | Général         |
| Configurations de paiements pour des relevés de vente au détail                                              | Général         |
| Assurer le libre service pour télécharger une station matérielle                                         | Général         |
| Validation des ventes et des paiements en ligne                                                      | Général         |
| Traiter les ajustements de points de récompense de fidélité                                                  | Général         |
| Envoyer des produits du centre de distribution au magasin à l’aide de la procédure de réassort magasin                        | Général         |
| Lancer un produit/produit générique à destination des entités juridiques                                        | Général         |
...
| Paramétrer les groupes de taxe et les groupes de taxe d’article  | Général         |
...
| Ligne BPM                                                | Pays/Région |
|---------------------------------------------------------|----------------|
| Création de nouveaux utilisateurs                                        | Général         |
...
| Ligne BPM                                                                          | Pays/région |
|-----------------------------------------------------------------------------------|----------------|
| Associer un index de carburant à un transporteur comme frais annexes                    | Général         |
| Configurer l’emplacement dans un entrepôt compatible WMS                                    | Général         |
| Créer une classe de travail                                                               | Général         |
| Définir l’inventaire tournant                                                             | Général         |
| Activer l’impression d’étiquette de contenant                                               | Général         |
| Enregistrer des articles pour un article activé pour l’entreposage de base à l’aide d’un journal des arrivées d’articles | Général         |
| Configurer un index de carburant du transporteur                                                       | Général         |
| Configurer une instruction d’emplacement pour le rangement des commandes fournisseur                           | Général         |
| Configurer une option de menu d’appareil mobile pour terminer le travail du type commande fournisseur       | Général         |
| Configurer une option de menu d’appareil mobile pour enregistrer les articles reçus                       | Général         |
| Définir un modèle de travail pour les commandes fournisseur                                        | Général         |
| Paramétrer les affectations d’élément accessoire                                                    | Général         |
| Configurer les codes disposition                                                         | Général         |
| Configurer des frais annexes de terminal et des données principales annexes                            | Général         |
| Paramétrer des tables maître des taux                                                               | Général         |
...
| Ligne BPM                                           | Pays/région |
|----------------------------------------------------|----------------|
| Analyse des soldes comptables                            | Général         |
| Créer un produit lancé pour une seule société     | Général         |
| Créer et planifier un ordre de fabrication             | Général         |
| Merchandisage efficace                            | Général         |
| États électroniques                               | Général         |
| Libre-service employé                              | Général         |
| Réduire vos ventes quotidiennes restantes          | Général         |
| Présentation des fonctions de localisation AX      | Général         |
| Présentation des fonctionnalités spécifiques au Japon | Japon          |
| Gérer la tarification et les promotions                      | Général         |
| Responsable en libre-service                               | Général         |
| Vue d’ensemble des projets                                  | Général         |
| Installer et configurer des canaux                      | Général         |
