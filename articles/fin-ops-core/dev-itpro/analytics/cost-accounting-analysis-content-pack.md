...
description: Cet article décrit les données incluses dans le contenu Power BI d’analyse du contrôle de gestion.
author: AndersGirke
ms.date: 10/02/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9205964"
---
# <a name="cost-accounting-analysis-power-bi-content"></a>Contenu Power BI Analyse de contrôle de gestion

[!include [banner](../includes/banner.md)]

Cet article décrit les données incluses dans le contenu Microsoft Power BI d’**analyse du contrôle de gestion**. Elle explique également comment accéder aux états Power BI, et fournit des informations sur le modèle de données et les entités qui permettent de créer le contenu.
