...
description: Cet article explique comment utiliser les sources de données de type GROUPBY dans la gestion des états électroniques (ER).
author: NickSelin
ms.date: 03/18/2022
ms.topic: article
ms.prod: ''
