...
description: Cet article fournit des informations sur la configuration d’une destination d’archive pour chaque composant DOSSIER ou FICHIER d’un format de gestion des états électroniques.
author: kfend
ms.date: 11/30/2020
ms.topic: article
ms.prod: ''
