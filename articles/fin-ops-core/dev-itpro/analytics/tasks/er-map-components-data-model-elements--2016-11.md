...
description: Cet article décrit comment mapper des éléments de modèle de données aux composants de la configuration de la gestion des états électroniques créée.
author: NickSelin
ms.date: 08/29/2018
