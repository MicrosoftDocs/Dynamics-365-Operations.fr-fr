...
description: Cet article décrit comment créer des configurations d’états électroniques pour générer un document électronique entrant et mettre à jour les données d’application.
author: kfend
ms.date: 06/19/2017
