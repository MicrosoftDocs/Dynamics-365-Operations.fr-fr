...
description: Cet article décrit comment mapper un modèle de données pour la gestion des états électroniques à une sélection de sources de données Microsoft Dynamics 365 Finance.
author: kfend
ms.date: 08/29/2018
