...
description: Cette rubrique décrit comment créer une nouvelle configuration de gestion des états électroniques (ER) contenant un modèle de données pour les documents de paiement électronique.
author: NickSelin
ms.date: 08/29/2018
