...
- Accédez à l'instance de Microsoft SharePoint Server qui est configurée pour être utilisée avec l'application.
...
2. Dans la page **États de fichier pour les sources**, sélectionnez **Actualiser** pour actualiser la page. Notez que le fichier Excel qui a été transféré vers SharePoint est affiché sur cette page avec le statut **Prêt**. Les statuts suivants sont actuellement pris en charge :
