...
4. Sélectionnez **Fichier**, puis **Enregistrer sous** et nommez l’état Balance comptable détaillée avec des attributs.
    ...
    > [!NOTE]
    > Remarque : à chaque fois qu’un état est créé dans le concepteur d’état, la liste des états financiers est mise à jour.
