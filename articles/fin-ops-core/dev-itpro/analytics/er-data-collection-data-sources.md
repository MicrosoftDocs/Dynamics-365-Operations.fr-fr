...
description: Cette rubrique explique comment utiliser les sources de données de type COLLECTION DE DONNÉES dans des formats de gestion des états électroniques (ER).
author: NickSelin
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
