...
description: Cet article explique comment utiliser la fonction de nettoyage de migration ER pour résoudre des problèmes avec les modèles ER.
author: kfend
ms.date: 04/29/2020
ms.topic: article
ms.prod: ''
