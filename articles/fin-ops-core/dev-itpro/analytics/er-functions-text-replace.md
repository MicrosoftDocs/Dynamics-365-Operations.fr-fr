...
---
# <a name="REPLACE">Fonction REPLACE ER</a>
...
Si l'argument `regular expression flag` est **FALSE**, cette fonction se comporte comme [TRANSLATE](er-functions-text-translate.md). Les caractères spécifiés par l'argument `replacement` sont utilisés pour remplacer les caractères qui sont recherchés. 
