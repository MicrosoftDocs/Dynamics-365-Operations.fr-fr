...
La version 1.9.1 de la configuration du format de gestion des états électroniques **État de déclaration d’échanges de biens Litware** est créée. Cette version présente le [statut](general-electronic-reporting.md#component-versioning) **Brouillon** et peut être modifiée. Le contenu actuel de votre format de gestion des états électroniques personnalisé correspond au contenu du format fourni par Microsoft.
