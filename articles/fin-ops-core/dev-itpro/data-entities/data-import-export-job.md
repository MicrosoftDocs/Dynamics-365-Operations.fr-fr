...
La fonctionnalité doit être activée dans le module de gestion des fonctionnalités et il est ensuite possible d'y accéder à partir de **Gestion des données \> Nettoyage de l'historique des tâches**.
