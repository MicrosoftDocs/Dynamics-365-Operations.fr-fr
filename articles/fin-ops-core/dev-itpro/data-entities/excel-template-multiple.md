...
description: Cet article décrit la procédure d’importation de données à l’aide des modèles d’entité de données Excel dans Finances et Opérations.
author: peakerbl
ms.date: 01/01/2018
ms.topic: article
ms.prod: ''
