...
description: Cet article décrit comment l’intégration de la double écriture prend en charge la création de commandes fournisseur et les mises à jour à partir de Supply Chain Management et Field Service.
