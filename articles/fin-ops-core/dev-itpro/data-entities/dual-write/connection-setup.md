...
1. [Configurer la connexion depuis l’application de finances et d’opérations](enable-dual-write.md).
2. Pour synchroniser les données Dataverse existantes avec l’application de finances et d’opérations, [amorcez](bootstrap-company-data.md) les données Dataverse à l’aide d’un code d’entreprise ISO à trois lettres.
