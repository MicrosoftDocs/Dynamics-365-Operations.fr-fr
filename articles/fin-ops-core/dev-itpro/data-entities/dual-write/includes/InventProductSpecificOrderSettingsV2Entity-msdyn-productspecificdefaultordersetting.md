## <a name="product-default-order-settings-v2-to-msdyn_productspecificdefaultordersettings"></a>Paramètres de commande par défaut du produit V2 vers msdyn_productspecificdefaultordersettings
