...
+ Vous ne pouvez activer et synchroniser les commandes des ventes que si tous les produits de la commande proviennent des applications Finance and Operations. Par conséquent, il ne peut y avoir aucun produit hors catalogue.
...
Voici les cartes des entités principales associées pour le prospect en disponibilités :
