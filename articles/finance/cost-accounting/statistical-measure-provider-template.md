...
description: Cet article fournit des informations sur les membres de la dimension statistique et les modèles de fournisseur de modèles statistiques.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
