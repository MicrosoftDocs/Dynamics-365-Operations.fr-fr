...
description: Cet article fournit des informations sur l’espace de travail Contrôle des coûts. Cet espace de travail est un point central où les responsables chargés de contrôler un objet de coût ou un ensemble d’objets de coûts dans une dimension ou dans plusieurs dimensions peuvent accéder aux états.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
