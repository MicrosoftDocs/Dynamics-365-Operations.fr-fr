...
6. Dans le champ Dimension cible, entrez ou sélectionnez une valeur.
    * Pour cet exemple, sélectionnez Éléments de coût MXMF.  
7. Cliquez sur Nouveau.
8. Dans la liste, marquez la ligne sélectionnée.
9. Dans le champ Membre de la dimension de départ, entrez ou sélectionnez une valeur.
    * Pour cet exemple, sélectionnez le membre de dimension 606400 Dépenses de téléphone et de télécopie.  
