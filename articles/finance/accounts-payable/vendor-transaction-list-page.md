...
description: Cet article fournit des informations sur la page de la liste des transactions fournisseur pour Microsoft Dynamics 365 Finance.
author: sunfzam
ms.date: 08/24/2018
ms.topic: article
ms.prod: ''
