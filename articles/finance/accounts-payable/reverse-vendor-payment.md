...
description: Cet article décrit les différences entre contrepasser, supprimer, annuler et rejeter un paiement, et explique comment contrepasser le chèque d’un fournisseur.
author: angelad116
ms.date: 10/24/2022
ms.topic: article
ms.prod: ''
