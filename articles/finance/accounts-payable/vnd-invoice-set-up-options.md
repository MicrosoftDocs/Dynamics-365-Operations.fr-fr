...
---
# <a name="setup-options-for-vendor-invoice-automation-preview"></a>Options de configuration pour l'automatisation des factures fournisseur (Version préliminaire)
...
- Paramètres des tâches d'automatisation des processus en arrière-plan. L'infrastructure d'automatisation des processus est utilisée pour soumettre les factures fournisseurs importées au système de workflow. Elle est également utilisée pour faire correspondre automatiquement les lignes de réception des marchandises avec les lignes de facture fournisseur en attente. Différents processus métier utilisent cette infrastructure pour définir la fréquence d'exécution du processus sélectionné. Les fréquences disponibles pour les processus en arrière-plan **Faire correspondre la réception des marchandises avec les lignes de facture** et **Soumettre les factures fournisseurs au workflow** sont notamment **Chaque heure** et **Chaque jour**.
