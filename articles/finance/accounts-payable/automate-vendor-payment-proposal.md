...
description: Cet article explique comment les organisations qui paient les fournisseurs selon un programme récurrent peuvent automatiser le processus de génération des propositions de paiement fournisseur.
author: kweekley
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
...
> [!NOTE]
> La fonction **Automatisation des propositions de paiement fournisseur** doit être activée dans la gestion des fonctionnalités pour être utilisée. 
