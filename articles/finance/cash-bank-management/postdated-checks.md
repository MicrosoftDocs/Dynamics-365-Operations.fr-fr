...
description: Cet article fournit des informations sur la prise en charge des chèques postdatés. Les chèques postdatés sont émis à des fins d’émission ou de réception de paiements à une date future.
author: angelad116
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
