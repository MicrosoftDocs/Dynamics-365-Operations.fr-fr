...
3. Dans le champ **Compte fournisseur**, entrez ou sélectionnez une valeur.
4. Dans la liste, recherchez et sélectionnez l’enregistrement souhaité.
5. Dans la liste, cliquer sur le lien dans la ligne sélectionnée.
6. Développez la section **Général**.
7. Entrez ou sélectionnez une valeur dans le champ **Site**.
8. Dans la liste, cliquer sur le lien dans la ligne sélectionnée.
9. Entrez ou sélectionnez une valeur dans le champ **Entrepôt**.
...
20. Entrez une date dans le champ **Date de livraison confirmée**.
...
30. Dans le champ **Banque conseillère**, entrez ou sélectionnez une valeur.
...
34. Fermez la page.
35. Dans le volet Actions, cliquez sur **Achat**.
...
44. Dans le volet Actions, cliquez sur **Achat**.
...
2. Dans la liste, recherchez et sélectionnez l’enregistrement souhaité.
3. Dans la liste, cliquer sur le lien dans la ligne sélectionnée.
4. Cliquez sur **Facture** dans le volet Actions.
5. Cliquez sur **Facture**.
6. Dans le champ **Nombre**, tapez une valeur.
...
2. Cliquez sur **Nouveau**.
3. Dans le champ **Nom**, entrez ou sélectionnez une valeur.
4. Dans la liste, cliquer sur le lien dans la ligne sélectionnée.
