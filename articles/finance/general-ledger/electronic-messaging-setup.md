...
description: Cet article fournit des informations générales sur la configuration de la fonctionnalité Messages électroniques (ME).
author: liza-golub
ms.date: 11/18/2021
ms.topic: article
ms.prod: ''
...
| Champ                                     | Description |
|-------------------------------------------|-------------|
| Type d’action                               | Permet de sélectionner le type de l’action. Pour plus d’informations sur les options disponibles, voir la section [Types d’actions de traitement des messages](#action-types) plus loin dans cet article. |
