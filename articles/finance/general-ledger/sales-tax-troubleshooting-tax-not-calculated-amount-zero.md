...
description: Cet article fournit des informations sur la résolution des problèmes qui peuvent vous aider lorsque le montant de la taxe est égal à 0 (zéro) ou lorsque la taxe n’est pas calculée.
author: shtao
ms.date: 04/01/2021
ms.topic: article
ms.prod: ''
