...
Si un justificatif a une ligne de journal où le type de compte est **Client**, toutes les lignes du journal dans le justificatif appliquent la même direction de taxe. 

Si le code taxe est exempt de taxe d’utilisation, la direction de la taxe est Vente détaxée. Sinon, la direction de la taxe est taxe de comptabilité fournisseur.
