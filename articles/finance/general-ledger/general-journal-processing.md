...
description: Cet article décrit les fonctionnalités de Microsoft Dynamics 365 Finance qui vous permettent d’effectuer le traitement du journal des opérations diverses, ainsi que de garantir que les données correctes sont capturées et que le contrôle interne n’est pas compromis.
author: kweekley
ms.date: 02/28/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8896374"
---
# <a name="general-journal-processing"></a>Journaux d’opérations diverses

[!include [banner](../includes/banner.md)]

Cet article décrit les fonctionnalités qui vous permettent d’effectuer le traitement du journal des opérations diverses, ainsi que de garantir que les données correctes sont capturées et que le contrôle interne n’est pas compromis.  
