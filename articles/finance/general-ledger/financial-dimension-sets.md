...
description: Cet article décrit les ensembles de dimensions financières et fournit quelques conseils pour optimiser leur utilisation.
author: yukonpeegs
ms.date: 03/07/2022
ms.topic: article
ems.prod: ''
...
ms.locfileid: "8864279"
---
# <a name="financial-dimension-sets"></a>Ensembles de dimensions financières

[!include [banner](../includes/banner.md)]

Cet article décrit les ensembles de dimensions financières et fournit quelques conseils pour optimiser leur utilisation.
