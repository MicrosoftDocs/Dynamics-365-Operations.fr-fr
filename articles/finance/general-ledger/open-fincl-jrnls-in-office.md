...
description: Cet article décrit les problèmes qui peuvent se produire lorsque vous créez des journaux financiers personnalisés à l’aide d’un modèle Microsoft Excel.
author: kweekley
ms.date: 05/14/2021
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "8896345"
---
# <a name="open-financial-journal-templates-in-office"></a>Ouvrir des modèles de journal financier dans Office

[!include [banner](../includes/banner.md)]

Cet article décrit les problèmes qui peuvent se produire lorsque vous créez des journaux financiers personnalisés à l’aide d’un modèle Microsoft Excel.
