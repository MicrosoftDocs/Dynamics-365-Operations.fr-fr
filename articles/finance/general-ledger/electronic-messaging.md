...
description: Cet article fournit des informations générales et de configuration pour la messagerie électronique dans Microsoft Dynamics 365 Finance.
author: AdamTrukawka
ms.date: 01/04/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9283452"
---
# <a name="electronic-messaging"></a>Messagerie électronique

[!include [banner](../includes/banner.md)]

Cet article fournit des informations générales et de configuration pour la fonctionnalité **Messages électroniques** (ME).
...
| Royaume-Uni | [Rendre la taxe numérique - Envoi de déclarations de TVA](../localizations/emea-gbr-mtd-vat-integration.md) | [Finances et opérations : Taxe numérique britannique – Déclaration de TVA dans Dynamics 365](https://community.dynamics.com/365/b/techtalks/posts/finance-and-operations-uk-digital-tax-vat-declaration-in-dynamics-365) |
...
| Norvège      | [Retour de TVA avec envoi direct à Altinn](../localizations/emea-nor-vat-return.md) | [Nouvelle déclaration de TVA avec soumission directe à Altinn dans Dynamics 365 Finance](https://community.dynamics.com/365/dynamics-365-fasttrack/b/techtalks/posts/new-vat-return-with-direct-submission-to-altinn-in-dynamics-365-finance-december-1-2021) |
| France      | [Déclaration de TVA (France)](../localizations/emea-fra-VAT-declaration-preview-France.md) | |
| Autriche     | [Déclaration de TVA (Autriche)](../localizations/emea-aut-vat-declaration-austria.md) | |
| Allemagne     | [Déclaration de TVA (Allemagne)](../localizations/emea-deu-vat-declaration-germany.md) | |
| Pays-Bas | [Déclaration de TVA pour les Pays-Bas](../localizations/emea-nl-vat-declaration-netherlands.md) | |
| Suède      | [Déclaration de TVA (Suède)](../localizations/emea-swe-VAT-declaration-Sweden.md) | |
| Suisse | [Déclaration TVA (Suisse)](../localizations/emea-che-vat-declaration-switzerland.md) | |
