...
5. Dans le champ Compte, spécifiez les valeurs souhaitées.
    * Dans cet exemple, nous allons définir la dépense pour l’assurance. Il s’agira d’un montant de dépense périodique.  
6. Dans le champ Description, entrez une valeur.
7. Entrez un nombre dans le champ Débit.
8. Spécifiez les valeurs souhaitées dans le champ Compte de contrepartie.
