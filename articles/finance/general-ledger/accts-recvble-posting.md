...
description: Cette rubrique explique comment les validations sont configurées dans la Comptabilité client et fournit des exemples de configurations de validation.
