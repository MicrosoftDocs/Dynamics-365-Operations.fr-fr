...
description: Cette rubrique explique les différentes manières dont vous pouvez afficher les entrées de journal et les transactions.
author: aprilolson
ms.date: 08/01/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8717556"
---
# <a name="view-journal-entries-and-transactions"></a>Afficher les entrées de journal et les transactions

[!include [banner](../includes/banner.md)]

Cette rubrique explique les différentes manières dont vous pouvez afficher les entrées de journal et les transactions. 
