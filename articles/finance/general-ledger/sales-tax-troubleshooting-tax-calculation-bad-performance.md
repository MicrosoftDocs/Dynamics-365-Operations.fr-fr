...
description: Cet article fournit des informations sur la résolution des problèmes liés aux performances du calcul de la taxe et à son effet sur les transactions.
author: shtao
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
