...
description: Cet article explique comment utiliser la spécification de taxe par écriture comptable afin d’afficher et d’imprimer des informations sur les écritures comptables pour laquelle la taxe est calculée.
author: EricWang
ms.date: 08/19/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8898089"
---
# <a name="sales-tax-specification-by-ledger-transaction-report"></a>Spécification de taxe par écriture comptable
[!include [banner](../includes/banner.md)]

Cet article explique comment utiliser la **spécification de taxe par écriture comptable** afin d’afficher et d’imprimer des informations sur les écritures comptables pour laquelle la taxe est calculée.
