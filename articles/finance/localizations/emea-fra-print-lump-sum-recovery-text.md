...
Utilisez la page **Paramétrage d’écran** pour définir les paramètres d’impression d’un texte récupéré du montant forfaitaire sur les factures client. Vous pouvez saisir le texte récupéré du montant forfaitaire et le montant de pénalité à imprimer sur les factures client. Vous pouvez également entrer le nombre de jours de la période de grâce avant l’application d’une pénalité. La pénalité est appliquée après le nombre de jours spécifié à partir de la date du document ou de celle de la facture.
