...
description: Cette rubrique fournit des informations sur les environnements de service pour la facturation électronique et explique comment les configurer.
author: dkalyuzh
ms.date: 02/28/2022
ms.topic: article
ms.prod: ''
