...
description: Cet article explique comment configurer et générer les déclarations de retenue à la source pour l’Indonésie.
author: AdamTrukawka
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
...
Cet article explique comment configurer et générer le fichier de retenue à la source PPH que les entités juridiques indonésiennes utilisent pour déclarer les transactions de retenue à la source dans l’application e-Bupot.
