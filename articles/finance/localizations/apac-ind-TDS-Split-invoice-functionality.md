...
description: Cet article décrit la configuration et la fonctionnalité de fractionnement des factures par adresse de livraison et numéro de compte fiscal (TAN).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Cet article décrit la configuration et la fonctionnalité de fractionnement des factures par adresse de livraison et numéro de compte fiscal (TAN).
