...
3. Sélectionnez **Référentiels**.
4. Sélectionnez **Ressource globale \> Ouvrir**.
5. Importez **Modèle de message de réponse**, **Importation du journal des erreurs CFDI (MX)**, **Importation du journal des erreurs CFDI (MX)** et **Importation du message de réponse CFDI (MX)**.
