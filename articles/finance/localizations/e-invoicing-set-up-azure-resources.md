...
description: Cette rubrique fournit une vue d’ensemble du processus de configuration des ressources Microsoft Azure pour la facturation électronique.
author: dkalyuzh
ms.date: 01/26/2022
ms.topic: article
ms.prod: ''
