...
Cette rubrique décrit une approche générique pour paramétrer la taxe sur la valeur ajoutée au preneur (TVA) pour l’UE, les pays GCC et Singapour.

> [!NOTE]                                                                                  
> Pour le Bahreïn, le Koweït, Oman et le Qatar, une fonctionnalité de **Disponibilité de l’auto-liquidation pour d’autres pays** doit être activée dans l’espace de travail **Gestion des fonctionnalités**. 
...
## <a name="set-up-countryregion-properties"></a>Configurer les propriétés de pays/régions
