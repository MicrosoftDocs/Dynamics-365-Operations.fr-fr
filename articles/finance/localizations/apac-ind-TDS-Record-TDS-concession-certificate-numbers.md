...
description: Cet article explique comment enregistrer les numéros de certificat de concession de taxe déduite à la source (TDS) qui sont délivrés aux fournisseurs.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8846611"
---
# <a name="record-tds-concession-certificate-numbers"></a>Enregistrez les numéros de certificat de concession TDS

[!include [banner](../includes/banner.md)]

Cet article explique comment enregistrer les numéros de certificat de concession de taxe déduite à la source (TDS) qui sont délivrés aux fournisseurs.
