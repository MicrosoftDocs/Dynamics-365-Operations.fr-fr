...
description: Cet article fournit une vue d’ensemble des fonctionnalités de Regulatory Configuration Service (RCS) et explique comment accéder au service.
author: kfend
ms.date: 06/04/2021
ms.topic: overview
ms.prod: ''
...
> [!NOTE] 
> Pour l’instant, RCS n’est pas disponible pour le Cloud de la communauté du secteur public (GCC).
