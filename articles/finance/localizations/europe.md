...
- [Détenteurs d'avance](emea-advance-holders.md)
 ...
 - [Acompte à un employé (Europe de l'Est)](tasks/advance-payment-employee.md)
- [Facturation avancée](emea-advance-invoice.md)
- [Rapprochement bancaire](emea-bank-reconciliation.md)
- [Facturation corrective](emea-corrective-invoice.md)
- [Créer et valider des journaux périodiques](emea-create-post-periodic-journals.md)
...
- [Normes OIOUBL](emea-oioubl-standards-electronic-invoicing.md)
...
- [Outil de génération de référence de paiement (Europe de l'Est)](tasks/ee-00015-payment-reference-generation-tool.md)
...
- Taxe sur la valeur ajoutée (TVA)
  - [nom : paramétrer l'ID de TVA](tasks/eur-00015-vat-id.md)
  - [Enregistrer un ID de TVA du fournisseur](tasks/eur-00015-registration-vendor-vat-id.md)
  ...
  - [Date du point de taxe (Date du registre de TVA)](emea-tax-point-date.md)
