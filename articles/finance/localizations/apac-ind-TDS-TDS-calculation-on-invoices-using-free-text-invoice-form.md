...
description: Cet article explique comment calculer la taxe déduite à la source (TDS) sur les factures à l’aide de la page Facture financière.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Cet article explique comment calculer la taxe déduite à la source (TDS) sur les factures à l’aide de la page **Facture financière**.
