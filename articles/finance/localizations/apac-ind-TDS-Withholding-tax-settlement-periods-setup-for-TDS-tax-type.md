...
description: Cet article explique comment configurer des périodes de configuration pour la fonction Taxe déduite à la source (TDS).
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
Cet article explique comment configurer des périodes de configuration pour la fonction Taxe déduite à la source (TDS).
