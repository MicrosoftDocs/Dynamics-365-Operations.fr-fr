...
description: Cette rubrique explique comment configurer une connexion pour que la facturation électronique puisse accéder à un site Microsoft SharePoint.
author: dkalyuzh
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
