...
Le tableau suivant présente les champs inclus dans la déclaration d’échange de biens française au format SAISUNIC 330. La table indique également le niveau d’état du champ. Le champ peut être **4** (simplifié), **1** (complet), ou les deux.

| **Champ**                   | **Niveau de l’état** |
|-----------------------------|------------------|
| Période de référence         | 4, 1              | 
| Numéro de déclaration       | 4, 1              |
| Numéro de ligne                 | 4, 1              |
| Code ISO de pays (FR)       | 4, 1              | 
| Code complémentaire          | 4, 1              | 
| Numéro Siren                | 4, 1              | 
| Code TVA du client        | 4, 1              | 
| Code direction              | 4, 1              |
| Type de transaction            | 4, 1              | 
| Niveau d’obligation            | 4, 1              |
| Code marchandise              | 1                | 
| NGP National                | 1                | 
| Département         | 1                |
| Nature de la transaction       | 1                | 
| Pays d’origine      | 1                | 
| Pays d’origine - Importations | 1                | 
| Destination finale - Exportations | 1                | 
| Valeur de la facture               | 4, 1              | 
| Valeur statistique           | 1                |
| Poids net                  | 1                | 
| Unités supplémentaires            | 1                |
| Code transport              | 1                | 

Le tableau suivant présente les champs inclus dans la déclaration d’échange de biens française au format INTRACOM.
La table indique également le niveau d’état du champ. Le champ peut être **4** (simplifié), **1** (complet), ou les deux.
...
7. Accédez à **Gestion des entrepôts** > **Paramétrage** > **Entrepôt** > **Entrepôts**, sélectionnez un entrepôt, puis procédez comme suit :
