...
- Prenez une photo d'une réception, et téléchargez-la dans Dynamics 365 Finance. Vous pouvez ensuite joindre cette photo à un état de dépenses ultérieurement.
...
Vous pouvez également utiliser ces fonctions :
...
Si Finance a été déployée pour votre organisation, l'administrateur système doit publier l'espace de travail mobile **Gestion des dépenses**. Pour obtenir des instructions, voir [Publier un espace de travail mobile](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
