...
description: Cette rubrique fournit des informations sur l'expérience remodelée et repensée de saisie de l'état de dépenses dans Microsoft Dynamics 365 Finance. La nouvelle expérience simplifie le processus de renseignement des états de dépenses et réduit le temps requis.
author: ryansandness
manager: AnnBe
ms.date: 06/14/2019
ms.topic: article
