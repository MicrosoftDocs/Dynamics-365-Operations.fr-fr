...
description: Cet article décrit un scénario de réaffectation dans lequel une ligne est supprimée d’une commande client existante, partiellement facturée. Ce scénario produit le même résultat, que la ligne soit supprimée de la commande client ou définie sur un statut annulé.
author: kweekley
ms.date: 12/21/2020
ms.topic: index-page
ms.prod: ''
...
ms.locfileid: "8891664"
---
# <a name="revenue-recognition-reallocation--scenario-4"></a>Réaffectation de la prise en compte de revenu - Scénario 4

[!include [banner](../includes/banner.md)]

Cet article décrit un scénario de réaffectation dans lequel une ligne est supprimée d’une commande client existante, partiellement facturée. Ce scénario produit le même résultat, que la ligne soit supprimée de la commande client ou définie sur un statut annulé.
