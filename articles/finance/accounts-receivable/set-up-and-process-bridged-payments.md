---
title: Configurer et traiter les paiements en transition
description: Cette rubrique explique comment paramétrer et traiter les paiements clients en transition. Un paiement en transition est un paiement qui est validé dans la comptabilité en deux étapes.
...
Vous pouvez créer des paiements en transition à partir de la Comptabilité fournisseur ou de la Comptabilité client. Bien que cette rubrique explique comment configurer la validation en transition pour la comptabilité client, les étapes pour les transactions de la comptabilité fournisseur sont similaires.
