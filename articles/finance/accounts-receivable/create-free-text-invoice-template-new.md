...
1. Accédez à **Comptabilité client > Factures > Factures récurrentes > Modèles de facture financière**.
    * Cette page permet de créer des modèles de facture financière pouvant inclure des lignes de facture, des frais, un modèle de répartition comptable ainsi que des informations de compte général.  
