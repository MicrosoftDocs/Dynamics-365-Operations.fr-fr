...
description: Cet article fournit des informations sur la page de la liste des transactions client pour Microsoft Dynamics 365 Finance.
author: abruer
ms.date: 08/28/2018
ms.topic: article
ms.prod: ''
