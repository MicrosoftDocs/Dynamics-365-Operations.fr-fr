...
description: Cet article fournit des informations sur la comptabilité de projet qui utilise les réservations budgétaires générales pour le secteur public.
author: AlexRenney
ms.date: 04/25/2019
ms.topic: article
ms.prod: ''
