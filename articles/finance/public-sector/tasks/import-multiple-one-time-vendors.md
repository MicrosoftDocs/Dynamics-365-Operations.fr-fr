...
description: Cet article fournit des informations sur la création simultanée d’une facture et d’un enregistrement pour un nouveau fournisseur lorsqu’aucune commande d’achat n’est requise.
author: twheeloc
ms.date: 02/14/2022
