...
Vous pouvez sélectionner soit **Calendrier** soit **Exercice** dans le champ **Année d’amortissement** de la page **Profils d’amortissement**. La sélection effectuée détermine les options disponibles dans le champ **Fréquence de période**. L’option par défaut est **Calendrier**.
...
Si vous sélectionnez **Fiscal**, les options suivantes sont disponibles dans le champ **Fréquence de période** :
