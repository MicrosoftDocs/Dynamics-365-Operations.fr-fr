...
Lorsque vous comprenez les concepts et la terminologie utilisés dans Microsoft Dynamics 365 Finance, vous avez plus de facilité à implémenter la planification budgétaire dans votre organisation.
...
Vous créez le workflow de budgétisation pour la planification budgétaire dans la page **Workflows de budgétisation**. Le processus est semblable au processus de création d'autres workflows. L'illustration suivante présente un exemple de workflow au niveau du siège. 
