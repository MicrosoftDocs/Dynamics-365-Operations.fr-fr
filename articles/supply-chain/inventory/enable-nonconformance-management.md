...
[Paramétrer des conditions préalables pour la gestion de la non-conformité (guide de tâche)](tasks/set-up-prerequisites-nonconformance-management.md)
