...
description: Cet article décrit comment créer des tests pour les utiliser avec des ordres de qualité dans Microsoft Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857603"
---
# <a name="quality-management-tests"></a>Tests de gestion de la qualité

[!include [banner](../includes/banner.md)]

Cet article décrit comment créer des tests pour les utiliser avec des ordres de qualité dans Microsoft Dynamics 365 Supply Chain Management.
