...
description: Cet article décrit comment utiliser les ordres de contrôle pour bloquer le stock.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8869660"
---
# <a name="quarantine-orders"></a>Ordres de contrôle

[!include [banner](../includes/banner.md)]

Cet article décrit comment utiliser les ordres de contrôle pour bloquer le stock.
