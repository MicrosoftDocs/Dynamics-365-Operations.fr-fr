...
description: Cet article décrit comment créer et utiliser des zones de contrôle pour les non-conformités.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857704"
---
# <a name="quarantine-zones-for-nonconformances"></a>Zones de contrôle pour les non-conformités

[!include [banner](../includes/banner.md)]

Cet article décrit comment créer et utiliser des zones de contrôle pour les non-conformités.
