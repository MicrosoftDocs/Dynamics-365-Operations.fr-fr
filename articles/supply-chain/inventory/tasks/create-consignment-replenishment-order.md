...
description: Cet article explique comment créer une commande de réapprovisionnement avec consignation pour vous permettre de suivre la livraison prévue d’un fournisseur dans le stock de consignation.
author: yufeihuang
ms.date: 08/19/2019
