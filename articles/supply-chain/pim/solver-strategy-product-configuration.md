...
description: Cet article décrit comment utiliser la stratégie du solveur pour améliorer les performances de configuration du produit.
author: t-benebo
ms.date: 02/19/2019
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9065515"
---
# <a name="solver-strategy-for-product-configuration"></a>Stratégie du solveur pour la configuration du produit

[!include [banner](../includes/banner.md)]

Cet article décrit comment utiliser la stratégie du solveur pour améliorer les performances de configuration du produit.

Le concept de stratégies du solveur a été introduit pour la première fois dans la mise à jour cumulative 7 (CU7) de Microsoft Dynamics AX 2012 R2. Il a été étendu dans la mise à jour cumulative 8 (CU8) pour Microsoft Dynamics AX 2012 R3 et les applications de finances et d’opérations, Enterprise Edition 7.3.
