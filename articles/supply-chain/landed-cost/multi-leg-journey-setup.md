...
description: Cet article décrit comment configurer les voyages en plusieurs étapes pour le module de coût au débarquement.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8905832"
---
# <a name="multi-leg-journey-setup"></a>Configuration d’un parcours à plusieurs étapes

[!include [banner](../../includes/banner.md)]

Cet article décrit comment configurer les voyages en plusieurs étapes pour le module **Coût au débarquement**.
