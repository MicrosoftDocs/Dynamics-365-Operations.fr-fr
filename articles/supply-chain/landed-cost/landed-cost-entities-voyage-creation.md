---
title: Entités de création de voyage
description: Cette rubrique fournit des informations sur les entités de données de création de voyage, qui regroupent les entités de données requises pour créer un voyage de travail.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
