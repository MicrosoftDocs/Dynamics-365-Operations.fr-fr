...
description: Ces articles décrivent comment configurer les informations générales et les paramètres de configuration qui sont utilisés dans le module de coûts dédouanés pour la validation, les mises à jour de statut, les séquences de numéros et le comportement.
author: Weijiesa
ms.date: 12/07/2020
ms.topic: article
ms.prod: ''
