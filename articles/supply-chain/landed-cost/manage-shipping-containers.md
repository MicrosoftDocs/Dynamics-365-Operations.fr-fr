...
Le raccourci **Conteneurs d’expédition** dans la vue **Lignes** affiche des informations sur le folio. La plupart de ces informations figurent également dans la vue **En-tête**, comme décrit précédemment dans cet article.
