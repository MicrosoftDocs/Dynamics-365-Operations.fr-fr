...
description: Cet article décrit comment configurer les informations de livraison pour le module de coût au débarquement.
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8895610"
---
# <a name="delivery-information-setup"></a>Paramétrage des informations de livraison

[!include [banner](../../includes/banner.md)]

Cet article décrit comment configurer les informations de livraison pour le module de **coût au débarquement**.
