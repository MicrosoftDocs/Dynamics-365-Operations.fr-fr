...
description: Cet article décrit comment configurer les informations d’expédition pour le module de coût au débarquement.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8882632"
---
# <a name="shipping-information-setup"></a>Paramétrage des informations d’expédition

[!include [banner](../../includes/banner.md)]

Cet article décrit comment configurer les informations d’expédition pour le module **Coût au débarquement**.
