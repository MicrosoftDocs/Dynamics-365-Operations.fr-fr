---
title: Entités Facture fournisseur
description: Cette rubrique fournit des informations sur les entités de facture fournisseur, qui permettent de configurer des codes de type de coût pour les coûts internes ou les coûts dérivés en externe.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
