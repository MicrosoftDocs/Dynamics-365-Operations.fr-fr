...
description: Cet article donne une vue d’ensemble sur la gestion des demandes de maintenance dans le module Gestion des actifs
...
Pour afficher les demandes de maintenance, sélectionnez **Gestion des actifs** \> **Demandes de maintenance** \> **Toutes les demandes de maintenance**, **Demandes de maintenance actives** ou **Mes demandes de maintenance de poste technique**. Chaque page de liste affiche certaines des informations liées à une demande de maintenance.
