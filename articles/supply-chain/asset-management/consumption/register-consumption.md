...
7. Après avoir validé les journaux de consommation, vous pouvez mettre à jour l'état du cycle de vie de l'ordre de travail, par exemple sur « Terminé », pour indiquer que l'ordre de travail a été effectué.

- Dans le champ **Afficher** situé en haut de la page **Journaux des ordres de travail**, sélectionnez les lignes de journal à afficher : Toutes, Non validées ou Validées. Les journaux validés ont une coche dans la case **Validé**.  
