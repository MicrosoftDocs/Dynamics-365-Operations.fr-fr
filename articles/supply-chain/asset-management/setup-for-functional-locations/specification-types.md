...
description: Cet article explique comment créer des types d’attribut dans le module Gestion des actifs.
...
Cet article explique comment créer des types d’attribut dans le module Gestion des actifs. Les attributs permettent de décrire les propriétés de différents éléments. Vous pouvez paramétrer des attributs sur les éléments suivants :
