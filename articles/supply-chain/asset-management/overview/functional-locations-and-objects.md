...
Gestion des actifs est intégré de façon transparente à plusieurs modules avec d’autres applications de finances et d’opérations. L’illustration suivante présente les interfaces avec d’autres modules.
