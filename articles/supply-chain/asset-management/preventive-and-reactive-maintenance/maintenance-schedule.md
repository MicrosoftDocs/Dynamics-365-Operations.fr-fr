...
description: Cet article explique le programme de maintenance dans le module Gestion des actifs.
...
1. Cliquez sur **Gestion des actifs** > **Programme de maintenance** > **Tout le programme de maintenance** ou **Ouvrir les lignes de programme de maintenance** ou **Ouvrir le regroupement de programme de maintenance**.
