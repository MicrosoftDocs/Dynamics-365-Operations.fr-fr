...
description: Cet article explique le contrôle des coûts de défaillance d’un actif dans le module Gestion des actifs.
...
Pour obtenir des informations sur la configuration de défaillances, consultez l'article [Gestion des défaillances](../setup-for-work-orders/fault-management.md).
