...
description: Cet article explique comment configurer et gérer des comptes d’utilisateur qui permettent aux collaborateurs de se connecter et d’utiliser l’application d’entrepôt.
author: Mirzaab
ms.date: 09/15/2021
ms.topic: article
ms.search.form: ''
