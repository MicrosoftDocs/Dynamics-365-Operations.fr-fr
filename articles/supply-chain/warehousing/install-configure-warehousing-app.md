...
> [!NOTE]
> La Zebra App Gallery a été supprimée. Autrement dit, l'application Finance and Operations - Entreposage ne sera plus disponible au téléchargement depuis cet emplacement.
...
2.  Associez votre application Azure Active Directory à l'utilisateur de l'application Entreposage.
    1.  Dans Finance and Operations, accédez à **Administration du système** &gt; **Configuration** &gt; **Applications Azure Active Directory**.
    2.  Créez une ligne.
...
3.  Entrez les informations suivantes : 
    ...
    + **Ressource Azure Active Directory** - La ressource Azure AD Directory représente l'URL racine de Finance and Operations. **Remarque** : ne terminez pas ce champ avec une barre oblique inverse (/). 
    + **Locataire Azure Active Directory** - Le locataire Azure AD Directory représente l'URL racine de Finance and Operations : `https://login.windows.net/your-AD-tenant-ID`. Exemple : `https://login.windows.net/contosooperations.onmicrosoft.com.` 
