...
ms.locfileid: "6711661"
---
# <a name="scan-bar-codes-using-a-camera-in-the-warehouse-management-mobile-app"></a>Lire les codes-barres à l’aide d’une caméra dans l’application mobile Gestion des entrepôts

[!include [banner](../includes/banner.md)]

Cette rubrique explique comment configurer l’application mobile Gestion des entrepôts pour lire les codes-barres à l’aide de la caméra d’un appareil mobile.
