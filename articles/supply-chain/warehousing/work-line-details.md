...
description: Cet article fournit des informations sur la page Détails de la ligne de travail, qui affiche une liste complète, triable et filtrable des lignes de travail individuelles de votre système.
author: Mirzaab
ms.date: 07/01/2020
ms.topic: article
ms.prod: ''
