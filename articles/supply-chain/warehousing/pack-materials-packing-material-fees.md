...
description: Cet article donne des informations sur les taxes sur les matières d’emballage qui sont payées aux entreprises de recyclage à des intervalles spécifiques.
author: Mirzaab
ms.date: 02/19/2020
ms.topic: article
ms.prod: ''
