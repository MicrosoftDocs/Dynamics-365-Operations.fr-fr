...
description: Cet article présente la fonctionnalité qui fournit des extensions de séquence numérique pour les ID de contenant, les ID d’étiquette de vague, les ID de conteneur et les ID de feuille de chargement.
author: Mirzaab
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
