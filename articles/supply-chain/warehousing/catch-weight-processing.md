---
title: Traitement des produits en poids variable avec gestion des entrepôts
description: Cet article décrit comment utiliser les modèles de travail et les instructions d’emplacement afin de déterminer de quelle manière et où effectuer le travail dans l’entrepôt.
author: perlynne
ms.date: 08/13/2020
ms.topic: article
ms.prod: ''
...
- Pour les produits en poids variable, le travail défini dans un modèle de travail ne peut être exécuté automatiquement.
