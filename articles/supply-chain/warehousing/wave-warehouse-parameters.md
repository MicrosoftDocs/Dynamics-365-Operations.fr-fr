...
Cette rubrique décrit comment définir les paramètres d’entrepôt pour le traitement des vagues. Vous pouvez utiliser le traitement de vagues pour regrouper les travaux de prélèvement pour plusieurs ordres d’exécution dans une vague unique.
