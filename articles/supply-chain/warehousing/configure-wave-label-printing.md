...
- <span data-ttu-id="5aaf7-123">Réimprimer des étiquettes à partir d’appareils mobiles et du Rich Client.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-123">Reprint labels from both mobile devices and the rich client.</span></span>
...
- <span data-ttu-id="5aaf7-137">**Module :** *Gestion des entrepôts*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-137">**Module:** *Warehouse management*</span></span>
...
1. <span data-ttu-id="5aaf7-180">Dans la boîte de dialogue de l’éditeur de requêtes, dans l’onglet **Plage**, ajoutez une ligne comportant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-180">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="5aaf7-181">**Table :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-181">**Table:** *Work lines*</span></span>
...
### <a name="create-a-wave-label-type"></a><span data-ttu-id="5aaf7-199">Créer un type d’étiquette de vague</span><span class="sxs-lookup"><span data-stu-id="5aaf7-199">Create a wave label type</span></span>
...
1. <span data-ttu-id="5aaf7-213">Ajoutez un modèle d’étiquette de vague et définissez les valeurs suivantes dans l’en-tête :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-213">Add a wave level template, and set the following values in the header:</span></span>
    ...
    - <span data-ttu-id="5aaf7-214">**Nom du modèle d’étiquette :** *Étiquettes de carton*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-214">**Label template name:** *Carton labels*</span></span>
...
### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="5aaf7-249">Créer une commande client et la lancer dans l’entrepôt</span><span class="sxs-lookup"><span data-stu-id="5aaf7-249">Create a sales order and release it to the warehouse</span></span>
...
<span data-ttu-id="5aaf7-296">Ce scénario montre le flux de bout en bout.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-296">This scenario shows the end-to-end flow.</span></span>
...
### <a name="create-a-wave-label-layout"></a><span data-ttu-id="5aaf7-311">Créer une mise en page d’étiquette de vague</span><span class="sxs-lookup"><span data-stu-id="5aaf7-311">Create a wave label layout</span></span>
...
1. <span data-ttu-id="5aaf7-320">Ajoutez une ligne ayant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-320">Add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="5aaf7-328">**Lignes par page :** *5*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-328">**Rows per page:** *5*</span></span>
        ...
        <span data-ttu-id="5aaf7-329">Ce champ définit le nombre de lignes pouvant être imprimées sur chaque étiquette.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-329">This field defines the number of rows that can be printed on each label.</span></span>
...
1. <span data-ttu-id="5aaf7-354">Accédez à **Gestion des entrepôts \> Paramétrage \> Acheminement de document \> Modèles d’étiquette de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-354">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
...
1. <span data-ttu-id="5aaf7-365">Facultatif : si vous configurez une conception d’étiquette spécifique au client, vous devez créer une requête pour trouver le compte du client.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-365">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="5aaf7-366">Dans l’organisateur **Détails du modèle d’étiquette de vague**, sélectionnez **Modifier la requête**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-366">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="5aaf7-367">Ensuite, dans la boîte de dialogue de l’éditeur de requêtes, dans l’onglet **Plage**, ajoutez une ligne comportant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-367">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    <span data-ttu-id="5aaf7-372">Lorsque vous avez terminé, sélectionnez **OK** pour fermer la boîte de dialogue de l’éditeur de requêtes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-372">When you've finished, select **OK** to close the query editor dialog box.</span></span>
...
1. <span data-ttu-id="5aaf7-382">Ajoutez cinq lignes de commande client :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-382">Add five sales order lines:</span></span>
    ...
    - <span data-ttu-id="5aaf7-389">Ligne de commande client 3 :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-389">Sales order line 3:</span></span>
...
<span data-ttu-id="5aaf7-422">Ce scénario montre le flux de bout en bout.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-422">This scenario shows the end-to-end flow.</span></span>

### <a name="make-demo-data-available"></a><span data-ttu-id="5aaf7-423">Rendre les données de démonstration disponibles</span><span class="sxs-lookup"><span data-stu-id="5aaf7-423">Make demo data available</span></span>

<span data-ttu-id="5aaf7-424">Pour suivre ce scénario, vous devez avoir des données de démonstration installées, et vous devez sélectionner l’entité juridique **USMF**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-424">To follow this scenario, you must have demo data installed, and you must select the **USMF** legal entity.</span></span>

### <a name="set-up-a-wave-process-method"></a><span data-ttu-id="5aaf7-425">Configurer une méthode de traitement de vague</span><span class="sxs-lookup"><span data-stu-id="5aaf7-425">Set up a wave process method</span></span>

1. <span data-ttu-id="5aaf7-426">Accédez à **Gestion des entrepôts \> Paramétrage \> Vagues \> Méthodes de traitement de la vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-426">Go to **Warehouse management \> Setup \> Waves \> Wave process methods**.</span></span>
1. <span data-ttu-id="5aaf7-427">Confirmez que **waveLabelPrinting** est dans la liste.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-427">Confirm that **waveLabelPrinting** is in the list.</span></span> <span data-ttu-id="5aaf7-428">Si elle n’est pas présente, sélectionnez **Régénérer les méthodes** dans le volet Actions pour l’ajouter.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-428">If it isn't, select **Regenerate methods** on the Action Pane to add it.</span></span>
1. <span data-ttu-id="5aaf7-429">Pour la méthode **waveLabelPrinting**, cochez la case **Rendre la méthode répétable**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-429">For the **waveLabelPrinting** method, select the **Make method repeatable** check box.</span></span>

### <a name="set-up-a-wave-template"></a><span data-ttu-id="5aaf7-430">Paramétrage d’un modèle de vague</span><span class="sxs-lookup"><span data-stu-id="5aaf7-430">Set up a wave template</span></span>

1. <span data-ttu-id="5aaf7-431">Accédez à **Gestion des entrepôts \> Configuration \> Vagues \> Modèles de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-431">Go to **Warehouse management \> Setup \> Waves \> Wave templates**.</span></span>
2. <span data-ttu-id="5aaf7-432">Sélectionnez le modèle de vague, tel que **Expédition par défaut 62**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-432">Select a template, such as **62 Shipping Default**.</span></span>
3. <span data-ttu-id="5aaf7-433">Dans l’organiseur **Méthodes**, déplacez la méthode **Impression d’étiquettes de vague** vers la colonne **Méthodes sélectionnées**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-433">On the **Methods** FastTab, move the **Wave label printing** method to the **Selected methods** column.</span></span>
4. <span data-ttu-id="5aaf7-434">Dans la colonne **Méthodes sélectionnées**, attribuez une valeur **Code étape de vague**, telle que *Carton*, à la méthode **Impression d’étiquettes de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-434">In the **Selected methods** column, assign a **Wave step code** value, such as *Carton*, to the **Wave label printing** method.</span></span> <span data-ttu-id="5aaf7-435">Pour plus d’informations sur les codes étape de vague, voir [Codes étape de vague](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="5aaf7-435">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>
5. <span data-ttu-id="5aaf7-436">Déplacez la méthode **Impression d’étiquettes de vague** vers la colonne **Méthodes sélectionnées** une deuxième fois.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-436">Move the **Wave label printing** method to the **Selected methods** column a second time.</span></span>
6. <span data-ttu-id="5aaf7-437">Dans la colonne **Méthodes sélectionnées**, attribuez une autre valeur **Code étape de vague**, telle que *Palette*, à la deuxième méthode **Impression d’étiquettes de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-437">In the **Selected methods** column, assign a different **Wave step code** value, such as *Pallet*, to the second **Wave label printing** method.</span></span> <span data-ttu-id="5aaf7-438">Pour plus d’informations sur les codes étape de vague, voir [Codes étape de vague](wave-step-codes.md).</span><span class="sxs-lookup"><span data-stu-id="5aaf7-438">For more information about wave step codes, see [Wave step codes](wave-step-codes.md).</span></span>

### <a name="create-three-wave-label-layouts"></a><span data-ttu-id="5aaf7-439">Créer trois mises en page d’étiquette de vague</span><span class="sxs-lookup"><span data-stu-id="5aaf7-439">Create three wave label layouts</span></span>

1. <span data-ttu-id="5aaf7-440">Accédez à **Gestion des entrepôts \> Paramétrage \> Acheminement de document \> Mises en page d’étiquette de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-440">Go to **Warehouse management \> Setup \> Document routing \> Wave label layouts**.</span></span>
1. <span data-ttu-id="5aaf7-441">Créez un enregistrement possédant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-441">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-442">**ID de mise en page d’étiquette :** *Carton*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-442">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="5aaf7-443">**Description :** *Carton (SSCC)*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-443">**Description:** *Carton (SSCC)*</span></span>

1. <span data-ttu-id="5aaf7-444">Dans le volet Actions, sélectionnez **Enregistrer**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-444">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="5aaf7-445">Dans le volet Actions, sélectionnez **Paramètres de ligne d’étiquette de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-445">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="5aaf7-446">La page **Paramètres de ligne d’étiquette de vague** s’affiche.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-446">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="5aaf7-447">Ici, vous pouvez configurer la partie dynamique de l’étiquette.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-447">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="5aaf7-448">Ajoutez une ligne ayant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-448">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-449">**ID de ligne :** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-449">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="5aaf7-450">**Nom de la table de lignes :** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-450">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="5aaf7-451">**Position de début de la ligne :** *0*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-451">**Row start position:** *0*</span></span>

        <span data-ttu-id="5aaf7-452">Ce champ définit la position verticale où la ligne commencera sur l’étiquette.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-452">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="5aaf7-453">**Hauteur de ligne :** *0*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-453">**Row height:** *0*</span></span>

        <span data-ttu-id="5aaf7-454">Ce champ définit la hauteur de chaque ligne (en points), selon la norme ZPL.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-454">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="5aaf7-455">La hauteur de ligne est positive pour les étiquettes horizontales et négative pour les étiquettes verticales.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-455">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="5aaf7-456">Comme il n’y a qu’une seule ligne dans cet exemple, vous pouvez définir la valeur sur *0* (zéro).</span><span class="sxs-lookup"><span data-stu-id="5aaf7-456">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="5aaf7-457">**Lignes par page :** *1*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-457">**Rows per page:** *1*</span></span>

        <span data-ttu-id="5aaf7-458">Ce champ définit le nombre de lignes pouvant être imprimées sur chaque étiquette.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-458">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="5aaf7-459">Cette configuration entraînera l’impression d’une étiquette ZPL distincte pour chaque enregistrement dans la table des étiquettes de vague.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-459">This setup will cause a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="5aaf7-460">Fermez la page.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-460">Close the page.</span></span>
1. <span data-ttu-id="5aaf7-461">Dans le volet Actions, sélectionnez **Modifier une requête**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-461">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="5aaf7-462">Dans la boîte de dialogue de l’éditeur de requêtes, dans l’onglet **Plage**, ajoutez une ligne comportant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-462">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-463">**Table :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-463">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-464">**Table dérivée :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-464">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-465">**Champ :** *Type de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-465">**Field:** *Work type*</span></span>
    - <span data-ttu-id="5aaf7-466">**Critères :** *Prélèvement*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-466">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="5aaf7-467">Cette requête garantit que seules les lignes de travail de type Prélèvement seront imprimées sur l’étiquette, et non les lignes de travail de type Placement.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-467">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="5aaf7-468">Si vous souhaitez pouvoir imprimer l’ID de la feuille de chargement, dans l’onglet **Jointures**, sélectionnez la table **Lignes de travail** et joignez-y la table **Expéditions**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-468">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span> 
1. <span data-ttu-id="5aaf7-469">Fermez la boîte de dialogue de l’éditeur de requêtes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-469">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="5aaf7-470">L’organisateur **Mise en page du texte de l’imprimante** comporte trois sections dans lesquelles vous pouvez écrire le code de l’imprimante : **Section d’en-tête**, **Section du corps** et **Section pied de page**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-470">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="5aaf7-471">Dans la **Section d’en-tête**, dans le champ **En-tête de l’étiquette**, entrez le code de l’en-tête requis.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-471">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="5aaf7-472">Par exemple, si vous utilisez des imprimantes Zebra, vous pouvez utiliser le code suivant.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-472">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="5aaf7-473">Dans la **Section de corps**, dans le champ **Corps de l’étiquette**, entrez le code ZPL du corps requis.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-473">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="5aaf7-474">Voici un exemple :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-474">Here is an example.</span></span>
...
1. <span data-ttu-id="5aaf7-475">Dans la **Section de pied de page**, dans le champ **Pied de page de l’étiquette**, entrez le code ZPL du pied de page requis.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-475">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="5aaf7-476">Voici un exemple :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-476">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="5aaf7-477">Cette configuration imprimera un exemplaire de chaque étiquette.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-477">This setup will print one copy of each label.</span></span> <span data-ttu-id="5aaf7-478">Si vous avez besoin de davantage d’exemplaires (par exemple, une copie pour chaque côté de la palette), définissez la valeur **n** pour la section **\^PQn** dans le pied de page au nombre d’exemplaires requis.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-478">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="5aaf7-479">Par exemple, pour imprimer quatre copies de chaque étiquette, spécifiez **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-479">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="5aaf7-480">La première étiquette est maintenant prête à être utilisée.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-480">The first label is now ready to use.</span></span>
1. <span data-ttu-id="5aaf7-481">Créez un deuxième enregistrement de mise en page possédant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-481">Create a second layout record that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-482">**ID de mise en page d’étiquette :** *Palette*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-482">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="5aaf7-483">**Description :** *Palette*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-483">**Description:** *Pallet*</span></span>

1. <span data-ttu-id="5aaf7-484">Dans le volet Actions, sélectionnez **Enregistrer**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-484">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="5aaf7-485">Dans le volet Actions, sélectionnez **Paramètres de ligne d’étiquette de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-485">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="5aaf7-486">La page **Paramètres de ligne d’étiquette de vague** s’affiche.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-486">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="5aaf7-487">Ici, vous pouvez configurer la partie dynamique de l’étiquette.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-487">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="5aaf7-488">Ajoutez une ligne ayant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-488">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-489">**ID de ligne :** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-489">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="5aaf7-490">**Nom de la table de lignes :** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-490">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="5aaf7-491">**Position de début de la ligne :** *0*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-491">**Row start position:** *0*</span></span>

        <span data-ttu-id="5aaf7-492">Ce champ définit la position verticale où la ligne commencera sur l’étiquette.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-492">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="5aaf7-493">**Hauteur de ligne :** *0*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-493">**Row height:** *0*</span></span>

        <span data-ttu-id="5aaf7-494">Ce champ définit la hauteur de chaque ligne (en points), selon la norme ZPL.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-494">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="5aaf7-495">La hauteur de ligne est positive pour les étiquettes horizontales et négative pour les étiquettes verticales.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-495">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="5aaf7-496">Comme il n’y a qu’une seule ligne dans cet exemple, vous pouvez définir la valeur sur *0* (zéro).</span><span class="sxs-lookup"><span data-stu-id="5aaf7-496">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="5aaf7-497">**Lignes par page :** *1*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-497">**Rows per page:** *1*</span></span>

        <span data-ttu-id="5aaf7-498">Ce champ définit le nombre de lignes pouvant être imprimées sur chaque étiquette.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-498">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="5aaf7-499">Cette configuration entraîne l’impression d’une étiquette ZPL distincte pour chaque enregistrement dans la table des étiquettes de vague.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-499">This setup causes a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="5aaf7-500">Fermez la page.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-500">Close the page.</span></span>
1. <span data-ttu-id="5aaf7-501">Dans le volet Actions, sélectionnez **Modifier une requête**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-501">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="5aaf7-502">Dans la boîte de dialogue de l’éditeur de requêtes, dans l’onglet **Plage**, ajoutez une ligne comportant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-502">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-503">**Table :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-503">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-504">**Table dérivée :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-504">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-505">**Champ :** *Type de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-505">**Field:** *Work type*</span></span>
    - <span data-ttu-id="5aaf7-506">**Critères :** *Prélèvement*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-506">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="5aaf7-507">Cette requête garantit que seules les lignes de travail de type Prélèvement seront imprimées sur l’étiquette, et non les lignes de travail de type Placement.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-507">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="5aaf7-508">Si vous souhaitez pouvoir imprimer l’ID de la feuille de chargement, dans l’onglet **Jointures**, sélectionnez la table **Lignes de travail** et joignez-y la table **Expéditions**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-508">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span>
1. <span data-ttu-id="5aaf7-509">Fermez la boîte de dialogue de l’éditeur de requêtes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-509">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="5aaf7-510">L’organisateur **Mise en page du texte de l’imprimante** comporte trois sections dans lesquelles vous pouvez écrire le code de l’imprimante : **Section d’en-tête**, **Section du corps** et **Section pied de page**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-510">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="5aaf7-511">Dans la **Section d’en-tête**, dans le champ **En-tête de l’étiquette**, entrez le code de l’en-tête requis.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-511">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="5aaf7-512">Par exemple, si vous utilisez des imprimantes Zebra, vous pouvez utiliser le code suivant.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-512">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="5aaf7-513">Dans la **Section de corps**, dans le champ **Corps de l’étiquette**, entrez le code ZPL du corps requis.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-513">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="5aaf7-514">Voici un exemple :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-514">Here is an example.</span></span>
...
1. <span data-ttu-id="5aaf7-515">Dans la **Section de pied de page**, dans le champ **Pied de page de l’étiquette**, entrez le code ZPL du pied de page requis.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-515">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="5aaf7-516">Voici un exemple :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-516">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="5aaf7-517">Cette configuration imprimera un exemplaire de chaque étiquette.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-517">This setup will print one copy of each label.</span></span> <span data-ttu-id="5aaf7-518">Si vous avez besoin de davantage d’exemplaires (par exemple, une copie pour chaque côté de la palette), définissez la valeur **n** pour la section **\^PQn** dans le pied de page au nombre d’exemplaires requis.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-518">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="5aaf7-519">Par exemple, pour imprimer quatre copies de chaque étiquette, spécifiez **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-519">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="5aaf7-520">La deuxième étiquette est maintenant prête à être utilisée.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-520">The second label is now ready to use.</span></span>
1. <span data-ttu-id="5aaf7-521">Créez un troisième enregistrement de mise en page possédant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-521">Create a third layout record that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-522">**ID de mise en page d’étiquette :** *Séparation*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-522">**Label layout ID:** *Break*</span></span>
    - <span data-ttu-id="5aaf7-523">**Description :** *Étiquette de séparation*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-523">**Description:** *Break label*</span></span>

1. <span data-ttu-id="5aaf7-524">Dans le volet Actions, sélectionnez **Enregistrer**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-524">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="5aaf7-525">L’organisateur **Mise en page du texte de l’imprimante** comporte trois sections dans lesquelles vous pouvez écrire le code de l’imprimante : **Section d’en-tête**, **Section du corps** et **Section pied de page**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-525">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="5aaf7-526">Dans la **Section d’en-tête**, dans le champ **En-tête de l’étiquette**, entrez le code ZPL de l’en-tête requis.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-526">In the **Header section** section, in the **Label header** field, enter ZPL code for the required header.</span></span> <span data-ttu-id="5aaf7-527">Voici un exemple :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-527">Here is an example.</span></span>
...
1. <span data-ttu-id="5aaf7-528">Cette fois, aucun corps n’est requis.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-528">This time, no body is required.</span></span> <span data-ttu-id="5aaf7-529">Par conséquent, entrez simplement le texte requis dans la section **Pied de page**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-529">Therefore, just enter the required text in the **Footer section** section.</span></span> <span data-ttu-id="5aaf7-530">Voici un exemple :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-530">Here is an example.</span></span>

    ```plaintext
    ^XZ
    ```

    <span data-ttu-id="5aaf7-531">La troisième étiquette est maintenant prête à être utilisée.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-531">The third label is now ready to use.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5aaf7-532">Cette troisième étiquette est une étiquette de séparation qui sera utilisée comme séparateur entre les rouleaux d’étiquettes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-532">This third label is a break label that will be used as a divider between label rolls.</span></span>

### <a name="create-two-wave-label-types"></a><span data-ttu-id="5aaf7-533">Créer deux types d’étiquette de vague</span><span class="sxs-lookup"><span data-stu-id="5aaf7-533">Create two wave label types</span></span>

1. <span data-ttu-id="5aaf7-534">Accédez à **Gestion des entrepôts \> Paramétrage \> Acheminement de document \> Types d’étiquette de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-534">Go to **Warehouse management \> Setup \> Document routing \> Wave label types**.</span></span>
1. <span data-ttu-id="5aaf7-535">Créez un enregistrement possédant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-535">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-536">**Type d’étiquette :** *Carton*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-536">**Label type:** *Carton*</span></span>
    - <span data-ttu-id="5aaf7-537">**Description :** *Carton*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-537">**Description:** *Carton*</span></span>

1. <span data-ttu-id="5aaf7-538">Créez un deuxième enregistrement possédant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-538">Create a second record that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-539">**Type d’étiquette :** *Palette*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-539">**Label type:** *Pallet*</span></span>
    - <span data-ttu-id="5aaf7-540">**Description :** *Palette*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-540">**Description:** *Pallet*</span></span>

### <a name="set-up-unit-sequence-groups"></a><span data-ttu-id="5aaf7-541">Définir des groupes de séquences d’unités</span><span class="sxs-lookup"><span data-stu-id="5aaf7-541">Set up unit sequence groups</span></span>

1. <span data-ttu-id="5aaf7-542">Accédez à **Gestion des entrepôts \> Paramétrage \> Entrepôt \> Groupes de séquences d’unités**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-542">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups**.</span></span>
1. <span data-ttu-id="5aaf7-543">Sélectionnez ou créez un groupe **Ea Box PL**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-543">Select or create an **Ea Box PL** group.</span></span>
1. <span data-ttu-id="5aaf7-544">Pour la ligne **Boîte**, définissez le champ **Type de niveau de vague** sur *Carton*.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-544">For the **Box** line, set the **Wave level type** field to *Carton*.</span></span>
1. <span data-ttu-id="5aaf7-545">Pour la ligne **PL**, définissez le champ **Type de niveau de vague** sur *Palette*.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-545">For the **PL** line, set the **Wave level type** field to *Pallet*.</span></span>

### <a name="create-wave-label-templates"></a><span data-ttu-id="5aaf7-546">Créer des modèles d’étiquette de vague</span><span class="sxs-lookup"><span data-stu-id="5aaf7-546">Create wave label templates</span></span>

1. <span data-ttu-id="5aaf7-547">Accédez à **Gestion des entrepôts \> Paramétrage \> Acheminement de document \> Modèles d’étiquette de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-547">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
1. <span data-ttu-id="5aaf7-548">Créez un modèle d’étiquette possédant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-548">Create a label template that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-549">**Nom du modèle d’étiquette :** *Étiquettes de carton*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-549">**Label template name:** *Carton labels*</span></span>
    - <span data-ttu-id="5aaf7-550">**Description :** *Étiquettes de carton*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-550">**Description:** *Carton labels*</span></span>
    - <span data-ttu-id="5aaf7-551">**Code étape de vague :** *Carton*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-551">**Wave step code:** *Carton*</span></span>
    - <span data-ttu-id="5aaf7-552">**Entrepôt :** *62*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-552">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="5aaf7-553">Dans l’organisateur **Général**, dans le champ **Type d’étiquette de vague**, sélectionnez une valeur, telle que *Carton*.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-553">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Carton*.</span></span>
1. <span data-ttu-id="5aaf7-554">Dans l’organisateur **Détails du modèle d’étiquette de vague**, ajoutez une ligne avec les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-554">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-555">**ID de mise en page d’étiquette :** *Carton*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-555">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="5aaf7-556">**Nom de l’imprimante :** sélectionnez une imprimante ZPL appropriée.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-556">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="5aaf7-557">**Exécuter la requête :** *Oui* (Ce paramètre est facultatif, mais il est recommandé pour des performances optimales.)</span><span class="sxs-lookup"><span data-stu-id="5aaf7-557">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="5aaf7-558">Dans le volet Actions, sélectionnez **Enregistrer**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-558">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="5aaf7-559">Facultatif : si vous configurez une conception d’étiquette spécifique au client, vous devez créer une requête pour trouver le compte du client.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-559">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="5aaf7-560">Dans l’organisateur **Détails du modèle d’étiquette de vague**, sélectionnez **Modifier la requête**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-560">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="5aaf7-561">Ensuite, dans la boîte de dialogue de l’éditeur de requêtes, dans l’onglet **Plage**, ajoutez une ligne comportant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-561">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-562">**Table :** *Expéditions*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-562">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="5aaf7-563">**Table dérivée :** *Expéditions*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-563">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="5aaf7-564">**Champ :** *Numéro de compte*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-564">**Field:** *Account number*</span></span>
    - <span data-ttu-id="5aaf7-565">**Critères :** saisissez le numéro de compte client concerné.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-565">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="5aaf7-566">Lorsque vous avez terminé, sélectionnez **OK** pour fermer la boîte de dialogue de l’éditeur de requêtes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-566">When you've finished, select **OK** to close the query editor dialog box.</span></span>

1. <span data-ttu-id="5aaf7-567">Dans le volet Actions, sélectionnez **Modifier la requête** pour ouvrir la boîte de dialogue de l’éditeur de requête pour le modèle d’étiquette entier.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-567">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="5aaf7-568">Dans la boîte de dialogue de l’éditeur de requêtes, dans l’onglet **Tri**, ajoutez une ligne comportant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-568">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-569">**Table :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-569">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-570">**Table dérivée :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-570">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-571">**Champ :** *ID de ligne de chargement de référence (Record-ID)*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-571">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="5aaf7-572">**Ordre de tri :** *Croissant*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-572">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="5aaf7-573">Ajoutez une deuxième ligne ayant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-573">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-574">**Table :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-574">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-575">**Table dérivée :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-575">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-576">**Champ :** *ID expédition*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-576">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="5aaf7-577">**Ordre de tri :** *Croissant*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-577">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="5aaf7-578">Sélectionnez **OK** pour fermer la boîte de dialogue de l’éditeur de requêtes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-578">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="5aaf7-579">Une boîte de message vous invite à confirmer l’opération de réinitialisation du regroupement.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-579">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="5aaf7-580">Sélectionnez **Oui** pour continuer.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-580">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="5aaf7-581">Dans le volet Actions, sélectionnez **Regroupement de modèles d’étiquettes de vagues**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-581">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="5aaf7-582">Dans la boîte de dialogue **Groupe de modèles d’étiquettes de vague**, pour la ligne où le **Nom du champ de référence** est défini sur *ID d’expédition*, définissez les valeurs suivantes :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-582">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="5aaf7-583">**Imprimer étiquette de séparation :** cochez cette case.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-583">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="5aaf7-584">**ID de mise en page d’étiquette :** sélectionnez une étiquette de séparation.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-584">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="5aaf7-585">(Par exemple, sélectionnez la mise en page d’étiquette *Séparation* que vous avez créée précédemment dans ce scénario.)</span><span class="sxs-lookup"><span data-stu-id="5aaf7-585">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="5aaf7-586">**Nom de l’imprimante :** sélectionnez l’imprimante pour l’étiquette de séparation.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-586">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="5aaf7-587">(En général, pour diviser les rouleaux d’étiquettes, vous devez sélectionner la même imprimante que celle sélectionnée dans l’organisateur **Détails du modèle d’étiquette de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-587">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="5aaf7-588">Cependant, d’autres scénarios sont possibles.)</span><span class="sxs-lookup"><span data-stu-id="5aaf7-588">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="5aaf7-589">Pour la rangée où le champ **Nom du champ de référence** est défini sur *ID de ligne de chargement de référence*, cochez la case **ID de build d’étiquette**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-589">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5aaf7-590">Cette configuration créera une séquence d’étiquettes (« Carton 1 sur X ») par ligne de chargement tout au long de la vague, quelle que soit la configuration de regroupement du travail.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-590">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="5aaf7-591">Cette séquence d’étiquettes peut être imprimée sur une mise en page d’étiquettes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-591">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="5aaf7-592">De plus, les étiquettes des différents envois seront séparées par l’étiquette de séparation sélectionnée.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-592">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

1. <span data-ttu-id="5aaf7-593">Sélectionnez **OK** pour fermer la boîte de dialogue **Groupe de modèles d’étiquettes de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-593">Select **OK** to close the **Wave label template group** dialog box.</span></span>
1. <span data-ttu-id="5aaf7-594">Créez un deuxième modèle d’étiquette possédant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-594">Create a second label template that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-595">**Nom du modèle d’étiquette :** *Étiquettes de palette*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-595">**Label template name:** *Pallet labels*</span></span>
    - <span data-ttu-id="5aaf7-596">**Description :** *Étiquettes de palette*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-596">**Description:** *Pallet labels*</span></span>
    - <span data-ttu-id="5aaf7-597">**Code étape de vague :** *Palette*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-597">**Wave step code:** *Pallet*</span></span>
    - <span data-ttu-id="5aaf7-598">**Entrepôt :** *62*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-598">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="5aaf7-599">Dans l’organisateur **Général**, dans le champ **Type d’étiquette de vague**, sélectionnez une valeur, telle que *Palette*.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-599">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Pallet*.</span></span>
1. <span data-ttu-id="5aaf7-600">Dans l’organisateur **Détails du modèle d’étiquette de vague**, ajoutez une ligne avec les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-600">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-601">**ID de mise en page d’étiquette :** *Palette*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-601">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="5aaf7-602">**Nom de l’imprimante :** sélectionnez une imprimante ZPL appropriée.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-602">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="5aaf7-603">**Exécuter la requête :** *Oui* (Ce paramètre est facultatif, mais il est recommandé pour des performances optimales.)</span><span class="sxs-lookup"><span data-stu-id="5aaf7-603">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="5aaf7-604">Dans le volet Actions, sélectionnez **Enregistrer**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-604">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="5aaf7-605">Facultatif : si vous configurez une conception d’étiquette spécifique au client, vous devez créer une requête pour trouver le compte du client.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-605">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="5aaf7-606">Dans l’organisateur **Détails du modèle d’étiquette de vague**, sélectionnez **Modifier la requête**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-606">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="5aaf7-607">Ensuite, dans la boîte de dialogue de l’éditeur de requêtes, dans l’onglet **Plage**, ajoutez une ligne comportant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-607">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-608">**Table :** *Expéditions*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-608">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="5aaf7-609">**Table dérivée :** *Expéditions*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-609">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="5aaf7-610">**Champ :** *Numéro de compte*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-610">**Field:** *Account number*</span></span>
    - <span data-ttu-id="5aaf7-611">**Critères :** saisissez le numéro de compte client concerné.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-611">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="5aaf7-612">Lorsque vous avez terminé, sélectionnez **OK** pour fermer la boîte de dialogue de l’éditeur de requêtes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-612">When you've finished, select **OK** to close the query editor dialog box.</span></span> 

1. <span data-ttu-id="5aaf7-613">Dans le volet Actions, sélectionnez **Modifier la requête** pour ouvrir la boîte de dialogue de l’éditeur de requête pour le modèle d’étiquette entier.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-613">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="5aaf7-614">Dans la boîte de dialogue de l’éditeur de requêtes, dans l’onglet **Tri**, ajoutez une ligne comportant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-614">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-615">**Table :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-615">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-616">**Table dérivée :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-616">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-617">**Champ :** *ID de ligne de chargement de référence (Record-ID)*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-617">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="5aaf7-618">**Ordre de tri :** *Croissant*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-618">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="5aaf7-619">Ajoutez une deuxième ligne ayant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-619">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-620">**Table :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-620">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-621">**Table dérivée :** *Lignes de travail*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-621">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="5aaf7-622">**Champ :** *ID expédition*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-622">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="5aaf7-623">**Ordre de tri :** *Croissant*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-623">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="5aaf7-624">Sélectionnez **OK** pour fermer la boîte de dialogue de l’éditeur de requêtes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-624">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="5aaf7-625">Une boîte de message vous invite à confirmer l’opération de réinitialisation du regroupement.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-625">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="5aaf7-626">Sélectionnez **Oui** pour continuer.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-626">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="5aaf7-627">Dans le volet Actions, sélectionnez **Regroupement de modèles d’étiquettes de vagues**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-627">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="5aaf7-628">Dans la boîte de dialogue **Groupe de modèles d’étiquettes de vague**, pour la ligne où le **Nom du champ de référence** est défini sur *ID d’expédition*, définissez les valeurs suivantes :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-628">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="5aaf7-629">**Imprimer étiquette de séparation :** cochez cette case.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-629">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="5aaf7-630">**ID de mise en page d’étiquette :** sélectionnez une étiquette de séparation.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-630">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="5aaf7-631">(Par exemple, sélectionnez la mise en page d’étiquette *Séparation* que vous avez créée précédemment dans ce scénario.)</span><span class="sxs-lookup"><span data-stu-id="5aaf7-631">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="5aaf7-632">**Nom de l’imprimante :** sélectionnez l’imprimante pour l’étiquette de séparation.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-632">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="5aaf7-633">(En général, pour diviser les rouleaux d’étiquettes, vous devez sélectionner la même imprimante que celle sélectionnée dans l’organisateur **Détails du modèle d’étiquette de vague**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-633">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="5aaf7-634">Cependant, d’autres scénarios sont possibles.)</span><span class="sxs-lookup"><span data-stu-id="5aaf7-634">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="5aaf7-635">Pour la rangée où le champ **Nom du champ de référence** est défini sur *ID de ligne de chargement de référence*, cochez la case **ID de build d’étiquette**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-635">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="5aaf7-636">Cette configuration créera une séquence d’étiquettes (« Carton 1 sur X ») par ligne de chargement tout au long de la vague, quelle que soit la configuration de regroupement du travail.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-636">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="5aaf7-637">Cette séquence d’étiquettes peut être imprimée sur une mise en page d’étiquettes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-637">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="5aaf7-638">De plus, les étiquettes des différents envois seront séparées par l’étiquette de séparation sélectionnée.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-638">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="5aaf7-639">Configurer les extensions de séquence numérique</span><span class="sxs-lookup"><span data-stu-id="5aaf7-639">Configure number sequence extensions</span></span>

<span data-ttu-id="5aaf7-640">Les extensions de séquence numérique contrôlent la conformité GS1 de séquences de numéros spécifiques.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-640">Number sequence extensions control the GS1 compliance of specific number sequences.</span></span> <span data-ttu-id="5aaf7-641">Cette configuration est facultative pour le scénario actuel.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-641">This configuration is optional for the current scenario.</span></span> <span data-ttu-id="5aaf7-642">Pour plus d’informations et des instructions de configuration, consultez [Configurer les extensions de séquence numérique](../warehousing/configure-number-sequence-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="5aaf7-642">For more information and configuration instructions, see [Configure number sequence extensions](../warehousing/configure-number-sequence-extensions.md).</span></span>

### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="5aaf7-643">Créer une commande client et la lancer dans l’entrepôt</span><span class="sxs-lookup"><span data-stu-id="5aaf7-643">Create a sales order and release it to the warehouse</span></span>

1. <span data-ttu-id="5aaf7-644">Accédez à **Ventes et marketing \> Commandes client \> Toutes les commandes client**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-644">Go to **Sales and marketing \> Sales order \> All sales orders**.</span></span>
1. <span data-ttu-id="5aaf7-645">Créez une commande client possédant les paramètres suivants :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-645">Create a sales order that has the following settings:</span></span>

    - <span data-ttu-id="5aaf7-646">**Compte client :** *US-001*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-646">**Customer account:** *US-001*</span></span>
    - <span data-ttu-id="5aaf7-647">**Entrepôt :** *62*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-647">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="5aaf7-648">Ajoutez deux lignes de commande client :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-648">Add two sales order lines:</span></span>

    - <span data-ttu-id="5aaf7-649">Ligne de commande client 1 :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-649">Sales order line 1:</span></span>

        - <span data-ttu-id="5aaf7-650">**Numéro d’article :** *A0001*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-650">**Item number:** *A0001*</span></span>
        - <span data-ttu-id="5aaf7-651">**Quantité :** *9024*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-651">**Quantity:** *9024*</span></span>
        - <span data-ttu-id="5aaf7-652">**Unité :** *unité* (9024 unités = 376 boîtes = 47 PL)</span><span class="sxs-lookup"><span data-stu-id="5aaf7-652">**Unit:** *ea* (9024 ea = 376 Box = 47 PL)</span></span>

    - <span data-ttu-id="5aaf7-653">Ligne de commande client 2 :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-653">Sales order line 2:</span></span>

        - <span data-ttu-id="5aaf7-654">**Numéro d’article :** *A0002*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-654">**Item number:** *A0002*</span></span>
        - <span data-ttu-id="5aaf7-655">**Quantité :** *9016*</span><span class="sxs-lookup"><span data-stu-id="5aaf7-655">**Quantity:** *9016*</span></span>
        - <span data-ttu-id="5aaf7-656">**Unité :** *unité* (9016 unités = 322 boîtes = 46 PL)</span><span class="sxs-lookup"><span data-stu-id="5aaf7-656">**Unit:** *ea* (9016 ea = 322 Box = 46 PL)</span></span>

    > [!NOTE]
    > <span data-ttu-id="5aaf7-657">Les articles et quantités fournis ici ne sont que des exemples.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-657">The items and quantities that are provided here are only examples.</span></span> <span data-ttu-id="5aaf7-658">Ils doivent utiliser le groupe de séquences d’unités que vous avez défini précédemment, les conversions d’unités appropriées entre *unité*, *Boîte* et *PL* doivent être définies, et ils doivent être en stock dans l’entrepôt *62*.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-658">They must use the unit sequence group that you defined earlier, appropriate unit conversions from *ea* to *Box* to *PL* must be defined for them, and they must have stock in warehouse *62*.</span></span> <span data-ttu-id="5aaf7-659">Pour plus d’informations, voir [Stratégies d’unité de mesure et de stockage](unit-measure-stocking-policies.md).</span><span class="sxs-lookup"><span data-stu-id="5aaf7-659">For more information, see [Unit of measure and stocking policies](unit-measure-stocking-policies.md).</span></span>

1. <span data-ttu-id="5aaf7-660">Sélectionnez la ligne de commande client 1.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-660">Select sales order line 1.</span></span> <span data-ttu-id="5aaf7-661">Dans la section **Ligne de commande client**, dans le menu **Stock**, sélectionnez **Réservations**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-661">Then, in the **Sales order line** section, on the **Inventory** menu, select **Reservations**.</span></span>
1. <span data-ttu-id="5aaf7-662">Sur la page **Réservation**, dans le volet Actions, sélectionnez **Réserver un lot**, puis fermez la page.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-662">On the **Reservation** page, on the Action Pane, select **Reserve lot**, and then close the page.</span></span>
1. <span data-ttu-id="5aaf7-663">Répétez les étapes 4 et 5 pour la ligne de commande client 2.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-663">Repeat steps 4 and 5 for sales order line 2.</span></span>
1. <span data-ttu-id="5aaf7-664">Dans le volet Actions, sous l’onglet **Entrepôt**, sélectionnez **Libérer dans l’entrepôt**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-664">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>

    <span data-ttu-id="5aaf7-665">Les événements suivants surviennent :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-665">The following events occur:</span></span> 

    - <span data-ttu-id="5aaf7-666">Le système traite l’expédition créée à l’aide du modèle qui inclut l’étape d’impression d’étiquettes.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-666">The system processes the created shipment by using the template that includes the label printing step.</span></span> <span data-ttu-id="5aaf7-667">La mise en page de l’étiquette sera utilisée pour définir le format de l’étiquette et le résultat sera une étiquette imprimée sur l’imprimante sélectionnée dans le modèle d’étiquette.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-667">The label layout will be used to define the format of the label, and the result will be a label that is printed on the printer that is selected in the label template.</span></span>
    - <span data-ttu-id="5aaf7-668">Les étiquettes de vague sont générées et imprimées.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-668">Wave labels are generated and printed.</span></span> <span data-ttu-id="5aaf7-669">Le nombre d’étiquettes sera égal au nombre de cartons (dans cet exemple, 376 étiquettes de boîte pour la ligne 1, 322 étiquettes de boîte pour la ligne 2, 47 étiquettes PL pour la ligne 1, 47 étiquettes PL pour la ligne 2 et deux étiquettes de séparation portant l’ID d’expédition).</span><span class="sxs-lookup"><span data-stu-id="5aaf7-669">The number of labels will equal the number of cartons (in this example, 376 Box labels for line 1, 322 Box labels for line 2, 47 PL labels for line 1, 47 PL labels for line 2, and two break labels that have the shipment ID).</span></span>
    - <span data-ttu-id="5aaf7-670">Un nouvel identificateur de feuille de chargement est généré pour les expéditions.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-670">A new bill of lading ID is generated for the shipments.</span></span> <span data-ttu-id="5aaf7-671">Si vous avez configuré les extensions de séquence numérique, les ID d’étiquette de vague seront au format numérique **SSCC-18**.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-671">If you configured the number sequence extensions, the wave label IDs will follow the **SSCC-18** number format.</span></span> 

<span data-ttu-id="5aaf7-672">Vous pouvez afficher et réimprimer des étiquettes de vague à partir des pages suivantes :</span><span class="sxs-lookup"><span data-stu-id="5aaf7-672">You can view and reprint wave labels from the following pages:</span></span>

- <span data-ttu-id="5aaf7-673">Toutes les expéditions \>Détails de l’expédition</span><span class="sxs-lookup"><span data-stu-id="5aaf7-673">All shipments \> Shipment details</span></span>
- <span data-ttu-id="5aaf7-674">Tous les chargements \>Charger du chargement</span><span class="sxs-lookup"><span data-stu-id="5aaf7-674">All loads \> Load details</span></span>
- <span data-ttu-id="5aaf7-675">Toutes les vagues</span><span class="sxs-lookup"><span data-stu-id="5aaf7-675">All waves</span></span>
- <span data-ttu-id="5aaf7-676">Étiquettes de vague</span><span class="sxs-lookup"><span data-stu-id="5aaf7-676">Wave labels</span></span>
- <span data-ttu-id="5aaf7-677">Historique des étiquettes de la vague</span><span class="sxs-lookup"><span data-stu-id="5aaf7-677">Wave label history</span></span>

<span data-ttu-id="5aaf7-678">Pour la plupart de ces pages, vous pouvez trouver la fonction appropriée en sélectionnant **Étiquettes de vague** dans le groupe **Informations connexes** de l’onglet **Expéditions** du volet Actions.</span><span class="sxs-lookup"><span data-stu-id="5aaf7-678">For most of these pages, you can find the relevant function by selecting **Wave labels** in the **Related information** group on the **Shipments** tab of the Action Pane.</span></span>
