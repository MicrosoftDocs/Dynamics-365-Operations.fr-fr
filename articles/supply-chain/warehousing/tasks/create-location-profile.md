...
5. Entrez ou sélectionnez une valeur dans le champ **Format de l'emplacement**.
6. Entrez ou sélectionnez une valeur dans le champ **Type d'emplacement**.
7. Entrez ou sélectionnez une valeur dans le champ **ID profil de gestion des quais**.
8. Sélectionnez **Oui** dans le champ **Autoriser les articles mixtes**.
9. Sélectionnez **Oui** dans le champ **Autoriser les statuts de stock mixtes**.
