...
1. <span data-ttu-id="3e555-110">Accédez à Gestion des entrepôts > Configuration > Travail > Classes de travail.</span><span class="sxs-lookup"><span data-stu-id="3e555-110">Go to Warehouse management > Setup > Work > Work classes.</span></span>
2. <span data-ttu-id="3e555-111">Cliquez sur Nouveau.</span><span class="sxs-lookup"><span data-stu-id="3e555-111">Click New.</span></span>
3. <span data-ttu-id="3e555-112">Tapez une valeur dans le champ ID classe de travail.</span><span class="sxs-lookup"><span data-stu-id="3e555-112">In the Work class ID field, type a value.</span></span>
4. <span data-ttu-id="3e555-113">Dans le champ Description, entrez une valeur.</span><span class="sxs-lookup"><span data-stu-id="3e555-113">In the Description field, type a value.</span></span>
5. <span data-ttu-id="3e555-114">Sélectionnez une option dans le champ Type d'ordre d'exécution.</span><span class="sxs-lookup"><span data-stu-id="3e555-114">In the Work order type field, select an option.</span></span>
6. <span data-ttu-id="3e555-115">Cliquez sur Nouveau.</span><span class="sxs-lookup"><span data-stu-id="3e555-115">Click New.</span></span>
7. <span data-ttu-id="3e555-116">Dans le champ Emplacement, tapez une valeur.</span><span class="sxs-lookup"><span data-stu-id="3e555-116">In the Location type field, type a value.</span></span>
    * <span data-ttu-id="3e555-117">Si vous sélectionnez un type d'emplacement, ceci définit une restriction quant au lieu dans lequel les articles peuvent être mis une fois qu'ils ont été prélevés.</span><span class="sxs-lookup"><span data-stu-id="3e555-117">If you select a location type, this sets a restriction on where items can be put after they’ve been picked.</span></span> <span data-ttu-id="3e555-118">Ce paramètre est utilisé lors de tentatives d'une directive d'emplacement pour résoudre l'emplacement, ou si un employé de l'entrepôt fournit manuellement l'emplacement pour l'élément du menu du périphérique portable.</span><span class="sxs-lookup"><span data-stu-id="3e555-118">This setting is used when a location directive tries to resolve the location, or if a warehouse worker manually provides the location for the mobile device menu item.</span></span>  
8. <span data-ttu-id="3e555-119">Fermez la page.</span><span class="sxs-lookup"><span data-stu-id="3e555-119">Close the page.</span></span>
