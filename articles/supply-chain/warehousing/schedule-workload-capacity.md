...
description: Cet article explique comment paramétrer et planifier la capacité de charge de travail pour les collaborateurs d’un entrepôt ou pour un entrepôt entier.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
