...
ms.locfileid: "859757"
---
# <a name="warehouse-mobile-device-display-settings"></a>Paramètres d'affichage de l'appareil mobile d'entrepôt

[!include [banner](../includes/banner.md)]

> [!NOTE]
> Cette fonction est obsolète. Pour plus d'informations, voir [Fonctions supprimées ou obsolètes](../../dev-itpro/migration-upgrade/deprecated-features.md#warehouse-mobile-devices-portal).
