...
description: Cet article décrit la procédure de configuration des principes de réduction. Les principes de réduction contrôlent le comportement de l’application de plusieurs remises à un même article ou une même transaction.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
