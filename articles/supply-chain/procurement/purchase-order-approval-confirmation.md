...
description: Cet article décrit les statuts par lesquels passe une commande fournisseur après sa création et les conséquences de l’activation de la gestion des modifications sur les CF.
