...
description: Cet article décrit l’utilisation d’un catalogue externe ou catalogue PunchOut pour collecter les informations de devis d’un fournisseur et les ajouter à une demande.
