...
Après avoir ajouté l’en-tête et les lignes à la CF, vous devez souvent effectuer des étapes supplémentaires avant que la commande soit prête à être confirmée. Étant donné que plusieurs options sont disponibles, il peut s’avérer utile d’utiliser [Recherche d’actions](../../fin-ops-core/fin-ops/get-started/action-search.md) pour trouver l’article de menu approprié.  
