...
---
# <a name="procurement-and-sourcing-overview"></a>Vue d'ensemble des approvisionnements

[!include [banner](../includes/banner.md)]

Cet article fournit une vue d'ensemble de la fonctionnalité disponible dans le module Approvisionnements.
...
-   Via le traitement des contrats d'achat, où les commandes fournisseur sont créées en tant que commandes lancées à partir de contrats. Cela est utilisé couramment lorsque des contrats d'achat servent à représenter des commandes globales.'
...
Les commandes fournisseur facturées enregistreront le passif dans le compte fournisseur dans la comptabilité fournisseur, à *p*artir de laquelle le *paiement du fournisseur* peut être traité.
