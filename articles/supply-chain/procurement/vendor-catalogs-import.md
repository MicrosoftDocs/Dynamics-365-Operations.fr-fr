...
5. Sélectionnez **Approvisionnements** \> **Catalogues** \> **Catalogues fournisseur** pour créer un catalogue fournisseur. Les fichiers DMC envoyés par le fournisseur sont regroupés dans ce catalogue.
