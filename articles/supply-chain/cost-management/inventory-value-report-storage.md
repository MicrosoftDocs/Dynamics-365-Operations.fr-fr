...
## <a name="turn-on-the-inventory-value-report-storage-feature"></a>Activer la fonctionnalité de stockage de rapport de valeur de stock

Le rapport **Valeur du stock** standard est activé par défaut. Toutefois, si vous souhaitez que générer le rapport **Stockage de rapport de valeur de stock** plus avancé, vous devez activer la fonctionnalité dans votre système. Les administrateurs peuvent utiliser les paramètres de [gestion des fonctionnalités](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) pour vérifier le statut de la fonctionnalité et l’activer si nécessaire. Dans l’espace de travail **Gestion des fonctionnalités**, la fonctionnalité est répertoriée comme suit :

- **Module :** *Cost Management*
- **Nom de la fonctionnalité :** *Stockage de rapport de valeur de stock*
