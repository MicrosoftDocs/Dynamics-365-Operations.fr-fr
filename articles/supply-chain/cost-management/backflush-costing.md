...
description: Cet article présente le concept de comptabilité à rebours utilisé pour la production au plus juste.
author: JennySong-SH
ms.date: 04/10/2017
ms.topic: article
ms.prod: ''
...
Le modèle de travaux en cours de la production au plus juste vous permet d’utiliser le statut d’unité de manutention de kanban pour gérer les matières, les produits semi-finis, et les produits finis qui font partie des travaux en cours.
