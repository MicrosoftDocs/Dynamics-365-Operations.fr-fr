---
title: Stockage Stock - Balance âgée
description: Cet article décrit les fonctionnalités qui vous permettent d’exécuter un état de la balance âgée et de mettre le résultat à disposition sous la forme d’un formulaire et d’un graphique.
author: JennySong-SH
ms.date: 11/11/2019
ms.topic: article
ms.prod: ''
