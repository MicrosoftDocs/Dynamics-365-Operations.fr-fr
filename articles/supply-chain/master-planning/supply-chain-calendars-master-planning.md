...
description: Cet article offre un aperçu des calendriers de chaîne d’approvisionnement et de la manière dont ils ont un impact sur la planification.
author: t-benebo
ms.date: 08/19/2020
ms.topic: article
ms.prod: ''
...
1. Calendrier d’entrepôt pour l’entrepôt de réception
...
1. Groupe de couverture de l’article sur la page **Couverture de l’article**
1. Groupe de couverture de l’article sur la page **Détails des produits lancés**
1. Groupe de couverture de l’article par défaut dans **Paramètres de planification**
...
1. Le calendrier de groupe de couverture (voir la commande de secours pour ce calendrier ci-dessus) Si un calendrier d’entrepôt est défini, la date d’expédition reste une date ouverte dans le calendrier. Si aucun calendrier d’entrepôt n’est défini, le calendrier de groupe de couverture est nécessaire. 
...
1. Calendrier pour un groupe de couverture 
1. Calendrier d’entrepôt « d’arrivée » Si un calendrier de couverture est défini, la date de réception reste une date ouverte dans le calendrier. Si aucun calendrier de groupe de couverture n’est défini, le calendrier d’entrepôt est nécessaire. 
