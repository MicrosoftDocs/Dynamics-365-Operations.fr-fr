...
description: Cet article explique comment exclure des produits en fonction de leur état de cycle de vie lorsque la fonctionnalité d’optimisation de planification est utilisée.
author: t-benebo
ms.date: 11/13/2020
ms.topic: article
ms.prod: ''
