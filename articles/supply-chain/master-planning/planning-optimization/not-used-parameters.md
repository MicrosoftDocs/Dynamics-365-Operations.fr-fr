...
- Onglet **Mise à jour standard** :

  - **Mettre à jour le marquage** – Support *Confirmation* en attente.
  - **Arrêter la confirmation si une erreur se produit** – Support *Confirmation*.
  - **Regrouper par fournisseur** – Support *Confirmation* en attente.
  - **Regrouper par groupe d’acheteurs** – Support *Confirmation* en attente.
  - **Regrouper par contrat d’achat** – Support *Confirmation* en attente.
  - **Regrouper par période** – Support *Confirmation* en attente.
  - **Rechercher un contrat d’achat** – Support *Confirmation* en attente.
  - **Regrouper par priorité de planification** – Support *Confirmation* en attente.
  - **Regrouper par période** – Support *Confirmation* en attente.
