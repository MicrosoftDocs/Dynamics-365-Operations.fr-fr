...
description: Cet article fournit des informations sur l’affichage, la gestion et l’approbation des ordres prévisionnels.
author: t-benebo
ms.date: 04/07/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9740956"
---
# <a name="view-manage-and-approve-planned-orders"></a>Afficher, gérer et approuver les ordres prévisionnels

[!include [banner](../../includes/banner.md)]

Cet article fournit des informations sur l’affichage, la gestion et l’approbation des ordres prévisionnels.
