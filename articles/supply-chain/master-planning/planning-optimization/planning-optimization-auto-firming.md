...
> 
> Les commandes dérivées confirmées (commandes d’achat de sous-traitance) afficheront un statut *En cours de révision* lorsque le suivi des modifications de dossier est activé.
