...
Ces courtes vidéos vous permettent de découvrir les nouvelles fonctions incluses dans Microsoft Dynamics 365 for Finance and Operations, version 8.0 (avril 2018).

- [Synchroniser un ordre d'exécution entre Field Service et Finance and Operations](https://youtu.be/hAB4TDVMjxU)

Ces courtes vidéos vous permettent de découvrir les nouvelles fonctions incluses dans Microsoft Dynamics 365 for Finance and Operations, édition Enterprise 7.3 (décembre 2017).
...
-  [Optimisez votre système de gestion des entrepôts](https://www.youtube.com/watch?v=--_didmZKHo&t=10s)
