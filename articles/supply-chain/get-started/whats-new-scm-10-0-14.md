...
ms.locfileid: "6739081"
---
# <a name="whats-new-or-changed-in-dynamics-365-supply-chain-management-10014-november-2020"></a>Nouveautés ou modifications dans Dynamics 365 Supply Chain Management 10.0.14 (novembre 2020)

[!include [banner](../includes/banner.md)]

Cette rubrique répertorie les fonctionnalités qui sont nouvelles ou ont été modifiées dans Microsoft Dynamics 365 Supply Chain Management, version 10.0.14. Cette version a un numéro de build de 10.0.605 et est disponible comme suit :

- **Version préliminaire :** Septembre 2020
- **Disponibilité générale (mise à jour automatique) :** Octobre 2020
- **Mise à jour automatique :** Novembre 2020

## <a name="features-included-in-this-release"></a>Fonctionnalités incluses dans cette version

Cette version inclut une plateforme mise à jour et des améliorations générales, mais n’inclut aucune nouvelle fonctionnalité spécifique à Supply Chain Management. Pour plus d’informations sur les fonctionnalités à venir, consultez le site [Programmes de lancement](/dynamics365/release-plans/).
...
Microsoft Dynamics 365 Supply Chain Management 10.0.14 inclut les mises à jour de plateforme. Pour en savoir plus, consultez [Mises à jour de la plateforme pour la version 10.0.14 des applications Finance and Operations (octobre 2020)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-14.md).

### <a name="bug-fixes"></a>Correctifs de bogue

Pour plus d’informations sur les correctifs de bogues inclus dans chacune des mises à jour qui font partie de 10.0.14, connectez-vous à Lifecycle Services (LCS) et consultez l’[Article de la base de connaissances](https://fix.lcs.dynamics.com/Issue/Details?bugId=488609&dbType=3&qc=8251e8e1d5e2386de850599926c1adc3fec8e2ba25308036d22cdfe0a1c28fc7).
