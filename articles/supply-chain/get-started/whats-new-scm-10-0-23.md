...
| Ventes et marketing | Nettoyer l’historique des mises à jour des commandes clients | Cette fonctionnalité vous permet de nettoyer les enregistrements historiques temporaires liés aux mises à jour des commandes client. Il ajoute un nouveau bouton appelé **Nettoyer l'historique des mises à jour des ventes** au volet Actions des pages de détail et de liste des commandes client. |
