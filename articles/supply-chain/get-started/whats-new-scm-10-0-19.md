...
---
# <a name="preview-of-dynamics-365-supply-chain-management-10019-july-2021"></a>Version préliminaire de Dynamics 365 Supply Chain Management 10.0.19 (juillet 2021)
...
|---|---|---|
| Inventaire et logistique | [Optimisation de l’exportation de l’entité de données des contacts](/dynamics365-release-plan/2021wave1/finance-operations/dynamics365-supply-chain-management/contact-person-data-entity-export-optimization)  | *Non disponible* |
...
| Gestion des entrepôts | [Résoudre les problèmes liés aux hiérarchies des lots d’entrepôt et des réservations en série](../warehousing/troubleshoot-warehouse-batch-and-serial-reservation-hierarchies.md) |
...
Microsoft Dynamics 365 Supply Chain Management 10.0.19 inclut les mises à jour de plateforme. Pour en savoir plus, consultez [Mises à jour de la plateforme pour la version 10.0.19 des applications Finance and Operations (juillet 2021)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-19.md).
