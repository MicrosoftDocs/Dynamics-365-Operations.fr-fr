...
Pour plus d’informations sur chacun de ces éléments et sur la manière dont leurs valeurs sont trouvées, consultez les sections restantes de cet article.
...
1. Effectuez l’une des opérations suivantes :
    - Accédez à **Gestion du transprt \> Planification \> Expéditions \> Toutes les expéditions** et sélectionnez l’expédition pour laquelle vous souhaitez imprimer le document.
