...
1. Sélectionnez **Nouveau** pour créer un mode.
1. Entrez un ID unique et un nom descriptif pour le mode.
1. Fermez la page.

## <a name="create-a-transportation-method"></a>Créer une méthode de transport

Pour créer une méthode de transport, procédez comme suit :

1. Accédez à **Gestion du transport \> Configurer \> Transporteurs \> Méthodes de transport**.
