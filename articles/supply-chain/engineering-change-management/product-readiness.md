...
### <a name="enable-readiness-checks-on-standard-products"></a>Activer les vérifications de disponibilité des produits standard

Pour permettre à votre système d’effectuer des vérifications de la disponibilité des produits standard, procédez comme suit.

- Activez la gestion des modifications d’ingénierie dans votre système, comme décrit dans [Gestion des modifications d’ingénierie](product-engineering-overview.md).
- Utilisez la [Gestion des fonctionnalités](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) pour activer la fonctionnalité nommée *Vérifications de la disponibilité du produit*.
