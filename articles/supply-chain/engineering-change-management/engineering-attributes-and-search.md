...
description: Cet article explique comment utiliser les attributs d’ingénierie pour spécifier toutes les caractéristiques non standard, afin de garantir que toutes les données de base produit peuvent être enregistrées dans le système. Il explique également comment vous pouvez utiliser la recherche d’attributs d’ingénierie pour trouver facilement des produits en fonction de ces caractéristiques enregistrées.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
...
#### <a name="turn-engineering-attribute-inheritance-on-or-off"></a>Activer ou désactiver l’héritage des attributs

Cette fonctionnalité nécessite que les deux fonctionnalités *Gestion des modifications techniques* et *Amélioration de l’héritage des attributs pour la gestion des changements d’ingénierie* soient activées pour votre système. Pour plus d’informations sur l’activation ou la désactivation de ces fonctionnalités, reportez-vous à [Présentation de la gestion des modifications techniques](product-engineering-overview.md).
