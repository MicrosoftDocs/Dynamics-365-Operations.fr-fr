...
description: Cet article fournit des informations sur le concept des versions d’ingénierie. Les versions d’ingénierie garantissent que les différents états d’un produit et de ses données sont tenus à jour et clairs, et qu’ils peuvent être visualisés dans le système.
author: t-benebo
ms.date: 04/07/2022
ms.topic: article
ms.prod: ''
