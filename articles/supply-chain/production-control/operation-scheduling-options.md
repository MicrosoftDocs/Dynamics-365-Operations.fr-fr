...
description: Cet article décrit les options de l’ordonnancement. Vous pouvez utiliser l’ordonnancement pour fournir une estimation globale du processus de production dans le temps.
...
ms.locfileid: "8907259"
---
# <a name="operations-scheduling-options"></a>Options d’ordonnancement des opérations

[!include [banner](../includes/banner.md)]

Cet article décrit les options de l’ordonnancement. Vous pouvez utiliser l’ordonnancement pour fournir une estimation globale du processus de production dans le temps.
