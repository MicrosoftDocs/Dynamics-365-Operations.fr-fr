...
description: Cet article décrit comment concevoir le contenu de l’interface utilisateur pour chaque configuration.
...
1. Définissez les paramètres suivants dans l’en-tête de la page :
    ...
    - **Vue principale** –  Choisissez dans les listes prédéfinies (*Tâches actives*, *Toutes les tâches*, *Mest tâches* et *Ma machine*).
