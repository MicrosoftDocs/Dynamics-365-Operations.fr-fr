...
description: Cet article décrit un workflow qui active l’enregistrement de la consommation de matières premières dans la production à l’aide d’un appareil portable.
...
Cet article décrit un workflow qui active l’enregistrement de la consommation de matières premières dans la production à l’aide d’un appareil portable.
