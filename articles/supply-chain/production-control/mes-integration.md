...
description: Cet article explique comment vous pouvez intégrer Microsoft Dynamics 365 Supply Chain Management à un système d’exécution de la production tiers.
...
1. Utilisez l'espace de travail [Gestion des fonctionnalités](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) pour activer *la fonctionnalité Intégration du système d’exécution de la fabrication*. (Depuis la version 10.0.29 de Supply Chain Management, cette fonctionnalité est activée par défaut.)
