...
Dans l’illustration suivante, (a) est la nomenclature du produit H et des pièces F et G, et (b) est la feuille de gamme des produits H et de la pièce F.

![Exemple de structure de nomenclature à deux niveaux.](media/product-H-part-F.png)
...
![La nomenclature d'ingénierie pour le produit H.](media/product-H-part-B.png)
...
![Type de ligne fantôme utilisé dans les structures de nomenclature à plusieurs niveaux.](media/product-G-route-sheet-G.png)
...
![Exemple de réseau de routage utilisé dans une nomenclature à plusieurs niveaux.](media/product-G-part-F.png)
...
![La nomenclature pour le produit G et la pièce F, et la feuille de route pour le produit G et la pièce F.](media/product-G-part-F-with-route-sheet.png)
