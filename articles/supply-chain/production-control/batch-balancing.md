...
Vous pouvez rechercher et modifier la valeur réelle de la substance active pour un lot sur la page **Attributs de lot de stock**. 

-  Sélectionnez **Gestion des stocks** \> **Recherches et états** \> **Suivi des dimensions** \> **Lots** \> **Attributs de lot de stock**.
...
### <a name="compensating"></a>Compensation
...
2.  Le résultat est multiplié par le facteur de compensation :

>   4,29 × 1,10 = –4,72

3.  – 4,72 est ensuite soustrait à la quantité de compensation estimée pour déterminer la quantité de compensation équilibrée :
...
2.  Confirmer et lancer la formule
...
Il existe une exception à la règle selon laquelle les lots de commandes peuvent être appliqué à l'équilibrage du lot si la formule contient au moins une ligne de formule dont le type de substance est **Active**.
