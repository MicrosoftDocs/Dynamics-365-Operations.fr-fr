...
Cette rubrique vous aide à créer une procédure de sous-traitance de la fabrication dans Microsoft Dynamics 365 for Finance and Operations. La première partie de cette rubrique décrit le paramétrage des données. La deuxième partie vous explique les étapes de la procédure.
