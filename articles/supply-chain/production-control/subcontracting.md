...
description: Cet article vous aidera à établir une présentation de la sous-traitance en production dans Dynamics 365 Supply Chain Management.
...
4. Une fois le numéro d’article sélectionné, les champs de la dimension de stock s’affichent. Dans le champ **Couleur**, sélectionnez **Chrome**.
    ...
    ![Boîte de message.](./media/subcontract13_message-box.png)
