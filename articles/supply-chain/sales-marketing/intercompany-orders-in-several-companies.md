...
description: Cette rubrique explique comment créer des commandes fournisseur intersociétés ou des commandes client dans plusieurs sociétés
author: Henrikan
ms.date: 09/01/2021
ms.topic: article
