...
1. Sélectionnez **Produits et approvisionnement \> Autres modes de livraison**.
1. Sélectionnez **Détails de ligne \> Livraison \> Autres modes de livraison.**
...
<td><ul>
<li>Les alternatives de livraison pour les lignes de vente ne sont pas prises en charge. Cette option arrête le contrôle des dates de livraison.</li>
</ul></td>
</tr>
<tr class="odd">
...
Cette section fournit des informations sur les alternatives de livraison disponibles sous chaque organisateur de la page **Autres modes de livraison**.

### <a name="the-product-fasttab"></a>Organisateur Produits

Cet organisateur affiche une synthèse du produit et les détails de la ligne de vente actuelle.

### <a name="the-delivery-alternatives-fasttab"></a>Organisateur Autres modes de livraison
