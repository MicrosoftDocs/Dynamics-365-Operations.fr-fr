...
---
# <a name="synchronize-inventory-adjustments-from-field-service-to-supply-chain-management"></a>Synchroniser les ajustements de stock depuis Field Service vers Supply Chain Management
