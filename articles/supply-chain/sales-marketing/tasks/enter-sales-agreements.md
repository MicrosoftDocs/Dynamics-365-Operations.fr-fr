...
description: Cet article explique comment créer un contrat de vente qui incite l’un de vos clients à acheter un produit pour un montant convenu sur une période définie en échange de remises spéciales.
author: Henrikan
ms.date: 08/08/2019
