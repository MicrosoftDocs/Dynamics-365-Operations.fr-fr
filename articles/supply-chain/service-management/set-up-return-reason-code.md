...
3.  Dans le champ **Code motif de retour**, entrez un texte pour identifier ce code.

4.  Dans le champ **Description**, entrez un texte pour décrire le code motif de retour.

5.  Utilisez la liste déroulante **Groupe de codes motif de retour** pour ajouter le code à un groupe de codes motif retour.

## <a name="see-also"></a>Voir également :

[Groupes de codes motif retour (écran)](https://technet.microsoft.com/en-us/library/hh209604\(v=ax.60\))

[Codes motif de retour (écran)](https://technet.microsoft.com/en-us/library/hh227372\(v=ax.60\))
