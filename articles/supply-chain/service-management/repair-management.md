...
- **Gestion des services** \> **Paramétrage** \> **Réparation** \> **Conditions**.
- **Gestion des services** \> **Paramétrage** \> **Réparation** \> **Zones de symptôme**.
-  **Gestion des services** \> **Paramétrage** \> **Réparation** \> **Zones de diagnostic**.
- **Gestion des services** \> **Paramétrage** \> **Réparation** \> **Résolutions**.
- **Gestion des services** \> **Paramétrage** \> **Réparation** \> **Stades de réparation**.
...
3.  Cliquez sur **Réparation** \> **Lignes de réparation** pour ouvrir le formulaire **Lignes de réparation**.

4.  Sélectionnez **Nouveau** pour créer une ligne.
...
6.  Sélectionnez les symptômes, le diagnostic et les valeurs d’exécution prédéfinis appropriés sur la ligne de réparation puis, au besoin, puis cliquez sur l’onglet **Remarque** pour créer une remarque sur la ligne de réparation.

7.  Sélectionnez **Enregistrer** pour enregistrer la nouvelle ligne de réparation. Le champ **Date et heure de création** de l’onglet **Général** de l’écran **Lignes de réparation** est mis à jour avec l’heure de l’enregistrement.
