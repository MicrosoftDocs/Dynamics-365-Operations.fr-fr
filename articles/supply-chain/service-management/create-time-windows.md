...
5. Dans le champ **Méthode**, sélectionnez le mode à créer automatiquement. Si la méthode est du type **Manuel**, spécifiez le nombre de jours avant ou après la date calculée auquel la ligne de commande de service peut être déplacée.
