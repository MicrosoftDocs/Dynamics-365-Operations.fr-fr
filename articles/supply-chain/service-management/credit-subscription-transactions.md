...
description: Cet article explique comment créditer des transactions de frais d’abonnement.
author: sorenva
ms.date: 05/01/2018
ms.topic: article
ms.prod: ''
...
1.  Cliquez sur **Gestion des services** \> **Services récurrents** \> **Tous les abonnements aux services**.
