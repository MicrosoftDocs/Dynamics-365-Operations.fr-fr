...
---
# <a name="share-content-with-other-contributors-in-dynamics-365-for-talent-onboard"></a>Partager du contenu avec d'autres contributeurs dans Dynamics 365 for Talent : Onboard

[!include [banner](includes/banner.md)]

Microsoft Dynamics 365 for Talent : Onboard vous permet de partager des guides et des modèles d'intégration avec d'autres contributeurs afin qu'ils puissent réviser les documents et apporter des modifications.
