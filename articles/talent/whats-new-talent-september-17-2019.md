...
ms.locfileid: "2002571"
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-september-17-2019"></a>Nouveautés ou modifications dans Dynamics 365 for Talent (17 septembre 2019)
...
Les modifications décrites dans cette section s'appliquent au numéro de version 8.1.2492. Les numéros entre parenthèses dans certains en-têtes se rapportent aux numéros de support dans Microsoft Dynamics Lifecycle Services (LCS).
...
### <a name="human-resources-staff-cant-see-performance-review-details-once-assigned-to-them-by-workflow-370308"></a>Le module Ressources humaines ne peut pas voir les détails d'examen des performances une fois qu'ils leur sont attribués par le workflow (370308)

Avec la mise à jour de cette semaine, les professionnels des RH seront en mesure de voir les détails de l'examen des performances qui leur ont été attribués via le traitement du workflow. Pour afficher les révisions, accédez à **Libre-service employé > Éléments de travail qui me sont affectés**.

### <a name="job-family-field-missing-in-the-manage-changes-page-for-job-details-346031"></a>Champ Famille de tâches manquant sur la page Gérer les modifications pour les détails de tâche (346031)

Dans cette version, le champ Famille de tâches a été ajouté à la page **Gestion des modifications** pour les détails de tâche.
