...
> [!NOTE] 
> - Les fonctionnalités de recommandation intelligente sont disponibles uniquement avec le Composant additionnel de recrutement complet.
> - Pour activer les fonctionnalités de recommandation de candidats et des missions, un administrateur doit activer les options d'aperçu pour elles. Dans le centre d'administration, sous l'onglet **Gestion des fonctionnalités**, assurez-vous que l'option **Fonctionnalités d'aperçu** est définie sur **Activé**. Vérifiez ensuite que les options **Recommandation de candidat** et **Recommandation de mission** sont individuellement définies sur **Activé**.
