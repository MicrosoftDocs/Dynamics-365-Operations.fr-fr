...
### <a name="issue-attract-and-onboard-create-inactive-workers-in-core-hr-380517"></a>Problème : Attract et Onboard créent des collaborateurs inactifs dans Core HR (380517)
...
### <a name="issue-the-workflow-fails-when-the-manager-is-signed-in-to-another-company-while-terminating-an-employee-346852"></a>Problème : Le workflow échoue lorsque le responsable est connecté à une autre société tout en mettant un terme au contrat d'un collaborateur (346852)

Le workflow n'échoue plus en fonction de l'entité juridique à laquelle le responsable est connecté.

### <a name="issue-missing-information-on-hcmonboardingworkerchecklisttaskentity-349591"></a>Problème : Informations manquantes dans HcmOnboardingWorkerChecklistTaskEntity (349591)
...
### <a name="issue-entities-arent-listed-in-alphabetical-order-in-common-data-service-administration-377414"></a>Problème : Les entités ne sont pas répertoriées par ordre alphabétique dans l'administration de Common Data Service (377414)

Les entités sont désormais répertoriées par ordre alphabétique sur la page **Administration de CDS**.

### <a name="issue-changing-the-employment-type-with-a-future-date-doesnt-allow-a-position-assignment-339958"></a>Problème : La modification du type d'emploi avec une date future n'autorise pas une affectation de poste (339958)
...
### <a name="issue-updating-the-common-data-service-leave-bank-transaction-entity-creates-a-new-record-in-talent-352938"></a>Problème : La mise à jour de l'entité Transaction bancaire de congé Common Data Service crée un enregistrement dans Talent (352938)
...
### <a name="issue-the-title-of-attachments-for-feedback-items-shows-the-feedback-description-343765"></a>Problème : Le titre des pièces jointes pour les éléments de rétroaction affiche la description de la rétroaction (343765)

La description de la rétroaction n'apparaît plus dans le titre de la pièce jointe.

### <a name="issue-compensation-workflow-comments-field-shows-incorrect-content-339297"></a>Problème : Le champ Commentaires sur le workflow de rémunération affiche un contenu incorrect (339297)

Cette modification affiche le contenu du champ **%HcmActionState.HcmWorkerActionComment.Comments%**.

### <a name="issue-workcalendarentity-and-workcalendardayentity-arent-exposed-through-odata-376329"></a>Problème : WorkCalendarEntity et WorkCalendarDayEntity ne sont pas exposés via OData (376329)

Dans cette version, **WorkCalendarEntity** et **WorkCalendarDayEntity** sont désormais disponibles via OData (Open Data Protocol).

### <a name="issue-hcmworkerentity-is-slow-when-odata-is-used-375221"></a>Problème : HCMWorkerEntity est lent lorsque OData est utilisé (375221)
...
### <a name="issue-manager-performance-journal-entry-shows-an-error-after-deleting-a-performance-journal-and-creating-a-new-one-336061"></a>Problème : L'entrée du journal des performances du responsable affiche une erreur après avoir supprimé un journal de performances et en avoir créé un (336061)
