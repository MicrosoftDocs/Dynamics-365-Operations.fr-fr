...
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-july-9-2019"></a>Nouveautés ou modifications dans Dynamics 365 for Talent (9 juillet 2019)
...
### <a name="platform-update-28"></a>Update 28 de la plateforme

Pour des informations complémentaires sur Platform Update 28, voir [Fonctionnalités en version préliminaire dans Dynamics 365 for Finance and Operations Platform Update 28 (juillet 2019)](https://docs.microsoft.com/en-us/dynamics365/unified-operations/fin-and-ops/get-started/whats-new-platform-update-28).
