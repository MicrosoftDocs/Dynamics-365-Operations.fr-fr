...
Plusieurs facteurs déterminent le droit des collaborateurs aux différents types d'avantages qu'un employeur offre. Lorsque vous créez un avantage dans Dynamics 365 Talent, vous pouvez définir le type de droit qui s'applique à cet avantage. 
