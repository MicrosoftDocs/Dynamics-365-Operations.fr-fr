...
---
# <a name="troubleshoot-integration-with-linkedin-and-attract"></a>Résoudre les problèmes d'intégration avec LinkedIn et Attract
...
## <a name="you-cant-sign-in-to-linkedin-from-attract"></a>Vous ne pouvez pas vous connecter à LinkedIn à partir d'Attract

Si vous rencontrez des problèmes lors de la connexion à LinkedIn à partir d'Attract, procédez comme suit :

1. Vérifiez que les informations d'identification LinkedIn entrées dans Attract sont valides et correctes.
2. Si les informations d'identification sont valides et correctes, contactez le [support LinkedIn](https://www.linkedin.com/help/linkedin).
3. Si le problème persiste, contactez le [Support Microsoft](./talent-support.md).

## <a name="job-posts-from-attract-dont-appear-on-linkedin"></a>Les offres publiées à partir d'Attract n'apparaissent pas dans LinkedIn
