...
## <a name="leave-and-absence--accrue-time-based-on-hours-worked"></a>Congé et absence – Accorder des congés sur la base des heures travaillées
...
-   Dans Platform update 18 pour Finance and Operations, le client Web Talent aligne maintenant ses visuels sur Microsoft Fluent Design.
    ...
    -   Modifications de l'affichage des champs en mode lecture.
