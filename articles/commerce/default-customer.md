...
description: Cet article décrit comment créer un client par défaut à utiliser lors de la création d’un canal dans Microsoft Dynamics 365 Commerce.
author: samjarawan
ms.date: 01/27/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8894527"
---
# <a name="create-a-default-customer"></a>Créer un client par défaut

[!include [banner](includes/banner.md)]

Cet article décrit comment créer un client par défaut à utiliser lors de la création d’un canal dans Microsoft Dynamics 365 Commerce.
