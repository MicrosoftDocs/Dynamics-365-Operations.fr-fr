---
title: Ajouter un code QR ou un code-barres aux courriers électroniques de transaction et de réception
description: Cet article explique comment insérer des codes QR et des codes barres qui représentent les ID de commande dans les e-mails transactionnels et de ticket de caisse dans Microsoft Dynamics 365 Commerce.
...
ms.locfileid: "9272042"
---
# <a name="add-a-qr-code-or-bar-code-to-transactional-and-receipt-emails"></a>Ajouter un code QR ou un code-barres aux courriers électroniques de transaction et de réception

[!include [banner](includes/banner.md)]

Cet article explique comment insérer des codes QR et des codes barres qui représentent les ID de commande dans les e-mails transactionnels et de ticket de caisse dans Microsoft Dynamics 365 Commerce.
