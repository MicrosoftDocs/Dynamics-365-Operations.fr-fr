...
description: Cet article couvre les modules de partage social et décrit comment les ajouter aux pages du site dans Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8844644"
---
# <a name="social-share-module"></a>Module Partage social

[!include [banner](includes/banner.md)]

Cet article couvre les modules de partage social et décrit comment les ajouter aux pages du site dans Microsoft Dynamics 365 Commerce.
...
1. Dans la boîte de dialogue **Sélectionner des modules**, sélectionnez le module **Partage social**, puis sélectionnez **OK**.
1. Dans l’emplacement **Partage social**, sélectionnez le bouton (**...**), puis sélectionnez **Ajouter un module**.
1. Dans la boîte de dialogue **Sélectionner des modules**, sélectionnez le module **SocialShare**, puis sélectionnez **OK**.
...
1. Dans la boîte de dialogue **Sélectionner les modules**, sélectionnez le module **SocialShareItem**, puis sélectionnez **OK**.
