...
Pour plus d’informations sur l’utilisation des commandes en attente, voir [Blocage de commandes](/dynamics365/unified-operations/retail/work-with-order-holds).
