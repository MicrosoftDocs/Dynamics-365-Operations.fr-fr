...
description: Cet article couvre les modules de bloc de contenu et décrit comment les ajouter aux pages du site dans Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
1. Dans la boîte de dialogue **Sélectionner des modules**, sélectionnez le module de bannière, puis cliquez sur **OK**.
