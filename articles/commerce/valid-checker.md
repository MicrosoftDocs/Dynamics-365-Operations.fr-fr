...
Cette rubrique décrit la fonctionnalité de validation des transactions en magasin dans Microsoft Dynamics 365 Commerce. Le processus de validation identifie et marque les transactions qui provoqueront des erreurs de comptabilisation, avant qu’elles ne soient récupérées par le processus de validation des relevés.
