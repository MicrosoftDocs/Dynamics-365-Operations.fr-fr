...
Les types de document suivants sont pris en charge :
- 7Z
- AVI
- CS
- CSS
...
Pour télécharger un fichier dans le générateur de site Commerce, procédez comme suit.
...
1. Dans l'Explorateur de fichiers, sélectionnez un ou plusieurs fichiers, puis sélectionnez **Ouvrir**.
1. Dans la boîte de dialogue **Télécharger des éléments multimédia**, entrez le titre, la description et les métadonnées des mots clés selon vos besoins.
1. Pour publier les fichiers immédiatement après le téléchargement, sélectionnez la case à cocher **Publier les éléments multimédia après le téléchargement**.
1. Cliquez sur **OK**.
