...
- Pour voir comment des fragments peuvent rendre la gestion de contenu plus efficace et plus flexible, consultez [Utiliser des fragments](work-with-fragments.md).
- Pour contribuer à garantir une expérience de création de marque réussie pour les auteurs de contenu Web, consultez [Vue d'ensemble des modèles et dispositions](templates-layouts-overview.md) et [Utiliser des modèles](work-with-templates.md).
- Pour réorganiser les sections sur une page du site, voir [Utiliser des dispositions](work-with-layouts.md).
- Pour modifier les polices, les couleurs, et l'aspect général des pages du site, voir [Sélectionner un thème pour le site](select-site-theme.md) ou [Utilisation de fichiers de remplacement CSS](css-override-files.md).
- Pour réorganiser ou ajouter de nouvelles options de navigation, voir [Personnaliser la navigation dans le site](customize-site-navigation.md).
- Pour savoir comment mettre en scène, prévisualiser et publier un large éventail de modifications de contenu web simultanées, consultez [Utiliser des groupes de publication](publish-groups.md).
