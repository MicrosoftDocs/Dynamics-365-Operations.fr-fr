...
---
# <a name="create-a-retail-functionality-profile"></a>Créer un profil de fonctionnalité de la vente au détail


[!include [banner](includes/banner.md)]

Cette rubrique décrit comment créer un profil de fonctionnalité de la vente au détail dans Microsoft Dynamics 365 Commerce.

## <a name="overview"></a>Vue d'ensemble

Le profil de fonctionnalité de la vente au détail fournit divers paramètres utilisés pour les canaux en ligne. Chaque canal de la vente au détail doit préciser un profil de fonctionnalité de la vente au détail.

## <a name="create-a-retail-functionality-profile"></a>Créer un profil de fonctionnalité de la vente au détail

Pour créer un profil de fonctionnalité de la vente au détail, procédez comme suit :
...
L'image suivante présente un exemple de profil de fonctionnalité de la vente au détail.
