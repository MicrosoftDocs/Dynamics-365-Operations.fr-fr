...
description: Cet article couvre les modules d’options de livraison et explique comment les configurer dans Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 02/24/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8894556"
---
# <a name="delivery-options-module"></a>Module Options de livraison

[!include [banner](includes/banner.md)]

Cet article couvre les modules d’options de livraison et explique comment les configurer dans Microsoft Dynamics 365 Commerce.
