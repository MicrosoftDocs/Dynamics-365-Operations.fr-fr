...
description: Cet article fournit des informations sur les mises en page de l’écran pour les expériences pour PDV Dynamics 365 Commerce.
author: boycezhu
ms.date: 09/22/2020
ms.topic: article
ms.prod: ''
...
L’interface utilisateur du point de vente (PDV) Microsoft Dynamics 365 Commerce peut être configurée avec une combinaison de profils visuels et de mises en page de l’écran, qui sont affectés aux magasins, aux registres et/ou aux utilisateurs. Cet article fournit des informations générales sur ces options de configuration.
