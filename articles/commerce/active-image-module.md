...
description: Cette rubrique couvre les modules Image active et décrit comment les ajouter aux pages du site dans Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 07/08/2021
ms.topic: article
ms.prod: ''
...
1. Dans la boîte de dialogue **Ajouter un module**, sélectionnez le module **Image active**, puis sélectionnez **OK**.
