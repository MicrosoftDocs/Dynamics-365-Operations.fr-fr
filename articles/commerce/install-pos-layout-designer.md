...
1. Dans Commerce, utilisez le menu situé dans le volet supérieur gauche pour accéder à **Retail et Commerce** &gt; **Paramétrage du canal** &gt; **Paramétrage POS** &gt; **PDV** &gt; **Mises en page de l'écran**.
...
- Lorsque vous cliquez sur **Concepteur**, l'invite de téléchargement (ou d'exécution) du programme d'installation ne s'affiche pas, ou vos paramètres de sécurité actuels ne permettent pas de télécharger le fichier. 
    ...
    **Solutions :**
    ...
    - Dans Internet Explorer, ajoutez l'URL Commerce à vos sites de confiance. Cliquez sur **Paramètres** &gt; **Options** &gt; **Sécurité** &gt; **Sites de confiance** &gt; **Sites** &gt; **Ajouter**.
