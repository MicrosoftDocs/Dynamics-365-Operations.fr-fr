...
description: Cette rubrique fournit des lignes directrices pour le déploiement de l’exemple d’intégration fiscale pour la République tchèque à partir du Kit de développement logiciel de vente au détail (SDK) Microsoft Dynamics 365 Commerce.
