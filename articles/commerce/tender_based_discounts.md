...
description: Cet article fournit une vue d’ensemble de la fonctionnalité qui permet aux détaillants de configurer des remises pour les modes de paiement spécifiques.
author: bebeale
ms.date: 10/30/2019
ms.topic: article
ms.prod: ''
