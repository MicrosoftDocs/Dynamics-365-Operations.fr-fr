...
description: Cette rubrique fournit des conseils de résolution de problème sur la façon de masquer l'affinement des évaluations sur les pages de résultats de recherche et de catégorie lorsque la solution d'évaluations et d'avis Microsoft Dynamics 365 Commerce n'est pas activée pour un site de commerce électronique.
...
Cette rubrique fournit des conseils de résolution de problème sur la façon de masquer l'affinement des évaluations sur les pages de résultats de recherche et de catégorie lorsque la solution d'évaluations et d'avis Microsoft Dynamics 365 Commerce n'est pas activée pour un site de commerce électronique.
