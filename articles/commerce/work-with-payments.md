...
description: Cet article décrit les différentes méthodes de paiement que vous pouvez utiliser dans un centre d’appels de Dynamics 365 Commerce.
author: josaw1
ms.date: 03/28/2018
ms.topic: article
ms.prod: ''
