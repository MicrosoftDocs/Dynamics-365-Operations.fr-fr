...
> [!TIP]
> Si votre page est visible dans le contrôleur de page, vous pouvez la sélectionner et l'archiver avant de l'ouvrir dans l'éditeur de page. De cette manière, vous pouvez vérifier les pages simultanément.

Une fois la page ouverte dans l'éditeur de page, vous devez vous assurer qu'elle extraite pour vous. La barre de commande dans l'outil de création est dynamique, contextuelle, et sensible à l'état. Par conséquent, elle n'affiche que les actions que vous pouvez actuellement exécuter sur la page. Par exemple, si la page n'est pas extraite pour vous, les boutons **Enregistrer** et **Archiver** n'apparaissent pas dans la barre de commande. L'état de la page est également affiché à droite de la fenêtre.

Si la page n'est pas déjà extraite pour vous, sélectionnez **Extraire** dans la barre de commande. La barre de commande change pour refléter le nouvel état de la page. Vous recevez également une notification indiquant que la page a été extraite pour vous.
...
Après avoir terminé d'apporter vos modifications et prévisualisé leurs effets, vous devez archiver la page en sélectionnant **Archiver** dans la barre de commande. 
...
1. Dans la barre de commande, sélectionnez **Extraire**.
