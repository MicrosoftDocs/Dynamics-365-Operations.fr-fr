...
description: Cet article explique comment personnaliser les résultats de recommandation de produit basés sur l’intelligence artificielle et le Machine Learning (IA et ML) votre entreprise.
author: bebeale
ms.date: 05/26/2020
ms.topic: article
ms.prod: ''
...
Cet article explique comment ajuster les résultats de recommandation de produit basés sur l’intelligence artificielle et le Machine Learning (IA et ML) votre entreprise. 
