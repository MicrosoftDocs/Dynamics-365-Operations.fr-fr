...
| Instance de la page | <p>**Définition :** les instances de page définissent le contenu localisé final et spécifique à une seule page. Ce contenu est dérivé des valeurs des propriétés du module.</p><p>**Où il est sélectionné :** les pages sont sélectionnées lorsque des URL sont affectés.</p><p>**Où il est modifié :** les pages sont modifiées dans l'éditeur de page. Aucun code n'est requis pour créer ou modifier.</p> |
