...
1. Lorsque vous avez terminé de saisir ces informations, sélectionnez **OK** pour enregistrer vos modifications. Votre nouveau client Azure AD B2C devrait maintenant apparaître dans la liste sous **Gérer les applications B2C**.
