...
Dynamics 365 Commerce utilise le service cognitif de Microsoft Azure pour modérer automatiquement du texte d'évaluation en effaçant les mots grossiers. En outre, les modérateurs peuvent utiliser l'outil de modération des classements et des évaluations pour les tâches manuelles suivantes :
...
Pour répondre à une évaluation, procédez comme suit.
...
Pour retirer une évaluation, procédez comme suit.

1. Accédez à **Accueil \> Évaluations \> Modération**.
1. Recherchez et sélectionnez l'évaluation qui doit être retirée.
1. Dans le volet de propriétés de droite, sélectionnez un motif de retrait, puis sélectionnez **Retirer**.
...
Pour rechercher et supprimer des données client, procédez comme suit.

1. Accédez à **Accueil \> Évaluations \> Supprimer**.
1. Dans le champ **Rechercher des utilisateurs par adresse e-mail**, entrez l'adresse e-mail du client, puis sélectionnez **Rechercher**.
...
Pour afficher les tendances des classements et des évaluations, procédez comme suit.
