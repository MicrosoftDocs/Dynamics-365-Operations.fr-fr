...
| Contenu | Description | Format | Longueur |
|---------|-------------|--------|--------|
| [Configurer et utiliser le commerce électronique dans Dynamics 365 Commerce](/training/paths/configure-work-e-commerce/)              | Les canaux en ligne et le site de commerce électronique de Dynamics 365 Commerce permettent aux détaillants de créer une présence en ligne de leur marque. |
