...
| Aperçus  |  Diffusez des événements d’informations opérationnelles sur les points de vente (PDV) à votre compte Application Insights. | [Accéder aux journaux Application Insights](../dev-itpro/retail-component-events-diagnostics-troubleshooting.md#enable-diagnostic-events-in-application-insights)   |  IT Pro/developer opt-in   |
