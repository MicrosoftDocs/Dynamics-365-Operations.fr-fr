...
description: Cet article décrit la fonctionnalité de gestion des commandes distribuées (DOM) dans Microsoft Dynamics 365 Commerce.
author: josaw1
ms.date: 11/16/2022
ms.topic: index-page
...
La vidéo suivante donne un aperçu des fonctionnalités DOM dans Dynamics 365 Commerce.
...
6. Revenez à **Vente au détail et Commerce \> Gestion des commandes distribuées \> Paramétrage \> Paramètres DOM**.
