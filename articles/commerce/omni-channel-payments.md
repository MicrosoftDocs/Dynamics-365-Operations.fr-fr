...
- **Configuration des paiements omnicanaux :** dans le back-office, accédez à **Retail et Commerce \> Paramétrage du siège \> Paramètres \> Paramètres partagés du commerce**. Puis, dans l'onglet **Paiements omnicanaux**, définissez l'option **Utiliser les paiements omnicanaux** sur **Oui**.
...
- L'option **Paiements omnicanaux** sur la page **Paramètres partagés du commerce** est définie sur **True**.
