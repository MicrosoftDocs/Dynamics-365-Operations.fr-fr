...
description: Cet article décrit comment paramétrer un entrepôt à utiliser avec un nouveau canal dans Microsoft Dynamics 365 Commerce.
author: samjarawan
ms.date: 01/27/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9273637"
---
# <a name="warehouse-set-up"></a>Paramétrer un entrepôt

[!include [banner](includes/banner.md)]

Cet article décrit comment paramétrer un entrepôt à utiliser avec un nouveau canal dans Microsoft Dynamics 365 Commerce.
