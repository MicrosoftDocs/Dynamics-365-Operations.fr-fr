...
Suivez les étapes requises pour créer votre expérience dans le service tiers. Si le connecteur est correctement configuré, la liste complète des expériences que vous avez configurées dans le service tiers apparaîtra dans le générateur de site dans un délai d'environ 5 minutes.
...
1. Dans le générateur de site, sélectionnez l'onglet **Pages** dans le volet de navigation de gauche, puis sélectionnez la page sur laquelle vous souhaitez collecter des métriques. 
