...
description: Cet article offre des informations sur le traitement des commandes pour les centres d’appels avec Dynamics 365 Commerce.
author: josaw1
ms.date: 02/04/2022
ms.topic: article
ms.prod: ''
