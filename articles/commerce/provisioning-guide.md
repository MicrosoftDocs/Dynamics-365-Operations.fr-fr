...
Pour ajouter le connecteur Azure à votre projet LCS, suivez les étapes de [Terminer l'intégration d'Azure Resource Manager (ARM)](https://docs.microsoft.com/dynamics365/fin-ops-core/dev-itpro/deployment/arm-onboarding).
