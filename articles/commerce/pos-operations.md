...
|----|-----------|-------------|-------------|--------------------|----------------|-------------------|-----------------|
| 707 | Activer le périphérique | Permet d’activer le périphérique actuel en permettant à un utilisateur authentifié de fournir des informations de connexion et affectez un ID de périphérique et de caisse enregistreuse. | Non | Non | Non | Non | Non |
...
| 135 | Ajouter une affiliation à partir de la liste | Permet d’ajouter une affiliation à une transaction en la sélectionnant dans une liste. | Oui | Oui | Oui | Oui | Non |
| 137 | Ajouter une affiliation à un client | Ajouter une affiliation à un client sur la page **Détails du client**. | Non | Non | Non | Oui | Non |
| 138 | Supprimer une affiliation d’un client | Supprimer une affiliation sur la page **Détails du client**. | Non | Non | Non | Oui | Non |
...
| 117 | Ajouter une carte de fidélité | Permet d’inviter l’utilisateur à entrer un numéro de carte de fidélité qui sera ajouté à la transaction actuelle. | Oui | Oui | Non | Oui | Non |
| 136 | Ajouter un numéro de série | Cette opération permet à l’utilisateur de spécifier un numéro de série pour le produit sélectionné actuellement. | Oui | Oui | Non | Oui | Non |
| 1214 | Ajouter une adresse d’expédition | Cette opération n’est pas prise en charge. | Non applicable | Non applicable | Non applicable | Non applicable | Non |
| 519 | Ajouter à la carte cadeau | Permet d’ajouter de l’argent à la carte cadeau spécifiée. | Oui | Oui | Non | Non | Non |
...
| 1 212 | Remise en banque | Permet d’enregistrer la somme d’argent envoyée à la banque ainsi que d’autres informations, telles que le numéro de sac de dépôt bancaire. | Oui | Oui | Oui | Oui | Non |
...
| 915 | Opération vide | Cette opération représente un bouton personnalisable qui peut être modifié par un développeur logiciel pour réaliser n’importe quelle opération nécessaire à l’entreprise. | Oui | Oui | Oui | Oui | Non |
...
| 310 | Calculer le total | Lorsque le calcul de la remise est retardé, cette opération initie le calcul de la transaction actuelle. | Oui | Oui | Non | Oui | Non |
| 642 | Exécuter tous les produits | Permet de définir le mode de livraison de toutes les lignes sur **Exécuter**. | Oui | Oui | Non | Oui\* | Non |
...
| 1215 | Modifier le mot de passe | Cette opération permet à l’utilisateur du PDV de modifier son mot de passe. | Oui | Oui | Oui | Non | Non |
| 123 | Modifier l’unité de mesure | Permet de modifier l’unité de mesure de la ligne sélectionnée. | Oui | Oui | Non | Oui | Non |
| 639 | Effacer le représentant par défaut sur la transaction | Permet de supprimer le groupe de ventes de commission (commercial) de la transaction. | Oui | Oui | Non | Oui | Non |
| 106 | Effacer la quantité | Permet de réinitialiser la quantité de la ligne sélectionnée actuellement sur **1**. | Oui | Oui | Non | Oui | Non |
...
| 912 | Activation du mode de configuration | Cette opération n’est pas prise en charge. | Non applicable | Non applicable | Non applicable | Non applicable | Non |
| 1 217 | Démonter les kits | Permet de démonter un kit en ses produits composants. | Oui | Oui | Oui | Oui | Non |
...
| 513 | Afficher le total | Permet d’afficher le solde des transactions sur l’écran du client. | Oui | Oui | Oui | Oui | Non |
| 623 | Editer le client | Permet de modifier les détails du client actuel. | Oui | Oui | Non | Non | Non |
...
| 918 | Gérer les équipes | Permet d’afficher une liste d’équipes actives, interrompues et clôturées en aveugle. | Oui | Oui | Oui | Non | Non |
| 914 | Réduire la fenêtre du PDV | Cette opération n’est pas prise en charge. | Non applicable | Non applicable | Non applicable | Non applicable | Non |
| 1 000 | Ouvrir tiroir-caisse | Permet d’exécuter une opération sans vente, puis d’ouvrir le tiroir-caisse actuellement sélectionné. | Oui | Oui | Oui | Oui | Non |
...
| 130 | Remplacer la taxe sur le produit de la ligne de la liste | Permet de remplacer la taxe sur la ligne sélectionnée par la taxe sélectionnée dans une liste par l’utilisateur. | Oui | Oui | Non | Oui | Non |
...
| 128 | Remplacer la taxe sur les transactions de la liste | Permet de remplacer la taxe sur la transaction et d’utiliser la taxe sélectionnée dans une liste par l’utilisateur. | Oui | Oui | Non | Oui | Non |
| 131 | Bon de livraison | Permet de créer le bon de livraison pour la commande sélectionnée. | Non | Non | Non | Non | Non |
| 710 | Jumeler une station matérielle | Cette opération n’est pas prise en charge. | Non applicable | Non applicable | Non applicable | Non applicable | Non |
| 201 | Payer par carte | Permet d’accepter une carte pour un paiement par carte de crédit ou de débit. | Oui | Oui | Non | Oui | Non |
| 200 | Payer en disponibilités | Permet d’accepter un paiement en disponibilités. | Oui | Oui | Non | Oui | Non |
| 206 | Payer rapidement en disponibilités | Permet d’exécuter la transaction en une étape, puis d’accepter le montant dû en espèces (appoint). | Oui | Oui | Non | Oui | Non |
| 204 | Payer par chèque | Permet d’accepter un chèque comme paiement. | Oui | Oui | Non | Oui | Non |
| 213 | Payer par avoir | Permet d’accepter un avoir (N° document) émis par le magasin. | Oui | Oui | Non | Non | Non |
| 203 | Payer en devises | Permet d’accepter un paiement dans différentes devises. | Oui | Oui | Non | Oui | Non |
| 202 | Payer sur le compte client | Permet de facturer la transaction sur le compte client. Ce mode de paiement n’est pas valide pour des dépôts de commande client. | Oui | Oui | Non | Non | Non |
| 214 | Payer par carte cadeau | Permet d’accepter une carte cadeau émise par le magasin. | Oui | Oui | Non | Non | Non |
| 207 | Payer par carte de fidélité | Permet d’accepter une carte de fidélité pour le paiement, et d’échanger les points contre des produits qualifiés. | Oui | Oui | Non | Non | Non |
| 634 | Historique des paiements | Permet d’afficher l’historique de paiement du client pour la commande client actuelle. | Oui | Oui | Non | Non | Non |
| 803 | Prélèvement et réception | Permet d’ouvrir la page **Prélèvement et réception**, sur laquelle vous pouvez sélectionner des ordres de prélèvement ou de réception dans le magasin. | Oui | Oui | Oui | Non | Non |
| 632 | Prélever tous les produits | Permet de définir la méthode d’exécution sur **Prélèvement en magasin** pour toutes les lignes. | Oui | Oui | Non | Oui\* | Non |
| 631 | Prélever les produits sélectionnés | Permet de définir la méthode d’exécution sur **Prélèvement en magasin** pour les lignes sélectionnées. | Oui | Oui | Non | Oui\* | Non |
| 400 | Menu contextuel | Cette opération n’est pas prise en charge. | Non applicable | Non applicable | Non applicable | Non applicable | Non |
| 101 | Vérification de prix | Cette opération permet à l’utilisateur de rechercher le prix d’un produit spécifié. | Oui | Oui | Oui | Oui | Non |
| 104 | Prix manuel | Permet de remplacer le prix d’un produit si le paramétrage le permet. | Oui | Oui | Non | Oui | Non |
...
| 927 | Imprimer une étiquette d’article | Cette opération n’est pas prise en charge. | Non applicable | Non applicable | Non applicable | Non applicable | Non |
...
| 922 | Afficher les détails du produit | Permet d’ouvrir la page de détails du produit pour la ligne sélectionnée actuellement. | Oui | Oui | Non | Oui | Non |
| 1003 | Afficher les rapports | Permet d’afficher les états qui ont été configurés pour l’utilisateur actuel. | Oui | Oui | Oui | Non | Non |
| 921 | Afficher les entrées de l’horloge de pointage | Permet d’afficher les entrées de l’horloge de pointage pour tous les travailleurs du magasin. | Oui | Oui | Oui | Non | Non |
| 211 | Annuler le paiement | Permet d’annuler la ligne de paiement sélectionnée actuellement de la transaction. | Oui | Oui | Non | Oui | Non |
| 102 | Annuler le produit | Permet d’annuler la ligne sélectionnée actuellement de la transaction. | Oui | Oui | Non | Oui | Non |
| 500 | Annuler la transaction | Permet d’annuler la transaction actuelle. | Oui | Oui | Non | Oui | Non |
| 916 | Windows Workflow Foundation | Cette opération n’est pas prise en charge. | Non applicable | Non applicable | Non applicable | Non applicable | Non |
...
| 311 | Supprimer les remises système des transactions | Supprimez toutes les remises appliquées par le système, y compris les remises basées sur les bons de réduction, de la transaction. Cela ne supprime pas les remises manuelles. | Oui | Oui | Oui | Oui | Non |
| 312 | Réappliquer les remises système | Réappliquez les remises système sur la transaction si elles ont été supprimées à l’aide de l’opération **Supprimer les remises système de la transaction**. | Oui | Oui | Oui | Oui | Non |
