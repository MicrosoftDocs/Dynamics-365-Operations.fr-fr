---
title: "Paramétrer un canal de centre d'appels"
...
Avant que les ventes puissent être correctement traitées via un canal de centre d'appels, les [modes de paiement](https://docs.microsoft.com/en-us/dynamics365/unified-operations/retail/work-with-payments) et les modes de livraison corrects doivent être définis pour le canal.
