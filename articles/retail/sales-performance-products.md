...
description: Vous pouvez étudier la rentabilité pour les 10 premiers produits à l'aide de Dynamics 365 Retail.
author: ashishmsft
manager: AnnBe
ms.date: 06/20/2017
ms.topic: article
...
ms.locfileid: "2024955"
---
# <a name="assess-sales-performance-by-product"></a>Évaluer les performances des ventes par produit

[!include [banner](includes/banner.md)]

Vous pouvez étudier la rentabilité pour les 10 premiers produits à l'aide de Dynamics 365 Retail.

Dans le cadre de Retail, les utilisateurs peuvent également étudier la rentabilité des principaux produits (10 à 100) entre différents niveaux de la hiérarchie d'organisation, selon l'un des critères suivants :
