...
**Contrôle Onglet** - Le contrôle Onglet peut être placé dans la mise en page de l'écran, et les autres contrôles tels que le pavé numérique, la carte client ou les groupes de boutons peuvent être placés dans l'onglet. Le contrôle Onglet est un conteneur qui permet aux utilisateurs d'ajouter plus de contenu à l'écran. Le contrôle Onglet est disponible uniquement pour les mises en page complètes. 
