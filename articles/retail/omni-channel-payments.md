...
description: Cette rubrique fournit une vue d'ensemble des paiements omnicanaux dans Dynamics 365 Retail.
author: rubendel
manager: AnnBe
ms.date: 05/12/2019
ms.topic: article
...
ms.locfileid: "2017572"
---
# <a name="omni-channel-payments-overview"></a>Présentation des paiements omnicanaux

[!include [banner](../includes/banner.md)]

Cette rubrique fournit une vue d'ensemble des paiements omnicanaux dans Dynamics 365 Retail. Elle inclut une liste complète des scénarios, des informations sur la fonctionnalité, du paramétrage, et de la résolution des problèmes pris en charge, et des descriptions de certains problèmes habituels.
