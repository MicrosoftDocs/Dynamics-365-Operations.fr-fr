...
description: Cette rubrique fournit une vue d'ensemble des paiements omnicanaux dans Microsoft Dynamics 365 for Retail.
author: rubendel
manager: AnnBe
ms.date: 05/12/2019
ms.topic: article
...
ms.locfileid: "1606190"
---
# <a name="omni-channel-payments-overview"></a>Présentation des paiements omnicanaux

[!include [banner](../includes/banner.md)]

Cette rubrique fournit une vue d'ensemble des paiements omnicanaux dans Microsoft Dynamics 365 for Retail. Elle inclut une liste complète des scénarios, des informations sur la fonctionnalité, du paramétrage, et de la résolution des problèmes pris en charge, et des descriptions de certains problèmes habituels.
...
- **Configuration des paiements omnicanaux :** Dans le back-office, accédez à **Vente au détail \> Paramétrage du siège \> Paramètres \> Paramètres partagés de la vente au détail**. Puis, dans l'onglet **Paiements omnicanaux**, définissez l'option **Utiliser les paiements omnicanaux** sur **Oui**.
...
- L'option **Paiements omnicanaux** sur la page **Paramètres partagés de la vente au détail** est définie sur **True**.
...
3. Dans Retail, utilisez le traitement par lots **Synchroniser les commandes** et le programme de distribution **P-001** pour créer les commandes dans le back-office.
...
1. Dans Retail, sur la page **Service client**, entrez **Karen Berg** dans la barre de recherche, puis sélectionnez **Rechercher**. 
