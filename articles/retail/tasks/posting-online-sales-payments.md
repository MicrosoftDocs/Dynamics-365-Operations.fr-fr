...
- Extraction des données de transaction de la vente au détail en ligne au siège social.
- Synchronisation des commandes pour créer des commandes client au siège social.

L'extraction des données de transaction de la vente au détail en ligne peut se faire soit manuellement en exécutant la tâche P, soit en créant un traitement par lots récurrent.

### <a name="manually-running-the-p-job"></a>Exécution manuelle de la tâche P

1. Accédez à Tous les espaces de travail > Informatique au détail.
