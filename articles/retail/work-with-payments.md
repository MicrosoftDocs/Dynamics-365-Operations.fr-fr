...
description: Cette rubrique décrit les différentes méthodes de paiement que vous pouvez utiliser dans un centre d'appels de Dynamics 365 Retail.
author: josaw1
manager: AnnBe
ms.date: 03/28/2018
ms.topic: article
