...
## [Configurer les modes de paiement pour le PDV](cash-denominations.md)
...
### [Configurer les mises en page d'écran pour le PDV](pos-screen-layouts.md)
### [Installer le concepteur de mise en page de Retail POS](install-pos-layout-designer.md)
### [Paramètres de langue et d'utilisateur de PDV](pos-application-user-language-settings.md)
...
### [Ajouter un contrôle de recommandations sur un périphérique PDV](add-recommendations-control-pos-screen.md)
## [Fonctionnalité de PDV hors connexion](pos-offline-functionality.md)
## [Gestion d'équipe et de tiroir-caisse](shift-drawer-management.md)
## Commandes client
### [Vue d'ensemble des commandes client](customer-orders-overview.md)
### [Commandes client hybrides](hybrid-customer-orders.md)
## Associés de vente
### [Suivre les commissions dans le PDV avec des groupes de ventes](pos-sales-groups-track-commissions.md)
## Activation du périphérique
### [Configurer et installer MPOS](retail-modern-pos-device-activation.md)
### [Paramétrer une connexion étendue pour le PDV cloud et MPOS](extended-logon.md)
...
## [ Créer des dimensions financières pour les caisses de PDV et configurer les valeurs de dimension dans les registres](tasks/create-financial-dimensions-pos.md)
...
## [ Créer des canaux en ligne et définir les attributs du canal](tasks/create-online-channel-define-channel-attributes.md)
## [ Créer des groupes d'autorisations de PDV](tasks/create-pos-permission-groups.md)
## [ Créer un profil visuel de PDV ](tasks/create-pos-visual-profile-2016-02.md)
...
## [ Configurer et exécuter une tâche de calcul des déclarations](tasks/run-job-calculate-statements.md)
...
## Architecture
### [Composants de Microsoft Dynamics 365 for Finance and Operations, Enterprise Edition - Retail](retail-components.md)
### [Architecture de serveur Retail](dev-itpro/retail-server-architecture.md)
...
### [Configuration et installation de l'unité d'échelle de magasin Retail](dev-itpro/retail-store-scale-unit-configuration-installation.md)
#### [Système de magasin Retail, avant de commencer](dev-itpro/retail-store-system-begin.md)
...
### [Gérer Bing Maps](dev-itpro/manage-bing-maps.md)

## Extensibilité
### Point de vente
#### [Mise en page de l'écran Retail POS](pos-screen-layouts.md)
##### [Installer le concepteur de mise en page de PDV](install-pos-layout-designer.md)
...
#### [Étendre le runtime de commerce pour prendre en charge le mode hors connexion du PDV](dev-itpro/call-crt-service-offline.md)
### Runtime de commerce
...
#### [Exemple de déclencheur : Stratégie de retour](dev-itpro/trigger-example-return-policy.md)
### e-Commerce
...
## Retail SDK
### [Vue d'ensemble du kit Retail SDK](dev-itpro/retail-sdk/retail-sdk-overview.md)
