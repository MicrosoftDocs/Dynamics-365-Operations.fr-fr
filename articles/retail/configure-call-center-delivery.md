...
Dans l'organisateur **Canaux de vente au détail**, ajoutez un canal de vente au détail qui doit être autorisé à utiliser le mode de livraison lorsque des transactions de vente sont créées dans ce canal.
