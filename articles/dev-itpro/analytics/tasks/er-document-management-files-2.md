...
---
# <a name="extend-data-model-to-use-document-management-files-in-format-outputs"></a>Étendre un modèle de données pour utiliser les fichiers de gestion des documents dans les sorties de format
