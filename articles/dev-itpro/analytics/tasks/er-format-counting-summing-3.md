...
---
# <a name="use-computations-to-generate-the-output-for-counting-and-summing"></a>Utiliser les calculs pour générer la sortie permettant d'effectuer le comptage et la synthèse
