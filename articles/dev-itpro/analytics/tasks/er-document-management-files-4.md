...
---
# <a name="run-format-to-use-document-management-files-in-format-outputs"></a>Exécuter un format pour utiliser les fichiers de gestion des documents dans les sorties de format 
