...
9. Dans l'arborescence, développez **format\root : Élément XML (racine)**.
10. Dans l'arborescence, sélectionnez **format\root: Élément XML (racine)\document: Élément XML 1.* (document)**.
11. Cliquez sur **Lier**.
12. Dans l'arborescence, développez **format\root: Élément XML (racine)\document: Élément XML 1.* (document)**.
13. Dans l'arborescence, sélectionnez **format\root: Élément XML (racine)\document: Élément XML 1.* (document)\id**.
