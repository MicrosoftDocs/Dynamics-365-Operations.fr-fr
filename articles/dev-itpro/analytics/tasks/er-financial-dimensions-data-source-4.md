...
---
# <a name="run-reports-that-use-financial-dimensions-as-data-sources"></a>Exécuter des états qui utilisent les dimensions financières comme sources de données
