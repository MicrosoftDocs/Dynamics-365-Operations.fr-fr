...
---
# <a name="design-data-models-to-use-financial-dimensions-as-data-sources"></a>Concevoir des modèles de données pour utiliser les dimensions financières comme sources de données
