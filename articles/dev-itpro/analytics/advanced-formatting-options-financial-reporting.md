...
- Entrez le code hiérarchie complet à partir de l'organigramme d'entreprise pour limiter le calcul à une unité spécifique. Par exemple, entrez **IF @Unit(SUMMARY^ACME^WEST COAST^SALES)**.
